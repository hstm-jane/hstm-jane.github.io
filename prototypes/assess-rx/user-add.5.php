        ...
        <div id="modal-pathway" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                        <h4 class="modal-title">Employee Pathway</h4>
                    </div>
                    <div class="modal-body">

<p>Applying this role with assign the following pathway to the employee:</p>
            ...
            <section class="section">
              ...
              <div class="slat-group">
                ...
                <div class="slat-group-footer"></div>
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success js-btn-assign-supervisor" data-dismiss="modal" >Apply Role to Assign Pathway</button>
