...
?>
    ...
    <?=createSiteStart($patterns['start']);?>
        ...
        <style>
/*           prototype only - we have enterprise license in prod*/
                    ...
                    <section>
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <a href="/admin-full-report-essentials-plus.php" class="btn btn-default btn-sm btn-path-results-report">View Full Report</a>

                            </div>
                            <div class="col-md-2">
                                <div class="index-container ">
                                    <div class="index">
                                        <div class="index-score">--</div>

                                    </div>
                                    <div class="index-label text-center">Index Unavailable</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="behavioral-metric assessment-metric visible-print-inline-block">
                                        <h2>Behavioral</h2>
                                        <span class="segment-score"></span>
                                        <span class="segment-percentile">No percentile data</span>
            ...
            <?=createPrototypeNav();?>
                <?=createSiteScripts();?>
                    ...
                    <script>
                        ...
                        var behavioralBenchmark = employeeBehavioral;
                        ...
                        var chart = AmCharts.makeChart("behavioral-bar", {
                            ...
                            "columnSpacing": 0,
                            "columnWidth": .2,
                            "colors": [employeeColor, "#ffffff"],
                            "addClassNames": true,
                            "maximum": 100,
                            "graphs": [{
                                    "balloonText": "Employee: " + employeeBehavioral + "%",
                                    "fillAlphas": 1,
                                    "id": "AmGraph-1",
                                    "lineAlpha": 0.2,
                                    "title": "Employee",
                                ...
                                {
                                    "balloonText": "No data for comparison",
                                    "fillAlphas": 1,
                                    "id": "AmGraph-2",
                                    "lineAlpha": 0.2,
                                    "title": "Benchmark",
