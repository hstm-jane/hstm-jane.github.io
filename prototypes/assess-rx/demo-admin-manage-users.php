  ...
  <div class="layout layout-search">
          ...
          <div class="col-md-9">
            ...
            <section class="section section-results" data-equalize="layout-columns">
              ...
              <section class="section section-results-header">
                <div class="row">
                  <div class="col-md-6">
                    <h2>Assess Users <small>Showing 1-50 of 2000</small></h2>
    ...
    for ($x = 0; $x <= 50; $x++) {
      ...
      if ($actors[$x] == "Augustus, Daren"){
        $slat = array(
          'title' => '<a href="demo-admin-user-edit.php">'. $actors[$x] . '</a>',
          'meta' => array(
          ...
          'action' => array(
            'type' => 'action-single',
            'content' => 'Options <i class="fa fa-plus visible-xs"></i>',
            'link' => '#pathway-modal',
          ),
        );
...
$stickybar = array(
  'sets' => array(
    array(
      ...
      'html' => '
        <a href="/demo-admin-user-acquire.php" class="btn btn-success ">Add User</a>',
    ),
    array(
      'position' => 'right',
      'classes' => array('hidden-xs', 'hidden-sm'),
