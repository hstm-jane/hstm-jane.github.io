...
<div class="layout">
  <div class="container" id="path-results-container" >
    <section class="section section-main section-box">
      ...
      <section class="section knowledge-details section-details active" id="knowledge-details">
        ...
        <section class="section">
          ...
          <div class="tab-content">
              <section id="assessment-1" class="active tab-pane section results-section assessment-details-tab">
                <h3>RN: Emergency Assessment: <span class="assessment-score">85%</span></h3>
              ...
              <section id="assessment-2" class="active tab-pane section results-section assessment-details-tab">
                <h3>Pharmacology: RN Assessment: <span class="assessment-score">80%</span></h3>
