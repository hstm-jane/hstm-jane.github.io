                            ...
                            <div class="analysis">
                                ...
                                <div class="analysis__box active hidden-xs">
                                    ...
                                    <a href="#" class="tag animated bounceInRight">
                                        Stop the blood<i class="fa fa-times"></i>
                                    </a>
                                    <a href="#" class="tag animated bounceInRight">
                                        Call the Doctor<i class="fa fa-times"></i>
                                    </a>
                                </div>
                                <div class="analysis__box active hidden-xs">
                                    <h4>Rationale</h4>
                        ...
                        <div class="col-md-6 padding-0">
                            <div class="chat">
                                ...
                                <div class=" chat__message__wrapper text-right animated fadeIn">
                                    <div class="chat__message--user chat__message">
                                        <p>Stop the blood and call the doctor</p>
                                        <div class="chat__message__arrow"></div>
                                    </div>
                                </div>
                                <div class="chat__input-block">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                            <a href="/demo-student-assessment-acute-care-judgement-5.php" class="btn btn-success">Send <i class="fa fa-paper-plane"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
