                    ...
                    <section>
                        <div class="row">
                            ...
                            <div class="col-md-10">
								...
								<div class="btn-group">
    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Actions <span class="fa fa-caret-down"></span></button>
    <ul class="dropdown-menu">
        <li><a href="/admin-full-report-essentials-plus.php">View Full Report</a></li>
<?php	
		
		if (isset($_GET["modal"]) == true) {
		echo '<li><a href="#modal-recommended-courses" data-toggle="modal">View Recommended Learning</a></li>';
}
		else{
		echo '<li><a href="admin-recommended-courses.php">View Recommended Learning</a></li>';
			
		}
     ?>   
        <li><a href="#">View Preceptor Guide</a></li>
    </ul>
</div>
                    ...
                    <section>
                        <div class="assessment-metrics">
                            <div class="row">
                                <div class="col-sm-6 col-md-4 visible-print-inline-block">
   ...
   <div id="modal-recommended-courses" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                        <h4 class="modal-title">Recommended Learning</h4>
                    </div>
                    ...
                    <div class="modal-footer">
                        <a class="btn btn-success" href="#modal-pathway" data-dismiss="modal" data-toggle="modal">Export</a>
