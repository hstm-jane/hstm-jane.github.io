        ...
        <div class="layout layout-min">
            ...
            <div class="container-fluid">
                <section class="section section-main section-box judgment-assessment" s data-equalize="layout-columns">
                    <h2>RN: Acute Care Judgment Assessment <span class="timer">10:00</span>
                        <p> <a href="#modal-clinical-data" data-toggle="modal" class="btn btn-default visible-xs">View Clinical Data</a></p>
                    </h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 padding-0">
                            <div class="chat">
                                <div class=" chat__message__wrapper animated fadeIn">
                            ...
                            <div class="chat__input-block">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-btn">
                                        <a href="/student-judgment-assessment-2.php" class="btn btn-success">Send <i class="fa fa-paper-plane"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-3 padding-0 hidden-xs ">
                            <div class="vignette-summary">
                                ...
                                <p><a href="#modal-clinical-data" data-toggle="modal" class="btn btn-default sm-screen-">View Clinical Data</a></p>
                            </div>
                        </div>
                    </div>
                    <!-- /row -->
