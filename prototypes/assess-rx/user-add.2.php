...
$patterns['search']['filters'] = array(
    ...
    ',
        ...
        <style>
            ...
            .js-enterprise-admin-mutli-affiliaton {
                display: none;
         /*   }
            .role-group{
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="role-group">
                        <label class="checkbox js-checkbox-role"><input type="checkbox"> <b>Employee </b> - Taking assessments </label>
                        <div class="permission-set ">
                           <div class="form-group">
                            <label class="control-label">
                                Which Affiliation(s) will the employee be assigned AssessRx items?
                            </label>
                            <select class="form-control js-affiliation-select" multiple="multiple">
                    ...
                    <div class="form-group ">
                        <label class="control-label">Let Supervisors in the following departments view the user's results </label>
                    ...
                    <button class="btn btn-default btn-block">Generate Role</button>

                </div>
            </div>
            <div class="role-group">

                <label class="checkbox js-checkbox-role"><input type="checkbox"> <b>Supervisor </b>  - Managing assessments and users </label> 
...
$stickybar = array(
    'sets' => array(
        array(
            ...
            <a class="btn btn-success" href="#">Save and Add Another</a>
...
<script>
    ...
    $(".js-affiliation-select").on("change", function(e){

        var value = $(this).val();
        if (value.length > 1) {
            $(".js-enterprise-admin-mutli-affiliaton").show();
        }
        else{
          $(".js-enterprise-admin-mutli-affiliaton").hide();
    ...
    //hide to work around bug in select two widths placeholders
    $(".permission-set").hide();
