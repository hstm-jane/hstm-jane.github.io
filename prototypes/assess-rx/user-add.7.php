					...
					<div class="container">
						<section class="section section-main section-box">
							...
							<fieldset>
								...
								<div class="row">
									<lable class="checkbox form-control">
								...
								<div class="row">
									<div class="col-md-4">
										...
										<div class="role-group">
											<div class="form-group">
												<a href="#modal-employee" class="btn btn-default js-employee-modal btn-block" data-toggle="modal">Assign Assessments by Profession</a>
											</div>
											<div class="form-group">
												<a href="#modal-employee" class="btn btn-default js-employee-modal btn-block" data-toggle="modal">Assign Assessments</a>
											</div>

										</div>
									</div>
									<div class="col-md-8">
										<label>Users' Assessments</label>
