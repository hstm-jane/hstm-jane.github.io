...
$patterns['start']['title'] = 'Edit User';
$patterns['focus']['title'] = 'Edit User';
    ...
    <div class="layout layout-search">
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="textbox" value="Jon"></input>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="textbox" value="R"></input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="textbox" value="Doe"></input>
                            </div>
                        </div>
                            </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="textbox" value="jDoe@gmail.com"></input>
                            </div>
                        </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="textbox" value="user123"></input>
                        </div>
                    </div>
            ...
            <fieldset class="roles-fieldset">
                <legend>
                    What Role(s) will the user have in Assess?
                </legend>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-3 col-md-offset-1 "> Affiliation:</div>
    ...
    $stickybar = array(
        'sets' => array(
            array(
                ...
                <a class="btn btn-default" href="/demo-admin-manage-users.php">Close</a>',
                ),
    ...
    <div class="modal-dialog">
        ...
        <div class="role-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control js-profession-select"  style="min-width:500px;" multiple="multiple">
