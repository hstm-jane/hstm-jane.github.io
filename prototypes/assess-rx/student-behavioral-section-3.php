        ...
        <div class="layout layout-min">
            <div class="container">
                <section class="section section-main section-box behavioral-assessment">
                    <h2>RN Behavioral Assessment <small>Section 3 of 6</small></h2>
                            ...
                            <section class="section">
                                ...
                                <div class="question">
                                    <div class="question-header">
                                        <h2 class="question-count">Item 1 <small>of 4</small><span class="label label-warning">Required Question</span></h2>
                                        <div class="question-text">
                                            Work on a task until it is perfect.
                                        </div>
                                    </div>
                                ...
                                <div class="question">
                                    <div class="question-header">
                                        <h2 class="question-count">Item 2 <small>of 4</small><span class="label label-warning">Required Question</span></h2>
                                        <div class="question-text">
                                ...
                                <!-- /question -->
                                   <div class="question">
                                    <div class="question-header">
                                        <h2 class="question-count">Item 3 <small>of 4</small><span class="label label-warning">Required Question</span></h2>
                                        <div class="question-text">
                                ...
                                <div class="question">
                                    <div class="question-header">
                                        <h2 class="question-count">Item 4 <small>of 4</small><span class="label label-warning">Required Question</span></h2>
                                        <div class="question-text">
                    ...
                    <section class="section">
                        <div class="form-group">
                            <a href="student-behavioral-section-4.php" class="btn btn-success">Next Section</a>
                        </div>
                    </section>
                </section>
                <!-- /section-main -->
