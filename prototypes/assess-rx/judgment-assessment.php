                ...
                <section class="section section-main section-box" style="background: #333; " data-equalize="layout-columns">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 padding-0">
                            <div class="chat">
                                <div class="chat__message--system chat__message animated fadeIn"><p>Let's see how we can help Mr. Kim. What is his primary problem? </p><div class="chat__message--system__arrow"></div></div>
                                <div class="chat__input-block">
                                    <div class="input-group">
                                        <input type="text" class="form-control" aria-label="" placeholder="Enter your answer">
                                        <div class="input-group-btn">
                                            <a href="/judgment-assessment-response.php" class="btn btn-success">Send <i class="fa fa-paper-plane"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
