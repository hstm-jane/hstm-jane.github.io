...
getOrgChart.buttons = {
    ...
    expColl: '<g transform="matrix(1,0,0,1,[xa],[ya])" data-btn-id="[id]" data-btn-action="expColl"><circle cx="[middle]" cy="[middle]" r="[middle]" class="get-btn" /><line x1="[start]" y1="[middle]" x2="[end]" y2="[middle]" class="get-btn get-btn-line" /><line style="display:[display]" x1="[middle]" y1="[start]" x2="[middle]" y2="[end]" class="get-btn get-btn-line" /><rect rx="5" ry="5" x="-175" y="-30" width="380" height="45"  class="get-btn exp-col-btn"  /></g>'
    // expColl: '<g transform="matrix(1,0,0,1,[xa],[ya])" data-btn-id="[id]" data-btn-action="expColl"><rect rx="5" ry="5" x="-175" y="-30" width="380" height="45"  class="get-btn exp-col-btn"  /></g>'
};
...
getOrgChart.prototype.print = function() {
    var b = this, d = this._X.element, k = this._X._zV, g = [], h = d.parentNode, j = k.style.display, a = document.body, c = a.childNodes, e;
    if (b._ah) {
        return
    }
    b._ah = true;
