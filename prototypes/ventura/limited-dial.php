            ...
            <section id="intervalPlanForm" class="col-md-8 p-int"><!-- left column, form with dial -->
                <form>
                    ...
                    <div class="form-group row pb-xl dash">
                        <div class="col-12 col-md-6">
                            ...
                            <select class="form-control" id="certifyingBody">
                                <option value="CP1" data-name="American Red Cross" selected>American Red Cross</option>
                                <!-- <option value="CP2" data-name="Content Partner Two">Content Partner Two</option> -->
                                <!-- commenting out option two just to represent that the options that haven't been purchased would come out of the markup or however they're being built -->
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select class="form-control" id="certification">
                                ...
                                <!-- commenting out PALS option just to represent that the options that haven't been purchased would come out of the markup or however they're being built -->
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row pl-lg pr-lg dash">
                        ...
                        <div id="dialBlock" class="pb-sm pl-xl pr-xl col-6 col-offset-3 mb-lg">
                            <div id="dialArc" class="text-center block row">
                            <!-- the "value" in the knob input element below needs to be changed depending on what the default option is. in this case, it has changed to 3, the 12month option, because we have disabled the 3/6 month options. However, if you put value=1 in the markup, it would still be defaulted to 3months" -->
                                <input class="knob" data-angleOffset=-90 data-angleArc=180 data-fgColor="#26B7FB" data-width="250" data-cursor="true" data-rotation="clockwise" data-step="1" data-min="0.7" data-max="4.3" value="3" readonly="readonly">
                            </div>
                            <div id="dialRadios" class="text-center block row mb-xl">
                                <input id="1_3_Month" name="monthOptions" type="radio">
                                <label for="1_3_Month" disabled>3 months</label>
                                <input id="2_6_Month" name="monthOptions" type="radio">
                                <label for="2_6_Month" disabled>6 months</label>
                                <input id="3_12_Month" name="monthOptions" type="radio" checked>
