        ...
        <table class width ="100%" border="0" cellpadding="0" cellspacing="0" id="identity-bar">
            <tbody>
                <tr>
                    ...
                    <a href="/HLC/Login/Logout.aspx?organizationID=072d25dd-c9a9-e111-b22e-0015171c1a75&amp;organizationNodeID=6afaafa9-caa9-e111-b22e-0015171c1a75" id="identity-logout"><img src="./admin-assets/images/Override/logout-orange.png" border="0" style="vertical-align:top;"></a>
                    </td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td class="af vlst">
                        ...
                        <ul id="cmul" class="txs">
                            ...
                            <li id="mlpli"><a href="./manage-AL-plan.php" target="_blank">Manage Learning Plans</a></li>
                            <li id="cctli">
                                <br>
                            ...
                            <div style="display:table;width:100%;height:100%;">
                                ...
                                <div style="display:table-cell;padding:20px;height:100%;">
                                    <div class="message-wrapper ">
                                        <div class="notification " data-type="system">
                                            <h3 class="notification-date ">November 2, 2017</h3>
                                            <h2 class="notification-title ">System Downtime</h2>
                                            <span class="notification-lead ">
                                                Scheduled Downtime on 11/15/2017!</span>
                                        ...
                                        <div class="notification " data-type="feedback">
                                            ...
                                            <span class="notification-lead ">
                                                Would your organization benefit from neonatal post-resuscitation/pre-transport stabilization courseware; why or why not? Please click here to complete our short survey (less than 10 questions). Thank you in advance for your time!</span>
