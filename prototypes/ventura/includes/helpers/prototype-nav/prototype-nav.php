...
$html = '<h5>Login Screens</h5>
		...
		<div class='modal-dialog'>
			<div class='modal-content'>
				...
				<ul class='nav nav-tabs'>
				  <li class='active'><a data-toggle='tab' href='#section-1' >Contents</a></li>
				  <li><a data-toggle='tab' href='#section-2' >Directory</a></li> 
				</ul>
	
				<div class='tab-content'>
					<div id='section-1' class='tab-pane active in fade'>" . $html ."</div>
	...
	for($x = 0; $x < $count; $x++) { 
  		$string = "<tr>
			...
			<td class='mdate'>" . $list[$x]['date']. "</td></tr>";
