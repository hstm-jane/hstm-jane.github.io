...
?>
<form id="AddNewNoteEmployee" method="post">
    <div id="modal-note-add-employee" class="modal fade" tabindex="-1">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="control-add-new">
                            <a href="#modal-select-documents-employee" data-toggle="modal" data-dismiss="modal">Attach Documents</a>
                            <span>|</span>
                            <a href="#modal-document-add-employee" data-toggle="modal" data-dismiss="modal">New Document</a>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-success" id="SaveAddNewNoteButton" type="submit">Save</button>
                    <a class="btn btn-success" data-dismiss="modal" data-toggle="modal" href="#modal-note-add-employee">Save and Add Another</a>
