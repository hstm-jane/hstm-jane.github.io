...
.app-drawer-nav-item-content .title {
...
<li class="app-drawer-container">
  ...
  ?>
        ...
        <div class="app-drawer-icon">
            ...
            <div class="applauncher-badge" style="position:absolute; z-index:5000; right:0px; top:-5px;">
                ...
                <li>
                        ...
                        <div style="margin:10px; padding:5px 5px; display:block;">
                            ...
                            <div class="app-drawer-nav-item-content" style="width:100%; display:table-cell;text-align:left;text-align:right;">
                                ...
                                <div class="description" style="margin:0;width:100%;text-align: right;font-size:12px;">
                                    <a style="font-size:12px;" href="http://hstm-sail-hstream.patternmanager.com/applications.php?persona=<?//= $persona ?>" target="_blank">Manage Apps</a></div>
                            </div>
                        </div>
                    </div> -->
                    <div class="app-drawer-content-panel">
                        <ul class="app-drawer-nav-item">
                            ...
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.dashboard-assignment.php?persona=<?= $persona ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                            ...
                            <?php } ?>
                            <?php if ($currentpage != 'hstream-workflow.eportfolio.php' && $workflow != '1') { ?>
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.eportfolio.php?persona=<?= $persona ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                            ...
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.todo.php?persona=<?= $persona ?>&workflow=1">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                                    ...
                                    <div class="app-drawer-nav-item-content ">
                                        <h5 class="title ">HLC  <div style="display:inline-block;margin-left:5px;"><span class="badge badge-alert">4</span></h5>
                                        <p class="description ">HealthStream Learning Center.</p>
                                    </div>
                                </a>
                            </li>
                            <?php } ?>
                            <?php if (($currentpage != 'hstream-workflow.educate.php') && ($workflow != '1') && ($persona == '3' || $persona =='9')) { ?>
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.educate.php?persona=<?= $persona ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                            ...
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.echo.php?persona=<?= $persona ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap ">
                                            <img src="content/images/verity-logo " alt="Verity " style="width:48px;height:48px; padding-left:1px;padding-top:1px; ">
                                        </div>
                                    </div>
                                    <div class="app-drawer-nav-item-content ">
                            ...
                            <?php } ?>
                            <?php if (($currentpage != 'hstream-workflow.alert.php') && ($persona == '3')) { ?>
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.alert.php?persona=<?= $persona ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                            ...
                            <?php } ?>
                            <?php if (($currentpage != 'hstream-workflow.hlcprofile.php') && ($workflow == '1') && ($persona == '3')) { ?>
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.hlcprofile.php?persona=<?= $persona ?>"  target="_blank">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                                            <img src="content/images/hstream-hlcprofile-logo-100.png " style="width:48px;height:48px;  " alt="hStream Alert ">
                                        </div>
                                    </div>
                                    <div class="app-drawer-nav-item-content ">
                            ...
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.profile.php?persona=<?= $persona ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap ">
                            ...
                            <li class="app-drawer-nav-item ">
                                <a href="hstream.developer.php?persona=<?= $persona ?> ">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
