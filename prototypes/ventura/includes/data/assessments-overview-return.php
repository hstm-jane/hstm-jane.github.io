...
$assessments = array(
    array(
        ...
        'title-id' => '1',
        'url' => '/assessment.php?assessment=competency-1&user=rater&state=5&return',
    ...
    array(
        ...
        'title-id' => '5',
        'url' => '/assessment.php?assessment=competency-2&user=rater&state=4&return',
    ...
    array(
        ...
        'title-id' => '6',
        'url' => '/assessment.php?assessment=competency-8&user=rater&state=2&approval&return',
    ...
    array(
        ...
        'title' => 'RN Community Health Competency Appraisal',
        'title-id' => '9',
        'url' => '/assessment.php?assessment=competency-7&user=rater&state=1&return',
        'state' => 'Review',
        'data-state' => 'review',
    ...
    array(
        ...
        'title-id' => '10',
        'url' => '/assessment.php?assessment=competency-3&user=rater&state=0&progress=3&return',
        'state' => 'Evaluate',
        'data-state' => 'evaluate',
    ...
    array(
        ...
        'title' => 'RN Nutrition',
        'title-id' => '11',
        'url' => '/assessment.php?assessment=competency-4&user=rater&state=0&progress=1&return',
        'state' => 'Evaluate',
        'data-state' => 'evaluate',
    ...
    array(
        ...
        'title' => 'Communication',
        'title-id' => '3',
        'url' => '/assessment.php?assessment=competency-6&user=rater&state=0&progress=0&return',
        'state' => 'Evaluate',
        'data-state' => 'evaluate',
    ...
    array(
        ...
        'title' => 'Prioritization, Organization, Delegation',
        'title-id' => '8',
        'url' => '/assessment.php?assessment=performance-1&user=rater&return',
        'state' => 'Evaluate',
        'data-state' => 'evaluate',
        'date' => date('M j, Y',strtotime('+20days')),
        'data-date' => date('Y/m/d',strtotime('+20days')),
    ...
    array(
        ...
        'title' => 'Initial Nursing Competency Appraisal',
        'title-id' => '12',
        'url' => 'assessment.php?assessment=competency-8&user=rater&state=2&approval&manager&return',
