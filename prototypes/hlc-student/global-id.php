    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-image:url('/content/images/modal-promo-simple-bg.jpg');">
            ...
            <div class="modal-footer">
                <a href="global-id-account-create.php" class="btn btn-success">Create ID</a>
                <a href="global-id-login.php" class="btn btn-success">I Already Have One</a>
