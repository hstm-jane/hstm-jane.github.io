...
================================================== -->
  ...
  <style>
    ...
    .nav-main .dropdown-options::after,
    .nav-main .dropdown-options::before {
      content: '';
      display: block;
      position: absolute;
      top: -20px;
...
<input type="checkbox" value="6"> Hidden Option with No Matches</label>
            ...
            <div class="filter-dropdown">
              <b style="font-weight:600">Show:</b>

              <div class="dropdown" style="display:inline-block;">
                <button class="btn btn-default btn-sm dropdown-toggle filter-button" type="button" data-toggle="dropdown" style="margin-left:7px; width:200px;text-align:left;"><span class="caret pull-right" style="margin-top:7px;"></span>All Tasks (12)
            ...
            <section class="section" id="tasks">
              <h3 class="pull-left hdr-1" style="display:inline-block; margin-top:5px">Action Needed</h3>
              ...
              <div class="slat slat-callout slat-attention slat-spaced slat-schedule slat3" data-filter-category="2">
