...
<div class="assessment-header">
  ...
  <section class="section assessment-action-section" id="jump-top">
   <h3>Waiting for Approval</h3>
     ...
     <p><button class="btn btn-default btn-sm">Return to Rater Overview</button><a href="#modal-state-detail-approval" data-toggle="modal">View Approval Activity</a></p>
...
<section class="section">
    <header class="section-header">
        <h3>Essential Attributes of Medical Surgical RNs<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-8">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h3>
    </header>
    <div class="statement">
    <div class="summary">
        <div class="basics">
