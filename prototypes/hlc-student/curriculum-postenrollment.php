                        ...
                        <div class="tab-pane fade active in" id="courses">
                            ...
                            <section class="section">
                                ...
                                $nested = createSlat(array(
                                    ...
                                    'title' => '<a href="#">A New Live Class</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Live Class',
                                        ),
                                ...
                                $nested = createSlat(array(
                                    'title' => '<a href="#modal-course-preview" data-toggle="modal">Course 3: Option 1</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Course',
                                        ),
                                    ...
                                    'action' => array(
                                        'type' => 'custom',
                                        'content' => '<div class="action"><a class="btn btn-sm btn-default" href="#modal-course-preview" data-toggle="modal">Course Info</a></div>',
                                    ),
                                    'attributes' => array(
                                        array('class',array('slat')),
                                    )
                                ...
                                $nested1 = createSlat(array(
                                    'title' => '<a href="#modal-course-preview" data-toggle="modal">Course 3: Option 2</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Course',
                                        ),
                                ...
                                $nested2 = createSlat(array(
                                    'title' => '<a href="#modal-course-preview" data-toggle="modal">Course 3: Option 3</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Course',
                                        ),
