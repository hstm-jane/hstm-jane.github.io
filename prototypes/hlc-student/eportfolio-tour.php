...
$patterns['header']['logoLarge'] = '/content/images/ePortfolio Logo_Horizal_RGB.Large.jpg';
$patterns['header']['logoSmall'] = '/content/images/ePortfolio Logo_Horizal_RGB.Large.jpg';
...
$importAction ='<div class="action"><a class="btn btn-sm btn-default js-import " href="#"> Import <i class="fa fa-plus visible-xs"></i></a><span class="loading-status"><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i></span>
<span class="sr-only">Loading...</span></div>';
?>


                    <style>
                        /*Styles for Prototype Only - Simulates ePortfolio color theme*/
                        ...
                        nav.nav-focus .nav li.active i,
                        nav.nav-focus .nav li:hover.active i {
                            display: block;
                            color: #769bba;
                        }
...
?>
                                                ...
                                                <div class="tab-pane fade in active" id="tab-2">
                                                    <section class="section work-experience-container" id="work-experience-container">
...
'attributes' => array(
array('class',array('slat', 'slat-callout', 'slat-import-record')),
),
'title' => 'Community Health Worker <div class="flag">Arlington Memorial Hospital  <span class="arrowLeft"></span></div>',
'meta' => array(
array(
'label' => 'Setting:',
'value' => 'Administrative Assistance and Secretarial Science, General Administrative Assistant etc etc etc ',
),
array(
...
'title' => 'Community Health Worker <div class="flag">MAYBERRY CLINIC HEALTH SYSTEM  <span class="arrowLeft"></span></div>',
'meta' => array(
array(
'label' => 'Setting:',
...
'title' => 'Community Health Worker <div class="flag">ST. ANTHONY HOSPITAL  <span class="arrowLeft"></span></div>',
'meta' => array(
array(
'label' => 'Setting:',
'value' => 'Ambulatory Care',
...
'title' => 'Records Available to Import to Work Experience',
'nested' => array(
'show' => array($nested, $nested2, $nested3),
),
'meta' => array(
array(
'label' => '',
...
?>
                                                    ...
                                                    <section class="section education-container">
                                                        <div class="slat-group">
                                                            <div class="slat-group-header">
                                                                <div class="slat-group-header-title" id="education-container">
                                                                    <h2>Education </h2>
                                                                </div>
                                                                <div class="slat-group-header-actions">
                                                                    <div class="btn-group">
                                                            ...
                                                            <div class="slat-group-content">
                                                                <div class="slat slat-callout">
                                                                    <div class="slat-default">
                                                                        <div class="title">Vanderbilt</div>

                                                                        <ul class="meta">
                                                                            <li><span class="meta-label">Degree:</span><span class="meta-value">Bachelors</span></li>
                                                                            <li><span class="meta-label">Field of Study:</span><span class="meta-value">Nursing</span></li>

                                                                            <li class="meta-callout"><span class="meta-value"><span class="meta-callout-label">Dates:</span>Aug 2004 - May 2008</span>
                                                                            </li>
                                                                        </ul>
...
<i class="fa fa-caret-down"></i>
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-right">
                                                                                    ...
                                                                                    <li><a href="#" class="hide-record">Hide</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </div>
...
'title' => 'Vanderbilt  <div class="flag">Arlington Memorial Hospital <span class="arrowLeft"></span></div>',
...
'title' => 'Vanderbilt  <div class="flag">Mayberry Clinic Health System  <span class="arrowLeft"></span></div>',
...
'title' => 'Vanderbilt  <div class="flag">St. Anthony Hospital  <span class="arrowLeft"></span></div>',
...
'title' => 'Records Available to Import to Education',
'nested' => array(
'show' => array($nested, $nested2, $nested3),
),
'meta' => array(
...
$slat = array(
'attributes' => array(
array('class',array('slat', 'slat-import-record')),
),
'title' => 'ABLS-Provider - Advanced Burn Life Support - Provider',
'meta' => array(
array(
'label' => 'Country:',
'value' => 'United States',
...
array(
'html' => '
<a href="#modal-sections" data-toggle="modal" class="btn btn-default btn-show-or-hide">Show or Hide Sections</a>
<a href="portfolio-print.php" class="btn btn-default btn-print" target="_blank">Print</a>
<a href="#" class="btn btn-default import-mode-btn" target="_blank">Enter Import Mode</a>
',
),
),
);
                                        ...
                                        <section class="section section-sidebar">
                                            <section class="section section-box">
                                                ...
                                                <ul class="list-links ">
                                                    ...
                                                    <li><a href="#modal-portable-portfolio-about"></a></li>
                                                    <li><a href="#">Manage Login and Password</a></li>


                                                </ul>
                                            </section>
                                            <section class="section section-box-import text-center section-box hidden-xs hidden-sm">
                                                <div class="import-message-wrapper animated pulse">

                                                    <img src="/content/images/cloud.svg" class="import-image">

                                                    <div class="records-available-text">
                                                        <div class="new-label">New</div>
                                                        <small>Records Available</small>
                                                    </div>
                                                </div>

                                                <a class="import-mode-btn btn btn-default btn-sm btn-block"> Enter Import Mode</a>

                                                <div class="hidden org-list ">
                                                    <h4 style="font-weight: 600">The following sections have records available to copy:</h4>

                                                    <ul class="list-links import-section-menu js-org-list">

                                                        <li>
                                                            <a href="#work-experience-container" class="scroll-link">Work Experience </a>
                                                        </li>

                                                        <li>
                                                            <a href="#education-container" class="scroll-link">Education Experience </a>
                                                        </li>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Show or Hide Sections</h4>
                                    </div>
                                    <div class="modal-body">
                                        <p>Choose which sections you would like to show on your ePortfolio.</p>
...
<button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        ...
                        <!-- Modal -->
                        <div id="modal-welcome" class="modal modal-lg modal-welcome fade" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                                        <h2 class="modal-title">Welcome to your</h2>
                                        <h2 class="modal-title product-title">ePortfolio</h2>
                                    </div>
                                    <div class="modal-body text-center">
                                        <img src="https://www.healthstream.com/images/default-source/eportfolio/step123106fcc2e5e68ebb67aff0000121ea5.png?sfvrsn=2" alt="computer-graphic" style="margin: auto; width:150px;">
                                        <ul class=" product-advantages">
                                            <li>Track current and future professional records </li>

                                            <li>Import your professional history from previous employers</li>
                                            <li>Share your unique story using an automatically generated resume</b>
                                            </li>
                                        </ul>
                                        ...
                                        <div style="margin: 15px auto;">
                                            <a href="#" class="btn btn-focus startTour">Take a Tour <i class="fa fa-caret-right fa-lg"></i> </a>
                                        </div>
                                    ...
                                    <?= createSiteScripts(); ?>
                                        ...
                                        <script>
                                            ...
                                            $(".js-org-list").on('change', 'input', function() {
                                                $(this).closest('li').find(".new-count").hide();
                                            });
                                            ...
                                            $(".js-import").click(function(e) {
                                                ...
                                                var $parentImportSlat = $(this).closest(".slat").parents('.slat-import-record');
                                                var $closestSlat = $(this).closest(".slat");
                                                ...
                                                $(this).text("Manage");
                                                $(this).removeClass("js-import");
                                                $(this).closest(".slat-group").find(".slat-message").parent().fadeOut();
                                                $(this).hide();

                                                $closestSlat.clone().insertBefore($parentImportSlat);

                                                $closestSlat.hide();

                                                if ($parentImportSlat.find(".slat-nested .slat       :visible").length == 0) {
                                                    $parentImportSlat.hide();
                                                }
                                            ...
                                            var importModeCount = 0;

                                            function toggleImportMode() {
                                                $(".org-list input").trigger("click");
                                                $("body").toggleClass("importMode");
                                                $(".import-message-wrapper").toggle();
                                                $(".org-list").toggleClass("hidden");
                                                $(".import-message").toggleClass("hidden");

                                                if (importModeCount % 2 != 0) {
                                                    $(".slat-import-record").hide();
                                                    $(".js-org-list input").attr('checked', false);
                                                } else {
                                                    $(".slat-import-record").toggle();
                                                    $(".import-section-menu .scroll-link:first").trigger("click");
                                                ...
                                                $(".slat:not(.slat-import-record) .action .btn").toggle();
                                                $(".slat-message .btn ").toggle();
                                                var messageText = $(this).text();

                                                $(".slat-message h3").text(messageText == $(".org-list").is(':visible') ? "This section is empty, add your first item." : "This section is empty. Choose an item to import from your available records.");

                                                var btnText = $(this).text();
                                                $(".import-mode-btn").text(
                                                    btnText == $(".org-list").is(':visible') ? "Enter Import Mode" : "Exit Import Mode");
                                        ...
                                        <script src="/scripts/healthstream.tours/tours/eportfolio-tour.js"></script>
