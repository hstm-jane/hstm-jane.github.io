   ...
   <h3>Sign Off</h3>
    ...
    <form class="validate">
        <div class="form-group">
            ...
            <blockquote >I agree with the rating given to me by my supervisor.</blockquote>
        </div>
        <div class="form-group">
            <h4 >Rater's Comments <small></small></h4>
            <blockquote >The employee ratings were outside of the criteria and need to be reviewed by a manager.</blockquote>
        </div>
        <div class="form-group">
...
<section class="section" id="ratings-top">
   <h2 style="font-weight:400;">Initial Nursing Competency Appraisal  
    <span class="average-rating">Assessment Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a> 
     |    Approval Activity: <a href="#" href="#modal-state-detail-approval" data-toggle="modal">View<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
