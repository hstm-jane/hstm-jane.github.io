...
$patterns['header']['mainNav'] = '
            ...
            <li class="{active=profile}"><a href="/portfolio-no-healthstream-id.php">Profile</a>
            </li>
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <section class="section " style="padding-right:30px; border-right: 1px solid #ddd;">
                                ...
                                <button class="btn btn-lg btn-primary btn-extend-profile js-healthstream-id">Create or link a HealthStream ID to this account.</button>
                                        ...
                                        <div class="slat-group-content">
                                            <div class="slat">
                                                <div class="slat-message slat-message-sm">
                                                    <h3>Add your first record by  <a class="js-healthstream-id">creating or linking</a> your HealthStream ID.</h3>
                                                ...
                                                $slat = array(
                                                    ...
                                                    'meta' => array(
                                                        array(
                                                            ...
                                                            'value' => 'Agriculture and Domestic Animal Services, Other',
                                                        ),
                                                        array(
                                                            'label' => 'School Name:',
                                                            'value' => 'Baylor',
                                    ...
                                    <div class="slat-group">
                                       ...
                                       <div class="slat-group-content">
                                            ...
                                            $slat = array(
                                                ...
                                                'nested' => array(
                                                    'show' => array('<div class="form-modified" style="margin:0">This record is not available in your ePortfolio; it is restricted to this account.</div>'),
                                                )
                                            );
                                            echo createSlat($slat);
...
<!-- Modal -->
<div id="modal-healthstream-id-promotional" class="modal modal-promo modal-promo-simple fade">
    <div class="modal-dialog">
        <div class="modal-content" style="background-image:url('/content/images/modal-promo-simple-bg.jpg');">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title">The New Healthstream ID</h3>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-7">
            ...
            <div class="modal-footer">
                <a href="healthstream-id-create-combined.php" class="btn btn-success">Create ID</a>
                <a href="healthstream-id-login-already-have-one.php" class="btn btn-success">I Already Have One</a>
                <button type="submit" class="btn btn-default" data-dismiss="modal" aria-hidden="true">Not Right Now</button>
            </div>
        </div>
    </div>
</div>
