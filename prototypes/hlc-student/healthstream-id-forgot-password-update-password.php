...
<div id="modal-healthstream-id-new-password" class="modal show modal-external" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form data-toggle="validator" id="newPasswordForm" method="post" action="healthstream-id-create-confirmation-complete-updated-password.php">
                <div class="modal-body">
                    ...
                    <div class="form-group nav-buttons">
                        <button class="btn btn-success" type="submit">Update Password</button> <a href="healthstream-id-create-confirmation-form.php" class="btn btn-default" type="submit">Cancel</a>
                    </div>
                </div>
