            ...
            <div class="row">
                <div class="col-md-3 hidden-xs hidden-sm hidden-print">
                    <section class="section section-refinement-options" data-equalize="layout-columns">
                            ...
                            <div class="date-range">
                                ...
                                <div class="date-range__custom">
                                    <div class="form-group">
                                        <label>Start:</label>
                                        <div class="input-group date" id="custom-start">
                                    ...
                                    <div class="form-group">
                                        <label>End:</label>
                                        <div class="input-group date" id="custom-end">
                                            <input type="text" class="form-control">
                                            <span class="input-group-btn">
                                                <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                                            </span>
                        ...
                        <p><a href="#" class="js-set-date">Test Date Setting</a></p>
                    </section>
                </div>
                <div class="col-md-9">
...
<script>
    $(function(){
        ...
        $('.js-set-date').click(function(e){
            e.preventDefault();
            $('#custom-start').datepicker('update', '<?= date('m/d/Y',strtotime('-2 years')); ?>');
            $('#custom-end').datepicker('update', '<?= date('m/d/Y'); ?>');
        });
