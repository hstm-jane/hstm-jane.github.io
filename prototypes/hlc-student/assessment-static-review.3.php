...
<head>
    ...
    <title>Initial Nursing Competency Appraisal| HealthStream</title>

    <!-- Styles
    ================================================== -->
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1480434432">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1480434432">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1480434432">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1480434432">
...
<div class="fph-cell fph-cell-icon"><div class="fph-icon" style="overflow:hidden;"><img src="/content/images/avatar.jpg" width="100%" height="100%"></div><div class="fph-icon-label"><span>Employee Assessment</span></div></div>
<div class="fph-cell fph-cell-text">
<div class="fph-primary">
<h1>Assessment Review</h1> 
<!--<ul class="meta">
<li class="meta-hidden-xs"><span class="meta-label">For Assessment:</span><span class="meta-value"><span class="meta-value">Initial Nursing Competency Appraisal</span></li>
</ul>-->
</div>
...
<style>
/*.layout-assessment .statement .actors > .actor { display: table }*/
.section-main .section.page-header, .section-main .section {
    margin:30px 10px 20px 10px;
}
  .assessment-action-section {
       margin-left: -15px !important;
       margin-right: -15px !important;
         /*box-shadow: 0 3px 3px rgba(0,0,0,0.07   ), 0 3px 3px rgba(0,0,0,0.07);*/
         /*box-shadow:   0px 2px 5px 0px  rgba(0,0,0,0.07),
               0px -2px 5px 0px  rgba(0,0,0,0.07);*/
           /*box-shadow:      0  8px 8px 8px rgba(0,0,0,0.07),
                          0 -8px -8px 8px rgba(0,0,0,0.07);*/
        box-shadow: 0 3px 3px rgba(0,0,0,0.07   ), 0 3px 3px rgba(0,0,0,0.07);
   ...
   .meta-box-new {
    ...
    .meta-box-new .mb-cell {
        display:table-cell;
        vertical-align:top;
        text-align:left;
        /*width: 16.6%;*/
        /*background-color:rgba(0, 153, 204, 0.11);*/
   ...
   .meta-box-new .mb-cell > div {
        /*margin: 0 5px;*/
     
        
   }
   .meta-box-new .meta-box-label {
       display:block;
       font-weight:400;
       /*margin-top:5px;*/
...
<div class="layout layout-assessment">
   ...
   <h3>Review</h3>
     <p>Please review the ratings below.</p>
   
   
</section>-->
            <section class="section page-header">
   <h2 style="font-weight:400;">Initial Nursing Competency Appraisal </h2>
   <div class="meta-box-new">
  
    <div class="mb-table">
        <div class="mb-row">
            <div class="mb-cell">
                    <span class="meta-box-label"> Assessment Rating</span> 
            
                    <span class="meta-box-value"><a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span>
            ...
            <div class="mb-cell">
                    ...
                    <span class="meta-box-value">Juniper, Stephanie P.</span> 
            ...
            <div class="mb-cell">
                    ...
                    <span class="meta-box-value">Dec 30, 2016</span>  
            
                
            </div>
              <div class="mb-cell">
                    <span class="meta-box-label">Approval Activity</span> 
              
                    <span class="meta-box-value"><a href="#" class="js-rating-definitions" data-params="assessment=competency-1">View<i class="fa fa-fw fa-info-circle"></i></a></span>  
...
<div class="assessment-instructions">
    ...
    <div id="assessment-instructions-body" class="collapse-group in">
        <div class="assessment-instructions__content">
            ...
            Please make progress on your department goal as we have discussed.
            
        </div>
     </div>
        <a href="#assessment-instructions-body" class="assessment-instructions__toggle collapse-toggle"
            data-toggle-text="Show instructions|Hide instructions">Hide instructions</a>
...
<div class="alert alert-info">
    <i class="fa fa-check-square-o fa-lg"></i> Check statements to include them in the Reflective/Development Plan.
</div>
    <header class="section-header">
        <h2>Essential Attributes of Medical Surgical RNs<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-7">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="checkable"><div class="statement">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-7&statement=statement-1&user=rater&state=1&progress=5">Critical Thinking</a></div>
    ...
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-7&statement=statement-1&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-7&statement=statement-1&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            ...
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5&actor=employee">More</a></div>
        </div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-1&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I am new and cannot rate this person</div>
        </div>
    </div>
</div></div><a href="#" class="collapse-toggle" data-toggle-text="Show Additional Rating Details|Hide Additional Rating Details">Show Additional Rating Details</a>
    </div>
</div><div class="select"><label><input type="checkbox" class="checkbox"><span class="icon"></span></label></div></div><div class="checkable"><div class="statement">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-7&statement=statement-2&user=rater&state=1&progress=5">Communication</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-7&statement=statement-2&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-7&statement=statement-2&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-2&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I am new and cannot rate this person</div>
    ...
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-7&statement=statement-3&user=rater&state=1&progress=5">Prioritization, Organization, Delegation</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-7&statement=statement-3&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-7&statement=statement-3&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-3&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I am new and cannot rate this person</div>
...
</div><div class="select"><label><input type="checkbox" class="checkbox"><span class="icon"></span></label></div></div>
</section><section class="section">
    <header class="section-header">
        <h2>Nursing Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-7">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="checkable"><div class="statement">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-7&statement=statement-4&user=rater&state=1&progress=5">Relationship Based Care</a></div>
            ...
            <div class="rating"><label>My Rating:</label> Novice</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-7&statement=statement-4&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-7&statement=statement-4&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-4&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-4&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Novice">Novice</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She needs to put in more effort to keep the team informed of her progress. Colleagues are often not aware of work she's completed, resulting in confusion in front of patients.</div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-4&user=rater&progress=5&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Competent">Competent</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> Overall, I think I am doing the work needed. I have had some feedback to communicate better but I'm working on it.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-4&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Novice">Novice</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She struggles with communicatation and needs to follow up on her shared tasks. I've gone to help a patient not nowing the work was already completed.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-4&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Advanced Beginner">Advanced Beginner</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I like working with her. She has a good attitude and wants to do bette. She could follow up more on shared tasks.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-4&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I am new and cannot rate this person</div>
    ...
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-7&statement=statement-5&user=rater&state=1&progress=5">Alcohol Withdrawal</a></div>
            <div class="description">Applies Relationship Based Care principals to strengthen teamwork and collaboration with all colleagues to improve the patient experience.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-7&statement=statement-5&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-7&statement=statement-5&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-5&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I am new and cannot rate this person</div>
    ...
    <header class="section-header">
        <h2>Med-Surg Core Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-7">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="checkable"><div class="statement">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-7&statement=statement-6&user=rater&state=1&progress=5">Blood Transfusion</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-7&statement=statement-6&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-7&statement=statement-6&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-6&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I am new and cannot rate this person</div>
    ...
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-7&statement=statement-7&user=rater&state=1&progress=5">Patient Controlled Analgesia - PCA</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-7&statement=statement-7&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-7&statement=statement-7&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-7&statement=statement-7&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Nov 22, 2016:</span> I am new and cannot rate this person</div>
...
<section class="section section-reflective">
    <header class="section-header">
        <h2>Reflective/Development Plan</h2>
    </header>
    <div class="row">
        <div class="col-sm-6">
        ...
        <div class="stickybar-floater">
            <div class="stickybar-outer">
                <div class="stickybar-inner">
                    ...
                    <a href="/assessment.php?assessment=competency-7&user=rater&state=3" class="btn btn-success js-submit-to-signoff">Begin Sign off Process</a>
...
<div id="modal-quickrate1" class="modal fade" tabindex="-1">
        ...
        <div class="modal-content">
            <div class="modal-page active" id="modal-page-goal-new">
               ...
               <form class="validate">
                            <h3>My Rating</h3>
                            <div class="form-group">
                                <label class="control-label">Rating <a href="#" class="js-rating-definitions" data-params="assessment=competency-3&amp;statement=statement-1"><i class="fa fa-fw fa-info-circle"></i></a></label>
                           ...
                           <div class="panel-group " role="tablist" id="risk-panel-group" aria-expanded="false">
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab">
                                        <a role="button" data-toggle="collapse" data-parent="#risk-panel-group" href="#risk-panel" class="collapsed">
                                            Risk/Outcome <small>Optional</small>
                            ...
                            <div class="panel-group " role="tablist" id="mov-panel-group" aria-expanded="true">
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab">
                                        <a role="button" data-toggle="collapse" data-parent="#mov-panel-group" href="#mov-panel" class="">
                                    ...
                                    <div id="mov-panel" class="panel-collapse collapse in" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <ul class="list-unstyled">
                                                        <li class="checkbox"><label><input type="checkbox">Case Study</label></li><li class="checkbox"><label><input type="checkbox">Confidence Based Learning</label></li><li class="checkbox"><label><input type="checkbox" checked="">Direct Observation</label></li><li class="checkbox"><label><input type="checkbox" checked="">Documentation Review</label></li><li class="checkbox"><label><input type="checkbox" checked="">Evidence of Daily Work</label></li><li class="checkbox"><label><input type="checkbox" checked="">Evidence Submission</label></li>
                                                    </ul>
                                                </div>
                                                <div class="col-xs-4">
                                                    <ul class="list-unstyled">
                                                        <li class="checkbox"><label><input type="checkbox">Exemplar</label></li><li class="checkbox"><label><input type="checkbox">Inservice Education</label></li><li class="checkbox"><label><input type="checkbox">Mock Survey</label></li><li class="checkbox"><label><input type="checkbox">Online Simulation</label></li><li class="checkbox"><label><input type="checkbox" checked="">Peer Review</label></li><li class="checkbox"><label><input type="checkbox">PI Data Trending</label></li>
                                                    </ul>
                                                </div>
                                                <div class="col-xs-4">
                                                    <ul class="list-unstyled">
...
<li><span class="meta-label">Status:</span><span class="meta-value">In Progress</span></li>
<li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>Nov 29, 2016</span></li>
</ul>
</div>
</div>
    ...
    $(function(){
        ...
        $('.js-submit').click(function(e){
            var growl = {
                ...
                growlText: encodeURIComponent('<dl class="gritter-class"><dd>Nursing Skills Assessment</dd></dl>'),
                growlSticky: 'false'
            }
            e.preventDefault();
        ...
        $('.js-submit-to-review').click(function(e){
                    ...
                    HealthStream.utilities.interrupt({
                        ...
                        actions: [
                        {
                            ...
                            url: '/assessment.php?assessment=competency-7&user=rater&state=0&progress=1',
                        },
                        {
                            type: 'default',
                            label: 'Cancel',
