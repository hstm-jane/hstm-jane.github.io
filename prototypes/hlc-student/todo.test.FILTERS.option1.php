                  ...
                  <div class="filter-dropdown-container ">
                                            ...
                                            <div class="dropdown" style="display:inline-block;">
                                                <button class="btn btn-default btn-sm dropdown-toggle filter-button" type="button" data-toggle="dropdown" style="margin-left:7px; width:200px;text-align:left;">
                                                    <span class="caret pull-right" style="margin-top:7px;"></span>Entire List (15) </button>
                                                <ul class="dropdown-menu pull-right filter-dropdown">
                                                    <li>
                                                        <a href="#" data-texttodisplay="Entire List (15)" data-filter="0">
                                                            <label class="badge pull-right">15</label>Entire List </a>
                                                    </li>
                                                    <li>
                                                        <a href="#" data-texttodisplay="Assigned Only (13)" data-filter="1">
                                                            <label class="badge pull-right">13</label>Assigned Only </a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                     ...
                                                     <li>
                                                        <a href="#" data-texttodisplay="Equivalents (1)" data-filter="9">
                                                            <label class="badge pull-right">1</label>Equivalents</a>
                                                    </li>
                                                    <li>
                                            ...
                                            <div class="pull-right">
                                                <div class="dropdown" style="display:inline-block;">
                                                    <button class="btn btn-default btn-sm dropdown-toggle sort-button" type="button" data-toggle="dropdown" style="margin-left:7px; width:130px;text-align:left;">
                                                        <span class="caret pull-right" style="margin-top:7px;"></span>Sort: By Priority </button>
                                                    <ul class="dropdown-menu sort-dropdown pull-right ">
                                                        <li>
                                                            <a href="#" data-sorttexttodisplay="Sort: By Priority" data-sort="0">Sort: By Priority</a>
                                                        </li>
                                                        <li>
                                                            <a href="#" data-sorttexttodisplay="Sort: Name (A-Z)" data-sort="1">Sort: Name (A-Z)</a>
                                                        </li>
                                                        <li>
                                                            <a href="#" data-sorttexttodisplay="Sort: Type of Task" data-sort="2">Sort: Type of Task</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
...
<div class="title"><a href="#">Fire Safety (PA)</a></div>
<ul class="meta">
...
<div class="slat-default">
<div class="title"><a href="#">Culture and Workplace Webinar</a></div>
<ul class="meta">
...
<div class="slat-default">
<div class="title"><a href="#">2017 Nursing Technologies Track</a></div>
<ul class="meta">
...
<div class="slat-default">
<div class="title"><a href="#">Lab Skills: Groover, George G.</a></div>
<ul class="meta">
...
<div class="slat-default">
<div class="title"><a href="#">Please Update Your Profile</a></div>
<ul class="meta">
...
<div class="slat-default">
<div class="title"><a href="#">Hand Hygiene</a></div>
<ul class="meta">
<li><span class="meta-type">Course</span></li>
<li><span class="meta-label">Status:</span><span class="meta-value">In Progress</span></li>
...
<div class="slat slat-spaced slat-callout slat-assessment" data-filter-category="5">
<div class="slat-default">
<div class="title"><a href="#">Nursing Skills Assessment</a></div>
<ul class="meta">
<li><span class="meta-type">Self Assessment</span></li>
...
<div class="slat-default">
<div class="title"><a href="#">Medical Ethics</a></div>
<ul class="meta">
<li><span class="meta-type">Live Class</span></li>
<li><span class="meta-label">Status:</span><span class="meta-value">Registered</span></li>
<li><span class="meta-label">Session:</span><span class="meta-value">1 of 1</span></li>
...
<div class="slat-default">
<div class="title"><a href="#">Choose a Course</a></div>
<ul class="meta">
...
<div class="slat-default">
<div class="title"><a href="#">Culture and Workplace Issues</a></div>
<ul class="meta">
<li><span class="meta-type">Course</span></li>
...
<div class="slat slat-spaced slat-callout slat-optional slat-course" data-filter-category="3">
<div class="slat-default">
<div class="title"><a href="#">Leadership Development: First Principles</a></div>
<ul class="meta">
<li><span class="meta-type">Course</span></li>
<li><span class="meta-label">Status:</span><span class="meta-value">Not Started</span></li>
                ...
                <div class="modal-body">
                    ...
                    <ol>
                        ...
                        <li>Performance Assessment: As Employee
                            <ol style="margin:3px 0 15px">
                                <li><a href="#&user=employee">Employee, no progress</a></li>
                                <li><a href="#&user=employee&progress=1">Employee, some progress</a></li>
                                <li><a href="#&user=employee&progress=2">Employee, no progress</a></li>
                            </ol>
                        </li>
                        <li>Performance Assessment: As Rater
                            <ol style="margin:3px 0 15px">
                                <li><a href="#&user=rater">Rater, no progress</a></li>
                                <li><a href="#&user=rater&progress=3">Rater, some progress</a></li>
                                <li><a href="#&user=rater&progress=4">Rater, complete</a></li>
                                <li><a href="#&user=rater&state=1">Rater, review</a></li>
                                <li><a href="#&user=rater&state=3">Rater, choose signoff type</a></li>
                                <li><a href="#&user=rater&state=4">Rater, waiting on employee signoff</a></li>
                                <li><a href="#&user=rater&state=5">Rater, signoff</a></li>
                            </ol>
                        </li>
                        <li>Performance Assessment: As Peer
                            <ol style="margin:3px 0 15px">
                                <li><a href="#&user=peer-1">Peer, no progress</a></li>
                                <li><a href="assessment.php?assessment=competency-1&user=peer-1&progress=1">Peer, complete</a></li>
                            </ol>
                        </li>
