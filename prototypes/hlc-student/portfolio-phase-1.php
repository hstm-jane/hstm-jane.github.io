                        ...
                        <div class="col-md-3">
                            ...
                            <section class="section">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="#modal-portable-portfolio-about" data-toggle="modal">What is my Portable Portfolio?</a></li>
                                    <li><a href="#modal-portable-portfolio-about" class="foo" data-toggle="modal">Why is my data not displayed?</a></li>
                                </ul>
                            </section>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" style="width:auto; max-width:770px">
        <div class="modal-content">
            ...
            <div class="modal-body modal-wizard-body">
                <iframe id="portfolio-wizard-modal" src="portfolio-wizard-modal-phase-1.php" width="100%" height="770" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
            </div>
...
<script src="/scripts/prototype.portfolio.wizard.helper-phase-1.js"></script>
<script>
$( ".foo" ).click(function(e) {
    e.preventDefault();
    $('iframe#portable-portfolio-about').attr('src', 'portable-portfolio-about.php#data-message');
});

$('#modal-portable-portfolio-about').on('hidden.bs.modal', function () {
    $('#portable-portfolio-about').attr('src', 'portable-portfolio-about.php');
