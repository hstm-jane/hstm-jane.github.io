            ...
            <ul class="app-drawer-nav-item">
                ...
                <li class="app-drawer-nav-item">
                    <a target="_blank" href="http://www.healthstream.com">
                        <div class="app-drawer-nav-item-logo">
                            <div class="svg-icon-wrap">
                                <img src="con`ent/images/echo-logo-50x50.png"> </div>
                        </div>
                        <div class="app-drawer-nav-item-content">
        ...
        <div class="fph-table">
            <div class="fph-row">
                ...
                <div class="fph-cell fph-cell-supporting">
                    <img src="/content/images/coaching-quick.png">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <section class="section section-main section-box" data-equalize="layout-columns">
                        <div class="filter-dropdown" style=" margin-top:10px !important;"> <b style="font-weight:600;">Show My:</b>
                        ...
                        <section class="section" id="tasks">
                            <h3 class="hdr-1 clearfix" style=" margin-top:20px !important;">Urgent Action Required</h3>
