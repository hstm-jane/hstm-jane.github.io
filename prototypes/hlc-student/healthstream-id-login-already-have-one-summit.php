            ...
            <form data-toggle="validator" id="loginForm" method="post" action="#">
                <div class="modal-body">
                    ...
                    <div class="form-group nav-buttons">
                         <a href="healthstream-id-link-form-validation-unrecognized-email.php" class="btn btn-success" type="submit">Submit</a>
                        <a href="portfolio-no-healthstream-id-summit.php?promo" class="btn btn-default" type="submit">Cancel</a>
                    </div>
                    <div class="form-group">
