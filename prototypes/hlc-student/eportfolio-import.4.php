            ...
            <div class="modal-body">
                <section class="section">
                    ...
                    <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#" class="group-header-link">Work Experience <i class="fa fa-caret-right"></i></a></h3>
                            </div>
                            ...
                            <div class="slat slat-callout slat-modal slat-import-record" style="display: block;">
                                <div class="slat-default">
                                    <div class="title">Registered Nurse
                                        <div class="flag">Carter Valley Medical  <span class="arrowLeft"></span>
                                        </div>
                                    </div>
                                    <ul class="meta">
                             ...
                             <div class="slat slat-callout slat-modal slat-import-record" style="display: block;">
                                <div class="slat-default">
                                    <div class="title">Registered Nurse
                                        <div class="flag">Southeast United Hospitals <span class="arrowLeft"></span>
                                        </div>
                                    </div>
                                    <ul class="meta">
                                        <li><span class="meta-label">Speciality:</span><span class="meta-value">Pediatrics</span></li>
                    ...
                    <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Education <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                    ...
                    <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Licenses <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                     ...
                     <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Certifications <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                     ...
                     <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Resucitation Programs <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                        ...
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Volunteer Service <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                      ...
                      <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Committee Work <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                    ...
                    <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Memberships & Associations <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                     ...
                     <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Teaching & Preceptorship <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                      ...
                      <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Publications & Research <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                     ...
                     <div class="slat-group">
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Awards & Recognition <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
                        ...
                        <div class="slat-group-header ">
                            <div class="slat-group-header-title">
                                <h3><a href="#southeast-group" class="group-header-link">Other <i class="fa fa-caret-right"></i> </a></h3>
                            </div>
...
<script>
   ...
   //  };
    ...
    $(".modal").on('shown.bs.modal', function(e){
        ...
        e.preventDefault();
        $('.group-header-link').on('click', function() {
