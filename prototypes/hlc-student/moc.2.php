...
<div class="layout">
                                ...
                                <div class="slat-group">
                                    ...
                                    <div class="slat-group-content">
                                        ...
                                        $slat = array(
                                            ...
                                            'title' => '<span class="time-period">Year 1 : 5 Courses Available All Year</span>',
                                            'meta' => array(
                                                array(
                                                    'label' => 'Total: ',
                                                    'value' => '5',
                                                ...
                                                array(
                                                    'label' => 'Due: ',
                                                    'value' => '<span class="meta-callout-label">Target:</span> Dec 31, 2015',
                                                    'attributes' => array(
                                                        array('class','meta-callout'),
                                                    )
                                                ),
                                            ...
                                            'toggle' => array('Show Courses','Hide Courses'),
                                        );
                                        ...
                                        $slat = array(
                                            ...
                                            'title' => 'Target Completion: Y1-Q2 <br >  <span style="font-weight:normal">Apr 1, 2015 to Jun 30, 2015 </span>',
                                            'meta' => array(
                                                array(
                                                    'label' => ' ',
                                                    'value' => '',
    ...
    <div class="slat-group">
                                    <div class="slat-group-header">
                                        <div class="slat-group-header-title">
                                            <h3>Year 2 :  Jan 1, 2016 - Dec 31, 2016</h3>
                                        </div>
