...
$patterns['start']['title'] = 'Goal Title';
$patterns['focus']['title'] = 'Goal Title';
...
$patterns['focus']['meta_primary'] = array(
    array(
        ...
        'value' => '<a href="'.$return.'" class="meta-value">Performance Appraisal - Employee Workflow</a>',
        'attributes' => array(
                            ...
                            <div class="actor__details">
                                <div class="actor__row">
                                    ...
                                    <div class="actor__comment">
                                        ...
                                        <pre>No comment available</pre>

                                    </div>
                                </div>
                            </div>
                            <div class="actor__submitted"></div>
                        </div>
                    </div>
                        ...
                        <div class="actor">
                            <div class="actor__basics">
                                <div class="actor__row">
                                    ...
                                    <div class="actor__summary"><div><span class="actor__summary-date">Jan 29, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year. I appreciate my manager asking me for feedback and putting in action plans geared towards tea… <a href="#" class="js-rating-detail">More</a></div></div>
                                </div>
                            </div>
                            <div class="actor__details">
                                <div class="actor__row">
                        ...
                        <div class="actor">
                            <div class="actor__basics">
                                <div class="actor__row">
                                    ...
                                    <div class="actor__summary"><div><span class="actor__summary-date">Dec 15, 2015:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year. I appreciate my manager asking me for feedback and putting in action plans geared towards tea… <a href="#" class="js-rating-detail">More</a></div></div>
                                </div>
                            </div>
                            <div class="actor__details">
                                <div class="actor__row">
                            ...
                            <div class="actor__submitted">Submitted: Dec 15, 2015</div>
                        </div>
                        <div class="actor">
                            <div class="actor__basics">
                                <div class="actor__row">
                                    ...
                                    <div class="actor__summary"><div><span class="actor__summary-date">Nov 15, 2015:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year. I appreciate my manager asking me for feedback and putting in action plans geared towards tea… <a href="#" class="js-rating-detail">More</a></div></div>
                                </div>
                            </div>
                            <div class="actor__details">
                                <div class="actor__row">
                            ...
                            <div class="actor__submitted">Submitted: Nov 15, 2015</div>
                        </div>
                        <div class="actor">
                            <div class="actor__basics">
                                <div class="actor__row">
                                    ...
                                    <div class="actor__name"><a href="#" class="js-rating-detail">Juniper, Stephanie P.</a></div>
                                    <div class="actor__rating"><div class="rating-control"><div class="rating-control-row"><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option  rating-selected"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Meets Expectations">Meets Expectations</span></div></div></div></div>
                                    <div class="actor__summary"><div><span class="actor__summary-date">Oct 15, 2015:</span> No Comment</div></div>
                                </div>
                            </div>
                            <div class="actor__details">
                                <div class="actor__row">
                            ...
                            <div class="actor__submitted">Submitted: Oct 15, 2015</div>
                        </div>
                    </div>
                ...
                <div class="col-md-8 col-sm-6">
                    <section class="section" data-equalize="layout-columns">
                        <section class="section">
                            <h3>Parent Goal</h3>
                            <p><a href="#">This is the parent goal</a></p>
                        </section>
                        <section class="section">
                            <h3>Detail</h3>
                        ...
                        <section class="section">
                            <h3>Progress</h3>
                            <div class="assessment-goal-progress">
                                <div class="assessment-goal-progress__col-1">
                                    <div class="assessment-goal-progress__date"><?php echo date('M j, Y',strtotime('-1 months')); ?></div>
                                    <div class="assessment-goal-progress__status">In Progress</div>
                                </div>
                                <div class="assessment-goal-progress__col-2">
                                    <div class="assessment-goal-progress__progress">I have been making steady improvement and completing all my checklists with high marks.</div>
                                    <div class="assessment-goal-progress__resources">
                                        <ul class="fa-ul">
                                            <li><a href="#"><i class="fa fa-paperclip fa-li"></i>Checklist summary</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="collapse collapse-group">
                                ...
                                <div class="assessment-goal-progress">
                                    <div class="assessment-goal-progress__col-1">
                                        <div class="assessment-goal-progress__date"><?php echo date('M j, Y',strtotime('-'.$i.' months')); ?></div>
                                        <div class="assessment-goal-progress__status">In Progress</div>
                                    </div>
                                    <div class="assessment-goal-progress__col-2">
                                        <div class="assessment-goal-progress__progress">I have been making steady improvement and completing all my checklists with high marks.</div>
                            ...
                            <a href="#" class="collapse-toggle" data-toggle-text="Show Progress History|Hide Progress History">Show Progress History</a>
                        </section>
                    </section>
                </div><!-- /column -->
            ...
            <div class="modal-body">
                ...
                <div class="detail__actors detail__actors--multiple">
                    <div class="detail__actor">
                        ...
                        <div class="detail__submitted">Submitted: Jan 29, 2016</div>
                    </div>
