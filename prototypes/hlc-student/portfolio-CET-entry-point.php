                                                        ...
                                                        <div class="slat-group">
                                                            ...
                                                            <div class="slat-group-content">
                                                                <div class="slat">
                                                                    ...
                                                                    <div class="title"><a href="#">Advanced Registered Nurse Practitioner Temporary</a></div>
                                                                    <ul class="meta">
                                                                        <li><span class="meta-label">STATE LICENSE NUMBER:</span><span class="meta-value">56465</span></li>
                                                                        <li><span class="meta-label">STATE/PROVINCE:</span><span class="meta-value">LA</span></li>
                                                                        <li><span class="meta-label">COUNTRY:</span><span class="meta-value">United States</span></li>
                                                                    </ul>
                                                                    <ul class="meta-2">
                                                                        <li><span class="meta-label">CETracker</span>| <span class="meta-value"><a href="ce-tracker.php">5 of 30</a></span></li>
                                                                    </ul>
                                                                ...
                                                                <div class="slat">
                                                                    <div class="slat-default">
                                                                    <div class="title"><a href="#">Slat with Split Action</a></div>
                                                                    <ul class="meta">
                                                                    ...
                                                                    <div class="slat-nested">
                                                                        <div class="form-modified" style="margin:0">This license is not available in your portable portfolio, it is restricted to your organization.</div>
                                                                    </div>
                                                                </div>
