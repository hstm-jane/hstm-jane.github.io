             ...
             <li>
                    <a href="hstream.docs.flow.php">
                      ...
                      <ul class="dashed">
                        ...
                        <li class="active"><a href="hstream.docs.flow.course.php">Course Attendance API</a></li>
                ...
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        <div class="places-buttons">
                            <div class="row">
                                <div class="col-md-12">
<h3  id="get-a-users-tasks"><a name="user-content-get-a-users-tasks" href="#get-a-users-tasks" class="headeranchor-link" aria-hidden="true"><span class="headeranchor"></span></a>Course Attendance API</h2>
...
<table class="table table-condensed table-striped">
    ...
    <tr>
        <td>Org Unique Record Identifier </td>
        <!--<td>URL</td>-->
        <!--<td>string</td>-->
        <td> 1 or many (if empty, all orgs)</td>
    </tr>
     <tr>
        <td>Course Unique Record Identifier <span class="label label-danger">Required</span></td>
        <!--<td>URL</td>-->
        <!--<td>string</td>-->
        <td> 1 or many</td>
    </tr>
...
<table class="table table-condensed table-striped">
    ...
    <tr>
        <td>Employee/User Unique Record Identifier</td>
        <!--<td>Bad Request</td>-->
    </tr>
    <tr>
...
<table class="table table-condensed table-striped">
    ...
    <tr>
        <td>User Unique Record Identifier</td>
        <!--<td>Unauthorized</td>-->
    </tr>
    <tr>
        <td>Course Unique Record Identifier</td>
