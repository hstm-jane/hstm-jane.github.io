    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" data-toggle="modal" data-target="#modal-quickrate1"><i class="fa fa-times"></i></button>
            ...
            <div class="modal-footer">
                <button class="btn btn-default" data-dismiss="modal" aria-hidden="true" data-toggle="modal" data-target="#modal-quickrate1">Close</button>
            </div>
        </div>
    </div>
</div><!-- /modal -->