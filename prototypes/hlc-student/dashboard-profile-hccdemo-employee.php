...
$patterns['header'] = array(
    ...
    'mainNav' => '
        <li class="{active=dashboard}"><a href="/dashboard-manager-hccdemo-employee.php">MyTeam</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <section class="profile-return-link">
                                <a href="dashboard-manager-hccdemo-employee.php"><i class="fa fa-fw fa-chevron-left"></i>Return to MyTeam</a>
                            </section>
                            <div class="panel panel-default panel-employee">
                                <div class="panel-body text-center clearfix">
                                   ...
                                   <div class="mv-lg">
                                       ...
                                       <div class="badge badge-info">On Leave </div>
