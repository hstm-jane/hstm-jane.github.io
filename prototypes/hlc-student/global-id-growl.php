...
<script>
    $(function() {
        HealthStream.utilities.growl({
            ...
            text: 'An%20email%20was%20sent%20to%20yourname@email.com%20with%20 instructions%20on%20completing%20your%20registration.%0A%0A%3Cp%3E%3Ca%20href%3D%22#%22%20class%3D%22js-resend-email%22%3EResend%20verification%20email%3C%2Fa%3E%3C%2Fp%3E',
            sticky: true
        });
        $(".js-resend-email").click(function(e) {
            e.preventDefault();
            $(this).closest('.gritter-item').find('.gritter-close').click();
            var delay = setTimeout(function(){
                HealthStream.utilities.growl({
                type: 'success',
                title: 'Email Sent',
                text: 'Your%20verification%20email%20has%20been%20re-sent',
                sticky: false
            });
            }, 700);
        });
