...
<div class="assessment-header">
  ...
  <section class="section assessment-waiting-section" id="jump-top">
   ...
   <p></p>
    ...
    <button class="btn btn-default ">Return to Rater Overview</button>&nbsp;&nbsp;&nbsp;<a href="#modal-state-detail-approval" data-toggle="modal">View Approval Activity</a>
    <!--<button class="btn btn-default btn-sm">View Approval Activity</button>-->
