            ...
            <div class="container">
                   ...
                   <div class="branding" style="display:table;">
                                       ...
                                       <div style="display:table-cell;font-size:28px; padding-bottom:10px;margin-left:15px;vertical-align:bottom;color:#000;">
                                           <span style="border-left:1px solid black;padding-left:10px;">Profile</span>
                                       </div>
                                   </div>
               ...
               <div class="row">
                   <div class="col-md-12">
                       <section class="section section-box section-main " style="padding:0px">
                          ...
                          <img src="/content/images/hlc-profile.png" style="width:1150px;display:block;margin-top:0px;"/>
