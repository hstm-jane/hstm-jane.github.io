...
$patterns['focus']['title'] = 'My Team: Assessments';
                    ...
                    <section class="section section-results" data-equalize="layout-columns">
                        ...
                        <section class="section">
                            ...
                            <?php
                                ...
                                $slat = array(
                                    'attributes' => array(
                                        array('class',array('slat','slat-spaced','slat-attention')),
                                    ),
                                ...
                                $slat = array(
                                    ...
                                    'title' => '<a href="#">2014 Performace Review: Jack White</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Assessment',
                                        ),
                                ...
                                $slat = array(
                                    ...
                                    'title' => '<a href="#">2014 Performace Review: Pat Morris</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Assessment',
                                        ),
                                ...
                                $slat = array(
                                    ...
                                    'title' => '<a href="#">2014 Performace Review: Sam Jones</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Assessment',
                                        ),
                                ...
                                $slat = array(
                                    ...
                                    'title' => '<a href="#">2015 Performace Review: Jack White</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Assessment',
                                        ),
                                ...
                                $slat['title'] = '<a href="#">2015 Performace Review: Jill Smith</a>';
                                echo createSlat($slat);

                                $slat['title'] = '<a href="#">2015 Performace Review: Joe Danford</a>';
                                echo createSlat($slat);

                                $slat['title'] = '<a href="#">2015 Performace Review: Pat Morris</a>';
                                echo createSlat($slat);

                                $slat['title'] = '<a href="#">2015 Performace Review: Sam Jones</a>';
                                echo createSlat($slat);
