                        ...
                        <div class="tab-pane fade in active" id="learning-activities">
                            <section>
                                ...
                                $slat = array(
                                    ...
                                    'action' => array(
                                        'type' => 'custom',
                                        'content' => '<div class="action"><a class="btn btn-sm btn-default disabled" href="attachment-incomplete"><i class="fa fa-lock"></i> Locked</a></div>',
                                    ),
                                    'attributes' => array(
                                        array('class',array('slat')),
                                    )
            ...
            <div class="col-md-3">
                <section class="section section-sidebar" data-equalize="layout-columns">
                    <section class="section section-box">
                        <h3>Options</h3>
                        <p>This course is voluntary and allows for unenrollment.</p>
                        <hr>
