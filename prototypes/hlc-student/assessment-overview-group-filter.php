...
$assessments_grouped_by_title = array_group_by($assessments, 'title');
$assessments_grouped_by_employee = array_group_by($assessments, 'employee');
?>
                    ...
                    <div class="container">
                        <section class="section section-main section-box">
                            <div class="tab-content">
                                <!-- //////// START Tab 1 - Assessment Overview ///////// -->
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="section-header-action hidden-xs">
                                                        <div class="action action-split">
                                                            ...
                                                            <div class="btn-group">
                                                                <button type="button" class="btn btn-default btn-sm hidden-xs dropdown-toggle" data-toggle="dropdown"> Group <span class="caret"></span> </button>
                                                                <ul class="dropdown-menu  dropdown-menu-right">
                                                                    <li class=""><a href="#tab-2" data-toggle="tab" class="group group-state">Group by Assessment State</a></li>
                                                                    <li class=""><a href="#tab-3" data-toggle="tab" class="group group-title">Group by Assessment Title</a></li>
                                                                    <li class=""><a href="#tab-4" data-toggle="tab" class="group group-name">Group by Employee Name</a></li>
                                                                    <li role="separator" class="divider"></li>
                                                                    <li class=""><a href="#tab-1" data-toggle="tab" class="group group-ungroup">Ungroup</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    array(
                                        ...
                                        'html' => '
                                            ...
                                            <div class="btn-group dropup">
                                                    <button type="button" class="btn btn-default btn-sm hidden-xs dropdown-toggle" data-toggle="dropdown"> Group  <i class="fa fa-caret-up"></i> </button>
                                                    <ul class="dropdown-menu">
                                                        <li class=""><a href="#tab-2" data-toggle="tab" class="group group-state">Group by Assessment State</a></li>
                                                        <li class=""><a href="#tab-3" data-toggle="tab" class="group group-title">Group by Assessment Title</a></li>
                                                        <li class=""><a href="#tab-4" data-toggle="tab" class="group group-name">Group by Employee Name</a></li>
                        ...
                        ?> </div>
                                <!-- //////// END Tab 1 - Assessment Overview ///////// -->


                                <!-- /////// START Tab 2 - Group by State ///////// -->
                                <div class="tab-pane" id="tab-2">
                                    <section class="section">
                                        <header class="section-header">
                                            <div class="row">
                                                <div class="col-sm-9">
                                                    <h2 class="section-header-title">Assessments by State</h2>
                                                </div>
                                                <div class="col-sm-3">
                                                     <div class="section-header-action hidden-xs">
                                                        <div class="action action-split">
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab" class="filter-from-group filter-from-group-review">In Review State</a> <span class="badge badge-review">0</span>',
                                'meta' => array(
                                    array(
                                    ...
                                    array(
                                        'label' => 'Due:',
                                        'value' => date('M j, Y',strtotime('-60days')) . ' <a href="#">First of 3 Due</a></span>',
                                        'attributes' => array(
                                ...
                                'action' => array(
                                    'type' => 'custom',
                                    'content' => '<div class="action action-single">
                                        <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs filter-from-group filter-from-group-review">View</a>
                                    </div>',
                                ),
                            );
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab" class="filter-from-group filter-from-group-assigned">In Assigned State</a> <span class="badge badge-assigned">0</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                                ...
                                'action' => array(
                                    'type' => 'custom',
                                    'content' => '<div class="action action-single">
                                        <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs filter-from-group filter-from-group-assigned">View</a>
                                    </div>',
                                ),
                            );
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab" class="filter-from-group filter-from-group-approval">In Approval State</a> <span class="badge badge-approval">0</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                                ...
                                'action' => array(
                                    'type' => 'custom',
                                    'content' => '<div class="action action-single">
                                        <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs filter-from-group filter-from-group-approval">View</a>
                                    </div>',
                                ),
                            );
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab" class="filter-from-group filter-from-group-evaluate">In Evaluation State</a> <span class="badge badge-evaluate">0</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                                ...
                                'action' => array(
                                    'type' => 'custom',
                                    'content' => '<div class="action action-single">
                                        <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs filter-from-group filter-from-group-evaluate">View</a>
                                    </div>',
                                ),
                            );
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab" class="filter-from-group filter-from-group-closed">In Closed State</a> <span class="badge badge-closed">0</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                                ...
                                'action' => array(
                                    'type' => 'custom',
                                    'content' => '<div class="action action-single">
                                        <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs filter-from-group filter-from-group-closed">View</a>
                                    </div>',
                                ),
                            );
                        ...
                        ?>
                                ...
                                <!-- /////// END Tab 2 - Group by State ///////// -->



                                <!-- /////// START Tab 3 - Group by Title ///////// -->
                                <div class="tab-pane" id="tab-3">
                                    <section class="section">
                                        <header class="section-header">
                                            <div class="row">
                                                <div class="col-sm-9">
                                                    <h2 class="section-header-title">Assessments by Title</h2>
                                                </div>
                                                <div class="col-sm-3">
                                                     <div class="section-header-action hidden-xs">
                                                        <div class="action action-split">
                                        ...
                                        $titles = array();
                                        foreach ($assessments_grouped_by_title as $group) {

                                            $titles[] = array($group[0]['title'], count($group), $group[0]['date'], $group[0]['title-id']);
                                        }
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab" class="filter-from-title-group filter-from-title-group-' . $title[3] .'">' . $title[0] . '</a> <span class="badge">' . $title[1] . '</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                                    array(
                                        'label' => 'Due:',
                                        'value' => $title[2] . ' <a href="#">First of ' . $title[1] . ' Due</a></span>',
                                        'attributes' => array(
                                            array('class','meta-callout'),
                                        )
                                    ),
                                ...
                                'action' => array(
                                    ...
                                    'content' => '<div class="action action-split">
                                        <div class="btn-group">
                                            <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs filter-from-title-group filter-from-title-group-' . $title[3] .'">View</a>
                                            <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-down"></i></a>
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="#tab-1" data-toggle="tab" >View</a></li><li><a href="#">Manage Rater &amp; Peers</a></li><li><a href="#">Manage Dynamic Sections</a></li>
                                            </ul>
                                        </div>
                                    </div>',
                                ),
                        ...
                        ?>
                                ...
                                <!-- /////// END Tab 3 - Group by Assessment Title ///////// -->

                                  <!-- /////// START Tab 4 - Group by Employee Name ///////// -->
                                <div class="tab-pane" id="tab-4">
                                    <section class="section">
                                        <header class="section-header">
                                            <div class="row">
                                                <div class="col-sm-9">
                                                    <h2 class="section-header-title">Assessments by Employee</h2>
                                                </div>
                                                <div class="col-sm-3">
                                                     <div class="section-header-action hidden-xs">
                                                        <div class="action action-split">
                                        ...
                                        $employees = array();
                                        foreach ($assessments_grouped_by_employee as $group) {

                                            $employees[] = array($group[0]['employee'], count($group), $group[0]['date'], $group[0]['empid']);
                                        }
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab" class="filter-from-emp-group filter-from-emp-group-' . $employee[3] .'">' . $employee[0] . '</a> <span class="badge">' . $employee[1] . '</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                                    array(
                                        'label' => 'Due:',
                                        'value' => $employee[2] . ' <a href="#">First of ' . $employee[1] . ' Due</a></span>',
                                        'attributes' => array(
                                            array('class','meta-callout'),
                                        )
                                    ),
                                ...
                                'action' => array(
                                    ...
                                    'content' => '<div class="action action-split">
                                        <div class="btn-group">
                                            <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs filter-from-emp-group filter-from-emp-group-' . $employee[3] .'">View</a>
                                            <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-down"></i></a>
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="#tab-1" data-toggle="tab" >View</a></li><li><a href="#">Manage Rater &amp; Peers</a></li><li><a href="#">Manage Dynamic Sections</a></li>
                                            </ul>
                        ...
                        ?>
                                ...
                                <!-- /////// END Tab 4 - Group by Employee Name ///////// -->
                            </div>
                        </section>
                    </div>
                    <!-- /container -->
                                        ...
                                        <select class="form-control" id="filter-title">
                                            <option value="all">All</option>
                                              <?php foreach($titles as $title) { ?>
                                                <option value="<?= $title['3'] ?>"><?= $title['0'] ?></option>
                                              <?php } ?>
                                        </select>
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <select class="form-control" id="filter-employee">
                                            <option value="all">All</option>
                                             <?php foreach($employees as $employee) { ?>
                                                <option value="<?= $employee['3'] ?>"><?= $employee['0'] ?></option>
                                              <?php } ?>
                                        </select>
                                    </div>
                                </section>
