<form action="?" method="GET" novalidate="novalidate" class="form">
                       <ul class="stepper " style="padding-left:0px;">
                           <li class="step active step1 canclick">
                               ...
                               <div class="step-content " style="display: block;">
                                   ...
                                   <div class="row">
                                       <div class="form-group col-lg-12">
                                           <label  class="control-label">Alternate Email Address <small><a href="#">(Why do you need this?)</a></small></label>
                                           <div class="row">
                                               <div class="col-lg-8">
                                   ...
                                   <div class="row">
                                       <div class="step-actions">
                                           ...
                                           <div class="step-actions-right">
                                               <button class="waves-effect waves-dark button-primary button  next-step">Save and Continue</button>
                                           </div>
                                       </div>
                                   </div>
                                 </div>
                           </li>
                           <li class="step step2 canclick">
                               ...
                               <div class="step-content">
                                   ...
                                   <div class="step-actions">
                                       ...
                                       <div class="step-actions-right">
                                           ...
                                           <button class="waves-effect waves-dark button button-primary  next-step">Save and Continue</button>
                                       </div>
                                   </div>
                               </div>
                           </li>
                           <li class="step step2 canclick">
                               <div class="step-title waves-dark waves-effect">Add Resuscitation Card</div>
                               <div class="step-content">
                                   <div class="row">
                                       <div class="form-group col-lg-12">
                                           ...
                                           <div class="row">
                                               <div class="col-lg-9">
                                                   <select class="form-control">
                                                       <option>Choose a Certificate</option>
                                                   </select>
                                               </div>
                                           </div>
                                       </div>
                                   ...
                                   <div class="row">
                                       <div class="col-sm-6">
                                           <div class="form-group">
                                               <label class="control-label">
                                                   Certification Number&nbsp;<small>Optional</small>
                                               </label>
                                               <input class="form-control"  name="LicenseNumber" type="text" value="">
                                               <span class="help-block"><span class="field-validation-valid" data-valmsg-for="LicenseNumber" data-valmsg-replace="true"></span></span>
                                           </div>
                           ...
                           <li class="step step2 canclick">
                               ...
                               <div class="step-content">
                                   <div class="row">
                                       <div class="col-lg-12">
                                           This will be your own personal HealthStream account. Your NRP information will be accessible whenever you access HealthStream at other healthcare organizations with this account. <a href="#">Tell me more...</a>
                                       </div>
                                   </div>
                                   <div class="row">
                                       <div class="form-group col-lg-6">
                                   ...
                                   <div class="row">
                                       <div class="col-lg-12">
                                           <div style="left:20px;">
                                               <input type="checkbox" class="" style="position:static !important; margin-right:5px !important;opacity:1; " value=""> Yes, I have read the <a href="#">Terms of Use</a>.
                                           </div>
                                       </div>
                                   </div>
                                   <div class="step-actions">
                                       ...
                                       <div class="step-actions-right">
                                           <button class="waves-effect waves-dark button button-default   previous-step">Back</button>
                                           <button class="waves-effect waves-dark button button-primary  next-step">Create NRP Account</button>
                                       </div>
                                   </div>
                               </div>
                           </li>
