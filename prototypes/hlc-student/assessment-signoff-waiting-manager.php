...
<body><div class="site-header ">
    <div class="container">
        ...
        <nav class="nav-account">
            <div class="name">Misty R. Peeples</div>
            <div class="avatar">
                <i class="fa fa-user"></i>
                <img src="https://s3.amazonaws.com/uifaces/faces/twitter/mtnmissy/128.jpg">
            </div>
...
<li><span class="meta-label">For Assessment:</span><span class="meta-value">Initial Nursing Competency Appraisal</span></li>
    ...
    <div class="container">
        ...
        <div class="assessment-header">
            <div class="assessment-return">
                <a href="assessment-overview.php"><i class="fa fa-fw fa-chevron-left"></i>Return to Rater Overview</a>
            </div>
        </div>
            <section class="section assessment-action-section" id="jump-signoff">
                <h3>Waiting for Manager Sign Off</h3>
                 <p>You cannot proceed until the Manager has signed off on their ratings.</p>

                 <form class="validate">
                    <div class="form-group">
                        <label class="control-label">Employee's Comments</label>
                        <blockquote class="signoff-no-comments">No Comments Entered</blockquote>
                    </div>

                     <div class="form-group">
                        <label class="control-label">Rater's Comments</label>
                         <blockquote  class="signoff-comments">The employee ratings were outside of the criteria and need to be reviewed by a manager.</blockquote>
                    </div>
                </form>
              <p>  <button class="btn btn-default">Return</button></p>
            </section>
 <section class="section page-header">
           
            <h2>Initial Nursing Competency Appraisal
        <span class="assessment-subtitle">
            Assessment Rating:  <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending <i class="fa fa-fw fa-info-circle"></i></a>
                 |  <a href="#modal-state-detail-approval" data-toggle="modal">View Approval Activity</a>
    ...
    <header class="section-header">
        <h2>Essential Attributes of Medical Surgical RNs<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="statement">
    <div class="summary">
        <div class="basics">
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
    ...
    <header class="section-header">
        <h2>Nursing Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="statement">
    <div class="summary">
        <div class="basics">
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
    ...
    <header class="section-header">
        <h2>Med-Surg Core Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="statement">
    <div class="summary">
        <div class="basics">
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
...
<li><span class="meta-label">Status:</span><span class="meta-value">In Progress</span></li>
<li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>Jul 28, 2016</span></li>
</ul>
</div>
</div>
...
<!-- /PROTOTYPE ONLY -->
    ...
    <script src="/scripts/prototype.validation/framework/bootstrap.min.js"></script><script>
    $(function(){
        $('.statement')
