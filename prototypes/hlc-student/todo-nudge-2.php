...
else if ( $_SERVER['HTTP_HOST'] == 'hstm-hccdemo-employee.patternmanager.com') {
    $patterns['header'] = array(
        'classes' => array('site-header--assessments'),
                ...
                <section class="section section-main section-box" data-equalize="layout-columns">
                    <div class="filter-mini" data-target="tasks">
                        <div class="filter-row">
                            ...
                            <div class="filter-cell">
                                <ul>
                                    <li><label class="checkbox"><input type="checkbox" value='all' checked> All Tasks</label></li><li><label class="checkbox"><input type="checkbox" value="1"> Assigned Learning</label></li><li><label class="checkbox"><input type="checkbox" value="2"> Live Classes</label></li><li><label class="checkbox"><input type="checkbox" value="3"> Elective Learning</label></li><li><label class="checkbox"><input type="checkbox" value="4"> Profile Tasks</label></li><li><label class="checkbox"><input type="checkbox" value="5"> Assessments</label></li><li><label class="checkbox"><input type="checkbox" value="6"> Certifications</label></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <?php if ( isset($_GET['nudge'])) { ?>
                        <div class="alert alert-warning alert-nudge" style="margin-bottom: 7px;">
                            <div class="nudge-container">
                                <div class="title"><i class="fa fa-exclamation-circle" style="color: #8a6d3b;"></i>
                                    <a class="trigger_resus-filter alert-warning" href="#">You have one assignment related to a certification that expires soon.</a>
                                </div>
                                 <div class="action">
                                        <a class="btn btn-sm btn-default cert-filter" href="#">
                                            View
                    ...
                    $slat = array(
                        'attributes' => array(
                            array('class',array('slat','slat-callout','slat-spaced', 'slat-attention')),
                            array('data-filter-category',array('6')),
                        ),
                        'title' => '<a href="assessment.php?assessment=competency-14&user=peer-1">Basic Life Support (BLS) Program</a>',
                        'meta' => array(
                            array(
                                'type' => 'Curriculum',
                            ),
                            ...
                            array(
                                ...
                                <div><i class="fa fa-exclamation-circle"></i> At-Risk Certification</div>',
                                'attributes' => array(
                    ...
                    <?php if ( isset($_GET['alt-orange'])) { ?>
                    <?php
                    $slat = array(
                        'attributes' => array(
                            array('class',array('slat','slat-callout','slat-spaced', 'slat-attention')),
                            array('style', array('background-color: rgb(240,173,78,30%); border-left-color: #B55800!important; margin-bottom: 20px;')),
                            array('data-filter-category',array('6')),
                        ),
                        'title' => '<a style="color: #B55800;" href="assessment.php?assessment=competency-14&user=peer-1">Basic Life Support (BLS) Program</a>',
...
<?php if ( isset($_GET['nudge'])) { ?>
                    ...
                    $slat = array(
                        ...
                        'meta' => array(
                            ...
                            array(
                                'label' => 'Due: ',
                                'value' => '<div>Due: '.date('M j, Y',strtotime('+30days')).'</div>',
                                'attributes' => array(
                                    array('class','meta-callout'),
                                )
                            ),
...
<?= createSiteScripts(); ?>
    ...
    <script>
        ...
        $('.cert-filter').click(function(){
            $('input[value="6"]').trigger('click');
        });

        $('.filter-cell').change(function(){
            if( $('input:checked').val() === '6' ){
                $('.alert-nudge:first').show();
                $('.cert-filter, .alert-nudge:last').hide();
            }
            else if( $('input:checked').val() === 'all' ){
                $('.alert-nudge, .cert-filter').show();
            }
            else if ( $('input:checked').val() === '5' ){
                $('.alert-nudge:last').show();
            }
            else {
                $('.alert-nudge').hide();
            }
