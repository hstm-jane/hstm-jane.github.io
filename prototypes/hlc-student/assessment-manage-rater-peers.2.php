        ...
        <div class="col-md-12">
            <section class="section section-main section-box">
                ...
                <section class="section" style="margin-bottom:30px!important">
                    <h3 style="font-weight:600">Assessment: Initial Nursing Competency Appraisal</h3>
                        ...
                        <div class="col-xs-12">
                            <div class="pull-left">
                                ...
                                <!--<h3 style="margin:0;">Assessments:  <small> (Optional) Assign the above raters and/or peers to the selected assessments below</small></h3>-->
                                 <h4 style="margin:0;"><strong style="font-weight:600;">Bulk Assign:</strong> Optionally select additional employees with this assessment to assign the selected raters and peers to</h4>
                            </div>
