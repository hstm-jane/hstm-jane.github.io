...
<body>
    ...
    <div class="login-window modal">
        <div class="modal-header">
            <div class="branding">
                <!-- <img src="/content/images/verity-logo.jpg"> -->
                <div style="font-size:28px;margin:20px">LMS Login</div>
            </div>
           <!--  <div class="nav-tabs">
                <a href="#tab-signin" class="nav-tab selected">Sign In</a>
                <a href="#tab-instructions" class="nav-tab">Instructions</a>1
            </div> -->
        </div>
                  ...
                  <!--   <div class="login-with-hstream-new">
                    ...
                    <form class="signin-form">
                        ...
                        <div class="nav-buttons">
                            <a href="../hstream-workflow.lms.php?workflow=1&persona=5" class="button button-primary" id="button-login">Sign In</a>
