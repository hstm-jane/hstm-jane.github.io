...
================================================== -->
  ...
  <style>
    ...
    .slat-schedule .slat-icon {
      ...
      /* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#fffcf3+57,fffcf3+57,fff4dd+96 */
      background: #fffcf3;
      /* Old browsers */
      background: -moz-radial-gradient(center, ellipse cover, #fffcf3 57%, #fffcf3 57%, #fff4dd 96%);
      /* FF3.6-15 */
      background: -webkit-radial-gradient(center, ellipse cover, #fffcf3 57%, #fffcf3 57%, #fff4dd 96%);
      /* Chrome10-25,Safari5.1-6 */
      background: radial-gradient(ellipse at center, #fffcf3 57%, #fffcf3 57%, #fff4dd 96%);
      /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
      filter: progid: DXImageTransform.Microsoft.gradient( startColorstr='#fffcf3', endColorstr='#fff4dd', GradientType=1);
    ...
    .slat-icon-moc-curriculum i,
    .slat-icon-moc-curriculum .slat-icon-label {
      color: #1797be;
    }
