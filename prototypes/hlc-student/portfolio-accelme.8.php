...
.card.card-experience .cover{
  background-color: #0e7c7B;
}
.card.card-experience .user{
  background-color:#0e7c7B;
}
...
.points{
  ...
  margin-top:5px;
                    ...
                    <div class="container accel-me-container">
                      ...
                      <div class="row">
                        <div class="col-md-10">
                          <h3> You are on <b>Level 2</b> of your <a><b>Professional Advancement <i class="fa fa-chevron-down"></i></b></a> Journey </h3>
                        </div>
                        <div class="col-md-2 text-right">
                          <div class="btn-group btn-block ">
                            <button type="button" class="btn btn-info btn-block dropdown-toggle" data-toggle="dropdown">Change Card Deck <i class="fa fa-caret-down"></i></button>
                            <ul class="dropdown-menu" role="menu">
                            <li class="active">
                                <a href="#">All Cards</a>
                              </li>
                              <li >
                                <a href="#">Education Cards</a>
                              </li>
                              <li>
                                <a href="#">Experience Cards</a>
                              </li>
                              <li>
                                <a href="#">Leadership Cards</a>
                              </li>
                        ...
                        <ul class="breadcrumb">
                          <li class="completed">
                            <a href="javascript:void(0);">Level 1 
                              <div class="progress">
  ...
  <li><a href="javascript:void(0);">Level 3  <div class="progress">
    <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width:30%">
      <span>30% </span>
    </div>
  </div></a></li>
  <li><a href="javascript:void(0);">Level 4 <div class="progress">
    <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width:0%">
      <span>0% </span>
    </div>
  </div></a></li>
  <li><a href="javascript:void(0);">Level 5 <div class="progress">
  ...
  <div class="container" style="margin-top:25px;">
    <div class="row">
             ...
             <div class="card-container manual-flip">
                <div class="card card-education">
                    <div class="front">
                        ...
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Attend 1 In-Service</h3>
                    ...
                    <div class="back">
                        ...
                        <div class="content">
                            <div class="main">
                                <h4 class="text-center">You've found a hidden badge!</h4>
                                <p class="text-center">This is the Card Flipper Badge. </p>
            ...
            <div class="card-container">
                <div class="card card-education">
                    <div class="front">
                        ...
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Earn 15 CE hours</h3>
             ...
             <div class="card-container manual-flip">
                <div class="card card-leadership">
                    <div class="front">
                        ...
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Provide 1 In-Service</h3>
                    ...
                    <div class="back">
                        <div class="header">
                            <h5 class="motto">"Leadership Card"</h5>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h4 class="text-center">You've found a hidden badge!</h4>
      ...
      <div class="row">
             <div class="col-md-3  col-sm-6">
             <div class="card-container manual-flip">
                <div class="card card-innovation">
                    <div class="front">
                        <div class="cover">
                        ...
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Committee Member in 1 Unit/Department</h3>
            ...
            <div class="col-md-3 col-sm-6">
             <div class="card-container manual-flip">
                <div class="card card-profession-engagement">
                    <div class="front">
                        <div class="cover">
                            <img src="https://www.clipartsgram.com/image/124089475-california-beaches-tumblr-wallpaper-3.jpg"/>
                            <p class="points"> 10 points </p>
                        ...
                        <div class="content">
                            <div class="main">
                                <h3 class="name">Professional Member of 1 Memebership</h3>
                    ...
                    <div class="back">
                        <div class="header">
                            <h5 class="motto">"Profession Engagement"</h5>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h4 class="text-center">Description</h4>
             ...
             <div class="card-container ">
                <div class="card card-experience">
                    <div class="front">
                        ...
                        <div class="content">
                            <div class="main">
                                <h3 class="name">24 Months of RN Experience</h3>
