                ...
                <div class="row">
                    <div class="col-md-12">
                        <section class="section section-box section-main " style="padding:0px 10px 0px 10px;">
                            ...
                            <a href="hstream.educate.monitor.2.php?org=<?= $org ?>" class="padbtn-utilize"></a>
                            <?php
                            if ($org == '3') {
                                //org = hca
                                echo ' <img src="/content/images/PAD-3-Mainline-size.png" nopin="nopin"/>';
                            }
                            else if ($org == '2') {
                                //org = hca
                                echo ' <img src="/content/images/PAD-3-Ascension-size.png" nopin="nopin"/>';
                            }
                            else if ($org == '1') {
                                //org = chs
                                echo ' <img src="/content/images/PAD-3-CHS-size.png" nopin="nopin"/>';
                            }
                            else {
                                echo ' <img src="/content/images/PAD-3-HCA-size.png" nopin="nopin"/>';
                            }
                            ?>
                        </section>
                    </div>
