...
<div id="modal-work-experience2" class="modal fade layout-wizard" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="#modal-welcome" class="btn btn-success" data-dismiss="modal" data-toggle="modal">Save</a> <a href="#modal-welcome" class="btn btn-default" data-dismiss="modal" data-toggle="modal">Cancel</a>
			</div>
		</div>
	</div>
</div>
...
<div id="modal-welcome" class="modal modal-welcome modal-capture fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
				...
				<h3 style="" class="text-left"> Please look over your current Work Experience. <img src="./content/images/time-work.svg" style="">
					<p >Get more value out of our system by keeping your Work Experience up-to-date!</p>
				</h3>
			...
			<div class="modal-body">
				...
				<div class="slat slat-ajax slat-callout slat-question" >
					...
					<div class="text-center slat-questions" >
						...
						<div class="update-old-record text-left">
