    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="title">Unrecognized Email Address</h3>

                <div class="form-group">
                    <p>You have entered an email address that is not recognized as having been used to register a HealthStream ID.</p>
                </div>

                <div class="form-group nav-buttons">
                    <a href="healthstream-id-forgot-password.php" class="btn btn-success" type="submit">Try Again</a>
                </div>
