...
?>
    ...
    ================================================== -->
        ...
        <title>Workforce Profile Dashboard | HealthStream</title>
        <!-- Styles
    ================================================== -->
    ...
    ================================================== -->
        ...
        .site-header .nav-main .app-drawer-container .app-drawer-icon:hover .label {
           color:#fff;
        }
        ...
        .site-header .nav-main .app-drawer-container .app-drawer-icon:hover .cls-1 {
            fill: #fff !important;
        }

        .site-header .nav-main .app-drawer-container .app-drawer-icon:hover .cls-2  {
            fill: #fff !important;
        }
        ...
        .site-header .nav-main .app-drawer-container.active .app-drawer-icon  .cls-2  {
            fill: #fff !important;
        }
        .site-header .nav-main .app-drawer-container.active .app-drawer-icon  .cls-1  {
            fill: #fff !important;
        }
        .site-header .nav-main .app-drawer-container.active .app-drawer-icon .label  {
          color:#fff;
        }
        .site-header .nav-main .app-drawer-container .app-drawer-icon:hover .site-header .nav-main .app-drawer-container.active .app-drawer-icon {
            color:#fff;
        }
        ...
        <div class="site-header site-header--assessments">
            <div class="container">
                    ...
                    <div class="branding" style="display:table;">
                      ...
                      <div style="display:table-cell;font-size:28px; padding-bottom:10px;margin-left:15px;vertical-align:bottom;width:500px;color:#000;">
                            <span style="border-left:1px solid black;margin-left:20px;padding-left:10px;">Workforce Profile Dashboard</span>
                          </div>
            ...
            <nav class="nav-main">
                <div class="container">
                  <ul id="nav" class="nav">
                                   ...
                                   <li class=""><a href="#">Hiring</a></li>
                                   <li class=""><a href="#">Tenure</a></li>
                                   <li class=""><a href="#">Span of Control</a></li>
                                   <li class=""><a href="#">Turnover</a></li>
                                   <li class=""><a href="#">Staff Details</a></li>
                                   <?php
               ...
               <div class="row">
                   <div class="col-md-12">
                       <section class="section section-box section-main " style="padding:0px">
                          ...
                          <img src="/content/images/blueprint.png" style="width:1150px;display:block;margin-top:0px;"/>
