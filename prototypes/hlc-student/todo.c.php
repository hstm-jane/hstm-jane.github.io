  ...
  <div class="site-header ">
    <div class="container">
      ...
      <style>
        ...
        .nav-main .app-drawer-icon:hover {
          /*background-color:#ddd;*/
        }
        
        .nav-main .app-drawer-icon .ad-icon {
          height: 20px;
          width: 20px;
          position: absolute;
          top: 12px;
        ...
        .nav-main .app-drawer-icon .ad-label {
          font-size: 9px;
          font-weight: 600;
          color: #999;
        ...
        .nav-main .dropdown-options,
        .nav-main .dropdown-options:focus,
        .nav-main .dropdown-options:hover {
        ...
        .nav-main .dropdown-options::after {
            top: -20px;
            border-bottom-color: #fff;
        }
        
        .nav-main .dropdown-options::after, .nav-main .dropdown-options::before {
            content: '';
            display: block;
            position: absolute;
            top: -20px;
        ...
        .nav-main .container .nav .app-drawer-container {
            float:right;
            padding-right:5px;
            margin-right:-5px;
        }
      ...
      <div class="container">
        <ul id="nav" class="nav">
          ...
          <li class="app-drawer-container" >
              <div class="UX_Orb ux_pulse ux_orb_sm ux_orb_harvest" id="CharmUX_orb_for_charm_839" title="click me" style="opacity: 1; display: block; position:absolute; right:10px;">
                <div class="innerOrb innerOrb1"></div>
                <div class="innerOrb innerOrb2"></div>
            </div>
  <div class="app-drawer-icon" >
          <!--<img src="/content/images/app_launcher_icon.png">-->
          <div class="ad-icon" id="applauncher">
  ...
  <script>
    $(function() {
      ...
      $(window).click(function() {
        ...
        $('.poweredByCharmUX').hide();

        $('.UX_Orb').click(function() {
            if ( $('#CharmUX_charm_839').hasClass("open")) {
                $('#CharmUX_charm_839').hide();
                $('#CharmUX_charm_839').removeClass("open");
            }
            else {
                
                 var pos = $(this).parents('.nav').position();
                 var width = $(this).parents('.nav').outerWidth();
                  console.log($(this).parents('.nav'));
                 console.log(pos);
                console.log(width);

                $("#CharmUX_charm_839").css({
                    position: "absolute",
                    top: (pos.top + 40) + "px",
                    left: ((pos.left + width) - $("#CharmUX_charm_839").outerWidth() - 30 ) + "px"
                }).show();
                // $('#CharmUX_charm_839').show();
                $($(this).parents('.nav')).append($("#CharmUX_charm_839"));
                $('#CharmUX_charm_839').addClass("open");
            }
        });
...
<script>
  //ent.location.protocol ? 'https://' : 'http://') + 'd25lwi78skvze0.cloudfront.net'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(clientcharms, s); })();
</script>
...
<script type="text/javascript">
    ...
    //     "transactionName": "YlxRYxdZWEcEVxBeCVsWZkUMF0JbAVtKVhZFFF9WEFZVXABGSgNIRVFD", 
    //     "queueTime": 0, 
    //     "applicationTime": 0, 
    //     "atts": "ThtSFV9DS0k=", 
...
<style type="text/css">
    ...
    .UX_Charm .ux_head i.close {
        -webkit-transition-delay: opacity 300ms ease;
        -moz-transition-delay: opacity 300ms ease;
        -o-transition-delay: opacity 300ms ease;
    ...
    .UX_Charm .ux_head i.close:hover,
    .UX_Charm .ux_head i.close:focus {
        opacity: .8;
    }
    ...
    .UX_Charm .ux_body .widgetIntro {
        float: left;
        width: 100%
    }
    
    .UX_Charm .ux_body .widgetHolder {
        clear: both;
        float: left;
        margin-top: 0.8em;
        width: 100%
    ...
    .UX_Charm .ux_body .widgetHolder .responseWidget {
        text-align: center
    }
    
    .UX_Charm .ux_body .widgetHolder .responseWidget .candidate,
    .UX_Charm .ux_body .widgetHolder .responseWidget .candidate:hover {
        cursor: pointer;
        color: #143468;
        text-decoration: none
    }
    
    .UX_Charm .ux_body .widgetHolder .responseWidget.smile .candidate,
    .UX_Charm .ux_body .widgetHolder .responseWidget.thumbs .candidate {
        margin: 0 8px 0 8px;
        font-size: 3em
    }
    
    .UX_Charm .ux_body .widgetHolder .responseWidget.fiveStar .candidate {
        margin: 0 0.07em 0 0.07em;
        font-size: 2em
    }
    
    .UX_Charm .ux_body .widgetHolder .comments {
        font-size: 0.95em
    }
    
    .UX_Charm .ux_body .widgetHolder .comments input {
        padding: 0.5em;
        float: right
    }
    
    .UX_Charm .ux_body .widgetHolder .comments textarea {
        padding: 0.5em;
        clear: both;
        float: right;
        height: 100px
    ...
    .UX_Charm .ux_body .widgetHolder .comments button {
        clear: both;
        float: right
    }
    ...
    .UX_Charm .ux_footer .poweredByCharmUX {
        margin-top: 8px;
        font-size: 9px
    }
    
    .UX_Charm .ux_footer a {
        opacity: .8;
        -webkit-transition-delay: opacity 300ms ease;
        -moz-transition-delay: opacity 300ms ease;
        -o-transition-delay: opacity 300ms ease;
    ...
    .UX_Charm .ux_footer a:hover,
    .UX_Charm .ux_footer a:focus {
        opacity: 1;
        text-decoration: underline
    }
    
    .UX_Charm.unresponded .brightenGold {
        color: #ffe243 !important
    }
    
    .UX_Charm.unresponded .brightenGold:hover {
        color: #ffd700 !important
    }
    
    .UX_Charm.unresponded .brightenGold.candidateChosen {
        color: #ffd700 !important
    }
    
    .UX_Charm.unresponded .toGreen:hover {
        color: #006207 !important
    }
    
    .UX_Charm.unresponded .toRed:hover {
        color: #d7071a !important
    }
    
    .UX_Charm.unresponded .toGold:hover {
        color: #ffd700 !important
    }
    
    .UX_Charm.responded .brightenGold {
        color: #ffe243 !important
    }
    
    .UX_Charm.responded .brightenGold.candidateChosen {
        color: #ffd700 !important
    }
    
    .UX_Charm.responded .toGreen.candidateChosen {
        color: #006207 !important
    }
    
    .UX_Charm.responded .toRed.candidateChosen {
        color: #d7071a !important
    }
    
    .UX_Charm.responded .toGold.candidateChosen {
        color: #ffd700 !important
    }
    
    .UX_Charm.responded .candidate {
    ...
    .UX_Charm.ux_light button {
        background-color: #428bca !important;
        color: #fff !important;
        border: 1pt solid #357ebd
    }
    
    .UX_Charm.ux_light button:hover {
    ...
    .UX_Charm.ux_md .ux_body {
        font-size: 1.2em
    }
    
    .UX_Charm.ux_md .ux_body .widgetHolder {
        font-size: 1.2em
    }
    ...
    .UX_Charm.ux_lg .ux_body {
        font-size: 1.4em
    }
    
    .UX_Charm.ux_lg .ux_body .widgetHolder {
        font-size: 1.2em
    }
    
    .UX_Charm.UX_Targeted {
    ...
    .UX_Charm.UX_Targeted.position_left_top {
        border-top-left-radius: 0px
    }
    
    .UX_Charm.UX_Targeted.position_right_top {
        border-top-right-radius: 0px
    }
    
    .UX_Charm.UX_Targeted.position_left_bottom {
        border-bottom-left-radius: 0px
    }
    
    .UX_Charm.UX_Targeted.position_right_bottom {
    ...
    .UX_Orb.ux_orb_xs.ux_pulse {
        height: 10px;
        width: 10px
    }
    
    .UX_Orb.ux_orb_xs.ux_pulse .innerOrb {
        height: 10px;
        width: 10px
    }
    
    .UX_Orb.ux_orb_xs.ux_pulse .innerOrb1:before {
        border-width: 3px;
        top: -3px;
        left: -3px
    }
    
    .UX_Orb.ux_orb_xs.ux_pulse .innerOrb2:before {
        border-width: 3px;
        top: -3px;
        left: -3px
    }
    
    .UX_Orb.ux_orb_sm.ux_pulse {
        height: 16px;
        width: 16px
    }
    
    .UX_Orb.ux_orb_sm.ux_pulse .innerOrb {
        height: 16px;
        width: 16px
    }
    
    .UX_Orb.ux_orb_sm.ux_pulse .innerOrb1:before {
        border-width: 4px;
        top: -4px;
        left: -4px
    }
    
    .UX_Orb.ux_orb_sm.ux_pulse .innerOrb2:before {
        border-width: 4px;
        top: -4px;
        left: -4px
    }
    
    .UX_Orb.ux_orb_md.ux_pulse {
        height: 28px;
        width: 28px
    }
    
    .UX_Orb.ux_orb_md.ux_pulse .innerOrb {
        height: 28px;
        width: 28px
    }
    
    .UX_Orb.ux_orb_md.ux_pulse .innerOrb1:before {
        border-width: 5px;
        top: -5px;
        left: -5px
    }
    
    .UX_Orb.ux_orb_md.ux_pulse .innerOrb2:before {
        border-width: 7px;
        top: -7px;
        left: -7px
    }
    
    .UX_Orb.ux_orb_lg.ux_pulse {
        height: 42px;
        width: 42px
    }
    
    .UX_Orb.ux_orb_lg.ux_pulse .innerOrb {
        height: 42px;
        width: 42px
    }
    
    .UX_Orb.ux_orb_lg.ux_pulse .innerOrb1:before {
        border-width: 6px;
        top: -6px;
        left: -6px
    }
    
    .UX_Orb.ux_orb_lg.ux_pulse .innerOrb2:before {
        border-width: 11px;
        top: -11px;
        left: -11px
    }
    
    .UX_Orb.ux_orb_xl.ux_pulse {
        height: 56px;
        width: 56px
    }
    
    .UX_Orb.ux_orb_xl.ux_pulse .innerOrb {
        height: 56px;
        width: 56px
    }
    
    .UX_Orb.ux_orb_xl.ux_pulse .innerOrb1:before {
        border-width: 7px;
        top: -7px;
        left: -7px
    }
    
    .UX_Orb.ux_orb_xl.ux_pulse .innerOrb2:before {
        border-width: 14px;
        top: -14px;
        left: -14px
    }
    
    .UX_Orb.ux_orb_xx.ux_pulse {
        height: 70px;
        width: 70px
    }
    
    .UX_Orb.ux_orb_xx.ux_pulse .innerOrb {
        height: 70px;
        width: 70px
    }
    
    .UX_Orb.ux_orb_xx.ux_pulse .innerOrb1:before {
        border-width: 8px;
        top: -8px;
        left: -8px
    }
    
    .UX_Orb.ux_orb_xx.ux_pulse .innerOrb2:before {
        border-width: 18px;
        top: -18px;
        left: -18px
    }
    
    .UX_Orb.ux_orb_dark.ux_questionMark {
        -webkit-transition-delay: text-shadow .1s linear;
        -moz-transition-delay: text-shadow .1s linear;
        -o-transition-delay: text-shadow .1s linear;
        transition: text-shadow .1s linear
    }
    
    .UX_Orb.ux_orb_dark.ux_questionMark:hover {
        text-shadow: 0 0 .2em #666, 0 0 .3em #666
    }
    
    .UX_Orb.ux_orb_dark.ux_questionMark i.fa-circle {
        color: #666
    }
    
    .UX_Orb.ux_orb_dark.ux_questionMark i.fa-question {
        color: #fff
    }
    
    .UX_Orb.ux_orb_dark.ux_pulse .innerOrb1:before {
        border-color: #666
    }
    
    .UX_Orb.ux_orb_dark.ux_pulse .innerOrb1:after {
        background-color: #666
    }
    
    .UX_Orb.ux_orb_dark.ux_pulse .innerOrb2:before {
        border-color: #aaa
    }
    
    .UX_Orb.ux_orb_dark.ux_pulse .innerOrb2:after {
        background-color: #71009b
    }
    
    .UX_Orb.ux_orb_light.ux_questionMark {
        -webkit-transition-delay: text-shadow .1s linear;
        -moz-transition-delay: text-shadow .1s linear;
        -o-transition-delay: text-shadow .1s linear;
        transition: text-shadow .1s linear
    ...
    .UX_Orb.ux_orb_light.ux_questionMark:hover {
        text-shadow: 0 0 .2em #fff8d4, 0 0 .3em #fff8d4
    }
    
    .UX_Orb.ux_orb_light.ux_questionMark i.fa-circle {
        color: #fff8d4
    }
    
    .UX_Orb.ux_orb_light.ux_questionMark i.fa-question {
        color: #666
    }
    
    .UX_Orb.ux_orb_light.ux_pulse .innerOrb1:before {
        border-color: #fff8d4
    }
    
    .UX_Orb.ux_orb_light.ux_pulse .innerOrb1:after {
        background-color: #fff8d4
    }
    
    .UX_Orb.ux_orb_light.ux_pulse .innerOrb2:before {
        border-color: #ffed8f
    }
    
    .UX_Orb.ux_orb_light.ux_pulse .innerOrb2:after {
        background-color: #ffed8f
    }
    
    .UX_Orb.ux_orb_harvest.ux_questionMark {
        -webkit-transition-delay: text-shadow .1s linear;
        -moz-transition-delay: text-shadow .1s linear;
        -o-transition-delay: text-shadow .1s linear;
        transition: text-shadow .1s linear
    ...
    .UX_Orb.ux_orb_harvest.ux_questionMark:hover {
        text-shadow: 0 0 .2em #f39306, 0 0 .3em #f39306
    }
    
    .UX_Orb.ux_orb_harvest.ux_questionMark i.fa-circle {
        color: #f39306
    }
    
    .UX_Orb.ux_orb_harvest.ux_questionMark i.fa-question {
        color: #fff
    }
    
    .UX_Orb.ux_orb_harvest.ux_pulse .innerOrb1:before {
        border-color: #f39306
    }
    
    .UX_Orb.ux_orb_harvest.ux_pulse .innerOrb1:after {
        background-color: #f39306
    }
    
    .UX_Orb.ux_orb_harvest.ux_pulse .innerOrb2:before {
        border-color: #ffd700
    }
    
    .UX_Orb.ux_orb_harvest.ux_pulse .innerOrb2:after {
        background-color: #f34e06
    }
    
    .UX_Orb.ux_orb_twilight.ux_questionMark {
        -webkit-transition-delay: text-shadow .1s linear;
        -moz-transition-delay: text-shadow .1s linear;
        -o-transition-delay: text-shadow .1s linear;
        transition: text-shadow .1s linear
    ...
    .UX_Orb.ux_orb_twilight.ux_questionMark:hover {
        text-shadow: 0 0 .2em #7481bd, 0 0 .3em #7481bd
    }
    
    .UX_Orb.ux_orb_twilight.ux_questionMark i.fa-circle {
        color: #7481bd
    }
    
    .UX_Orb.ux_orb_twilight.ux_questionMark i.fa-question {
        color: #fff
    }
    
    .UX_Orb.ux_orb_twilight.ux_pulse .innerOrb1:before {
        border-color: #7481bd
    }
    
    .UX_Orb.ux_orb_twilight.ux_pulse .innerOrb1:after {
        background-color: #7481bd
    }
    
    .UX_Orb.ux_orb_twilight.ux_pulse .innerOrb2:before {
        border-color: #6078e0
    }
    
    .UX_Orb.ux_orb_twilight.ux_pulse .innerOrb2:after {
        background-color: #0e1357
    }
    
    .UX_Orb.ux_orb_fire.ux_questionMark {
        -webkit-transition-delay: text-shadow .1s linear;
        -moz-transition-delay: text-shadow .1s linear;
        -o-transition-delay: text-shadow .1s linear;
        transition: text-shadow .1s linear
    ...
    .UX_Orb.ux_orb_fire.ux_questionMark:hover {
        text-shadow: 0 0 .2em #ea2828, 0 0 .3em #ea2828
    }
    
    .UX_Orb.ux_orb_fire.ux_questionMark i.fa-circle {
        color: #ea2828
    }
    
    .UX_Orb.ux_orb_fire.ux_questionMark i.fa-question {
        color: #fff
    }
    
    .UX_Orb.ux_orb_fire.ux_pulse .innerOrb1:before {
        border-color: #ea2828
    }
    
    .UX_Orb.ux_orb_fire.ux_pulse .innerOrb1:after {
        background-color: #ea2828
    }
    
    .UX_Orb.ux_orb_fire.ux_pulse .innerOrb2:before {
        border-color: #f00
    }
    
    .UX_Orb.ux_orb_fire.ux_pulse .innerOrb2:after {
        background-color: #f00
    }
    
    .UX_Orb.ux_questionMark {
        text-shadow: 0 0 .1em rgba(0, 0, 0, 0.2)
    }
    
    .UX_Orb.ux_pulse .innerOrb {
        -webkit-transition-delay: opacity 300ms ease;
        -moz-transition-delay: opacity 300ms ease;
        -o-transition-delay: opacity 300ms ease;
        transition: opacity 300ms ease;
    ...
    .UX_Orb.ux_pulse .innerOrb:hover,
    .UX_Orb.ux_pulse .innerOrb:focus {
        opacity: 1;
    }
    
    .UX_Orb.ux_pulse .innerOrb:before,
    .UX_Orb.ux_pulse .innerOrb:after {
        -webkit-animation: 2s infinite ease-in-out;
        animation: 2s infinite ease-in-out;
        height: 100%;
        width: 100%;
    ...
    .UX_Orb.ux_pulse .innerOrb1:before,
    .UX_Orb.ux_pulse .innerOrb1:after {
        content: ''
    }
    ...
    .UX_Orb.ux_pulse .innerOrb1:before {
        border-style: solid;
        opacity: 0.3;
        -webkit-animation-name: orbAnimate1;
        animation-name: orbAnimate1
    }
    
    .UX_Orb.ux_pulse .innerOrb2:before,
    .UX_Orb.ux_pulse .innerOrb2:after {
        content: ''
    }
    ...
    .UX_Orb.ux_pulse .innerOrb2:before {
        border-style: solid;
        opacity: 0.5;
        -webkit-animation-name: orbAnimate2;
        animation-name: orbAnimate2
    }
    
    @-webkit-keyframes orbAnimate1 {
        0% {
...
<div class="UX_Charm UX_Targeted unresponded ux_md ux_light" id="CharmUX_charm_839">
    <div style=" float: left;">
        <div class="ux_head"> </div>
        <div class="ux_body">
            <div class="widgetIntro">Now you can get to any of your HealthStream apps with one easy click! Exciting!</div>
            <div class="widgetHolder">
                <div class="responseWidget gotIt"> <button class="btn btn-primary" data-response="20">Got it</button></div>
            </div>
        </div>
        <div class="ux_footer">
            <div class="poweredByCharmUX"> <a target="_new" href="https://charmux.com">powered by Charm UX</a> </div>
        </div>
    </div>
</div>
...
<!--<div class="UX_Charm UX_Targeted unresponded ux_sm ux_light" id="CharmUX_charm_841">
    <div style="width: 100%; float: left;">
        <div class="ux_head"> </div>
        <div class="ux_body">
            <div class="widgetIntro">Now you can view Assessments on your To Do List! <br><br> We think this is pretty great! Do you agree?</div>
            <div
                class="widgetHolder">
                <div class="responseWidget thumbs"> <i class="toRed fa fa-thumbs-o-down candidate" data-response="0"></i> <i class="toGreen fa fa-thumbs-o-up candidate"
                        data-response="20"></i></div>
        </div>
    </div>
    <div class="ux_footer">
        <div class="poweredByCharmUX"> <a target="_new" href="https://charmux.com">powered by Charm UX</a> </div>
