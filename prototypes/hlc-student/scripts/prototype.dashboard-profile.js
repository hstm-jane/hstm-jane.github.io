...
$(function() {
    ...
    var hoverProfileCard = '<img src="/content/images/prototype-actors/brynn.jpg" alt="Contact" class="media-object img-circle img-thumbnail thumb96 hcard-image">' +
        ...
        '<div class="hcard-data-item"><i class="fa fa-fw fa-laptop"></i><a hhref="#modal-message-single" data-toggle="modal">mchambers@jupiterhealth.net</a></div>' +
        '</div>' +
