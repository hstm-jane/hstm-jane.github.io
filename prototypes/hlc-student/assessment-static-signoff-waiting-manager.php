...
<div class="layout layout-assessment">
        ...
        <section class="section section-main section-box">
            ...
            <section class="section assessment-action-section" id="jump-signoff">
                <h3>Waiting for Manager Sign Off</h3>
                  <p>You cannot proceed until the Manager has signed off on the ratings.</p>
                ...
                <form class="validate">
                    ...
                    <div class="form-group">
                        <label class="control-label">Rater's Comments <small>Optional</small></label>
                       <blockquote class="signoff-comments">The employee ratings were outside of the criteria and need to be reviewed by a manager.</blockquote>
                                ...
                                <button class="btn btn-default btn-sm">Return to Rater Overview</button>
            </section>
    ...
    <header class="section-header">
        <h3>Essential Attributes of Medical Surgical RNs<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h3>
    </header>
    <div class="statement">
    <div class="summary">
        <div class="basics">
    ...
    <header class="section-header">
        <h3>Nursing Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h3>
    </header>
    <div class="statement">
    <div class="summary">
        <div class="basics">
    ...
    <header class="section-header">
        <h3>Med-Surg Core Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h3>
    </header>
    <div class="statement">
    <div class="summary">
        <div class="basics">
