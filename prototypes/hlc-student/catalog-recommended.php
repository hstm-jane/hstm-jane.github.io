...
$slat = array(
    ...
    'description' => 'Recommended based on <a href="#modal-recommendation" data-toggle="modal"> exam history</a>.',
    ...
    <div id="modal-recommendation" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                    <h4 class="modal-title">Recommended Course</h4>
                </div>
...
$slat = array(
    ...
    'action' => array(
        'type' => 'action-single',
        'content' => '<i class="fa fa-info visible-xs"></i> Ignore',
