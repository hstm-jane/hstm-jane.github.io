                ...
                <div class="tab-pane fade in active" id="tab-2">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            .cetracker__group + .cetracker__group {
                                margin-top: 20px;
                            }

                            .cetracker__group-title {
                                font-size: 18px;
                                font-weight: 300;
                                line-height: 1.1;
                                color: #555;
                            ...
                            .cetracker__item-title {
                                font-size: 13px;
                                font-weight: 600;
                            }
                            .cetracker__item-expiration {
                                font-size: 12px;
                            }
                            .cetracker__item-expiration span {
                                text-transform: uppercase;
                                font-weight: 700;
                                font-size: 11px;
                            }
                            .cetracker__item-progress .progress {
                                margin: 5px 0 0;
                                background: #CCC;
                            }
                            ...
                            .cetracker__overview-column {
                                display: table-cell;
                                width: 50%;
                            }
                            .cetracker__overview-column + .cetracker__overview-column {
                                padding-left: 10px;
                            }
                            .cetracker__stat {
                                text-align: center;
                            ...
                            <section class="section section--cetracker">
                                <h2>CE Tracker</h2>

                                <div class="cetracker__group">
                                    <div class="cetracker__overview">
                                        <div class="cetracker__overview-column">
                                            <div class="cetracker__stat">
                                                <div class="cetracker__stat-label">Lifetime</div>
                                                <div class="cetracker__stat-value">440</div>
                                            </div>
                                        </div>
                                        <div class="cetracker__overview-column">
                                            <div class="cetracker__stat">
                                                <div class="cetracker__stat-label">This Year</div>
                                                <div class="cetracker__stat-value">12</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cetracker__group">
                                    <div class="cetracker__group-title">Licenses</div>
                                    <div class="cetracker__items">
                                        <div class="cetracker__item">
                                            <div class="cetracker__item-title">Registered Nurse, Georgia</div>
                                            <div class="cetracker__item-expiration"><span>Expires:</span> 1/31/2018</div>
                                            <div class="cetracker__item-progress">
                                                <div class="progress">
                                                    <div class="progress-bar" style="width:40%">12/30</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cetracker__group">
                                    <div class="cetracker__group-title">Certifications</div>
                                    <div class="cetracker__items">
                                        <div class="cetracker__item">
                                            <div class="cetracker__item-title">Acute/Critical Care Nursing (Adult)</div>
                                            <div class="cetracker__item-expiration"><span>Expires:</span> 3/31/2019</div>
                                            <div class="cetracker__item-progress">
                                                <div class="progress">
                                                    <div class="progress-bar" style="width:97%">73/75</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
