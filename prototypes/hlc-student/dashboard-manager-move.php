                    ...
                    <div class="portlets-wrapper">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6" id="portlet-1" data-toggle="portlet">
                                ...
                                <!-- START panel-->
                                <div id="" class="panel panel-default panel-knowledgeq"  style="overflow:hidden;">
                                    <div class="panel-heading">
                                        <div class="panel-title">Knowledge<span style="color:#D0021B;font-weight:600">Q</span></div>
                                        <div class="kebab" style="top:12px; right:12px;">
                                            <figure></figure>
                                            <figure class="middle"></figure>
                                            <p class="cross">x</p>
                                            <figure></figure>
                                    ...
                                    <div class="panel-body" style="min-height:330px;overflow:hidden;position:relative;">
                                     <a href="#" class="show-modal-knowledgeq">
                                    <div class="">
                                        <img src="https://s3.amazonaws.com/uifaces/faces/twitter/allisongrayce/128.jpg" alt="Contact" class="center-block img-responsive img-circle img-thumbnail thumb80">
                                        <!-- below is the code for when there is no picture - initals in grey circle-->
                                        <!-- <div class="img-circle img-thumbnail ">
                                            <div class="knowledgeq-initial-circle center-block"> DC </div>
                                        </div> -->
                                    </div>

                                    <div class="place" >
                                        <div class="place-value" style=
                                        "font-weight: 500!important;color:#777">3rd</div> <div class="place-label">Place</div>
                                    </div>
                                    <div class="completed" >
                                        <div class="place-value" style="font-weight: 500!important;color:#777">16</div> 
                                        <div class="place-label">Due in 30 days</div>
                                    </div>
                                    <div class="team-name" style="color:#777">
                                        Darcy's Team
                                    </div>
                                    ...
                                    <div class="last-place">
                                       <div class="last-place-label">last place</div>
                                       <div class="last-place-value">58%</div>
                                    </div>
                                    <div class="first-place">
                                        <div class="first-place-label">first place</div>
                                        <div class="first-place-value">100%</div>
                                    </div>
                                    <div class="metric-box-footer" style="transform: scale(1.15);
                                    font-size: 9.5px;
                                    text-transform: uppercase;
                                    color: #aaa;
                                    text-align: center;
