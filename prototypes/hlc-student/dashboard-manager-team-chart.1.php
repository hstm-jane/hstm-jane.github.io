                                                 ...
                                                 <div class="panel-body">
                                                    <div class="row row-table">
                                                       ...
                                                       <div class="col-xs-8 text-center">
                                                          ...
                                                          <div class="pull-right"> <a href="dashboard-profile.php" type="button" class="btn btn-success btn-sm" ta1rget="_new">View Detail</a>
                                                          </div>
                                                       </div>
                                                    </div>
                                                 </div>
                                                  ...
                                                  <div class="panel-body">
                                                     <div class="row row-table">
                                                        ...
                                                        <div class="col-xs-8 text-center">
                                                           ...
                                                           <div class="pull-right"> <a href="dashboard-profile.php" type="button" class="btn btn-success btn-sm" target="_new">View Detail</a>
                                                           </div>
                                                        </div>
                                                     </div>
                                                  </div>
