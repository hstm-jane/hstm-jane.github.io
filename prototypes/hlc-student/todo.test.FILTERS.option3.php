...
<head>
    ...
    .filter-item .form-group .filter-label,
    .filter-item .form-group .filter-text {
        display: table-cell;
        vertical-align: middle;
        text-align: left;
        white-space: nowrap;
    ...
    .filter-dropdown-container .dropdown-menu {
        ...
        text-shadow: 1px 1px 0 #007aa3 !important;
    ...
    /* .filter-dropdown-container .nav { margin-bottom: 0; }
        .filter-dropdown-container .dropdown { position: static; }
        .filter-dropdown-container .dropdown-menu { width: 100%; text-align: center; }
        .filter-dropdown-container .dropdown-menu>li { display: inline-block; }*/
    </style>
</head>
...
<body>
                    ...
                    <section class="section section-main section-box" data-equalize="layout-columns">
                        <div class="filter-dropdown-container ">
                            <div class="btn-container">
                                <button class="btn btn-primary btn-filter-sort" type="button">Sort & Filter </button>
                            </div>
                            <div class="dropdown open">
                                <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> Dropdown
                                    <span class="caret"></span>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <div class="pull-right" style="color:#fff;">
                                        <a href="#" class="close-filter" style="color:#fff;">Close <i class="fa fa-times"></i></a>
                                    </div>
                                    <h3 class="pull-left" style="color:#fff;margin:0;">Sort & Filter</h3>
                                    <div class="clearfix"></div>
                                    <div class="filter-bar-row row1" id="row1">
                                        <div class="filter-item" style="text-align:left;margin-top:0px;padding-top:0px;vertical-align:top !important;">
                                            <div class="form-group" style="display:block; !important; margin:0;">
                                                <label class="control-label " style="color:#fff;font-weight:normal;font-size:16px;margin-top:15px;margin-bottom:10px;">Assignment:</label>
                                                <div class="filter-control" style="display:block;">
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Assigned" checked style="color:#fff;margin-right:7px;"> Assigned (13) </div>
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Elective" checked style="color:#fff;margin-right:7px;"> Elective (2) </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="filter-item" style="text-align:left;margin-top:0px;padding-top:0px;vertical-align:top !important;">
                                            <div class="form-group" style="display:block; !important; margin:0;">
                                                <label class="control-label " style="color:#fff;font-weight:normal;font-size:16px;margin-top:15px;margin-bottom:10px;">Task Type:</label>
                                                <div class="filter-control" style="display:block;">
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Assigned" checked style="color:#fff;margin-right:7px;"> Assessment (13) </div>
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Elective" checked style="color:#fff;margin-right:7px;"> Course (2) </div>
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Elective" checked style="color:#fff;margin-right:7px;"> Curriculum (2) </div>
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Elective" checked style="color:#fff;margin-right:7px;"> Live Class (2) </div>
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Elective" checked style="color:#fff;margin-right:7px;"> Profile Task (2) </div>
                                                    <div style="color:#fff;padding-right:15px;">
                                                        <input type="checkbox" class="pull-left " id="assignment" name="assignment" value="Elective" checked style="color:#fff;margin-right:7px;"> Virtual Class (2) </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="filter-item" style="text-align:left;margin-top:0px;padding-top:0px;vertical-align:top !important;">
                                            <div class="form-group" style="display:block; !important; margin:0;">
                                                <label class="control-label " style="color:#fff;font-weight:normal;font-size:16px;margin-top:15px;margin-bottom:10px;">Sort:</label>
                                                <div class="filter-control" style="display:block;">
                                                    <select class="form-control input-sm dd-filter" id="sort-type" style="width:150px;">
    ...
    $(function() {
        ...
        //     }
        // });
        // $('.filter-dropdown-container .dropdown').on('show.bs.dropdown', function(e){
        //     // e.preventDefault();
        //     console.log('has open. now hide');
        //     $(this).find('.dropdown-menu').first().stop(true, true).slideDown(10000, function(){
        //         //On Complete, we reset all active dropdown classes and attributes
        //         //This fixes the visual bug associated with the open class being removed too fast
        //         $('.filter-dropdown-container .dropdown').find('.dropdown-toggle').attr('aria-expanded','true');
        //         $('.filter-dropdown-container .dropdown').addClass('open');      
        //     });
        // });
        // $('.filter-dropdown-container .dropdown').on('hide.bs.dropdown', function(e){
        //    console.log('does not have open. now show');
        //    e.stopPropagation();
        //         // $('.filter-dropdown-container .dropdown .btn').dropdown('toggle');
        //     $(this).find('.dropdown-menu').first().stop(true, true).slideUp(10000, function(){
        //         //On Complete, we reset all active dropdown classes and attributes
        //         //This fixes the visual bug associated with the open class being removed too fast
        //         $('.filter-dropdown-container .dropdown').find('.dropdown-toggle').attr('aria-expanded','false');
        //         $('.filter-dropdown-container .dropdown').removeClass('open');      
        //     });
        // });
        $('.filter-dropdown-container .dropdown').on('show.bs.dropdown', function(e) {
            $(this).find('.dropdown-menu').first().stop(true, true).slideDown();
        ...
        //                    $('.btn-filter-sort').on('click', function(e){
        //                       // $('.filter-dropdown-container .dropdown-menu').toggle();
        //                       // console.log('shown');
        //                       if ($('.filter-dropdown-container .dropdown').hasClass('open')) {
        //                       // $('.dropdown').on('show.bs.dropdown', function(e){
        //                           // e.preventDefault();
        //                           console.log('has open. now hide');
        //                           $(this).find('.dropdown-menu').first().stop(true, true).slideDown(10000, function(){
