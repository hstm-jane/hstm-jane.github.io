...
<body class="static-assessment"><div class="site-header ">
    <div class="container">
        ...
        <nav class="nav-account">
            ...
            <a href="alerts.php" class="alerts"><span class="assessment-title-badge">3</span></a>
...
<li><span class="meta-label">State:</span><span class="meta-value">Evaluation</span></li>
<li><span class="meta-label">Due:</span><span class="meta-value">Dec 30, 2016</span></li>
</ul></div>
...
<div class="layout layout-assessment">
    ...
    <div class="badge">Assessment Summary</div>
   <h2>Initial Nursing Competency Appraisal
        <span class="average-rating">Assessment Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a> |    Approval Activity: <a href="#" href="#modal-state-detail-approval" data-toggle="modal">View<i class="fa fa-fw fa-info-circle"></i></a></span>
    </h2>
 <h4>Description</h4>
