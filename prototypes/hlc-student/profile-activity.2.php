                    ...
                    <div class="slat-group alert alert-warning">
                      <div class="slat-group-header">
                        <div class="slat-group-header-title">
                          ...
                          <h2>Certifications <a href="#" class="btn btn-warning btn-sm js-review-btn">Mark Section as Reviewed</a></h2>
                        </div>
...
?>
                  ...
                  <section class="section">
                    <div class="slat-group alert alert-warning">
                      <div class="slat-group-header ">
                        <h2>Education <a href="#" class="btn btn-warning btn-sm js-review-btn">Mark Section as Reviewed</a> </h2>
                      </div>
                      <div class="slat-group-content">
                        <div class="slat">
                  ...
                  <section class="section">
                    <div class="slat-group alert alert-warning">
                      <div class="slat-group-header">
                        <div class="slat-group-header-title">
                          <h2>Licenses <a href="#" class="btn btn-warning btn-sm js-review-btn">Mark Section as Reviewed</a></h2>
                        </div>
                        <div class="slat-group-header-actions">
