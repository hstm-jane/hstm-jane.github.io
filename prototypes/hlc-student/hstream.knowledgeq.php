...
<html lang="en">
   <head>
    ...
    <div class="wrapper branding">
        <img src="/content/images/hstream-logo.png" class="logo"/>
        <div class="title">Powered by hStream </div>
        
        <div class="items flex-container">
            <div class="box" data-link="hstream.knowledgeq.1.php">
                  <!--<div class="heading-container">
                    Option 1
                </div>-->
                <div class="image-container">
                   
                    <img src="/content/images/kq-ss-sm_1.png" class="product-tn"/>
                    <br><br>
                    <span class="heading-container">
                        Option 1: hStream in Footer
                    </span>
                </div>
            </div>
            <div class="box" data-link="hstream.knowledgeq.2.php">
                <!--<div class="heading-container">
                    Option 2
                </div>-->
                <div class="image-container">
                    
                    <img src="/content/images/kq-ss-sm_2.png" class="product-tn"/>
                    <br><br>
                    <span class="heading-container">
                        Option 2: powered by hStream in Footer
                    </span>
                </div>
            </div>
            <div class="box" data-link="hstream.knowledgeq.3.php">
                <!--<div class="heading-container">
                    Option 3
                </div>-->
                <div class="image-container">
                   
                    <img src="/content/images/kq-ss-sm_3.png" class="product-tn"/>
                    <br><br>
                    <span class="heading-container">
                        Option 3: hStream in Header
                    </span>
                </div>
            </div>
        </div>
        <div class="description">
            <div class="text">Build Data Driven Applications</div>
