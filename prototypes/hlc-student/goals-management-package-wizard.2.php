          ...
          <div class="row">
              <div class="col-md-3">
                    <section class="section wizard-nav" data-equalize="layout-columns">
                        ...
                        <p class="message-text">A package contains a like group of goals.</p>

                        <hr>

                        <div class="wizard-progress-links nav-focus">
                            <ul class="list-links">
                                <li class="link-step complete">
                                     <a href="#tab1" data-toggle="tab"> Create Package <i class="fa fa-check"></i></a>
                                </li>
                                <li class="link-step complete">
                                     <a href="#tab2" data-toggle="tab">Set Dates <i class="fa fa-check"></i></a>
                                </li>
                                <li class="link-step active">
                                     <a href="#tab3" data-toggle="tab">Rating Scale</a>
                                </li>
                                <li class="link-step">
                                     <a href="#tab4" data-toggle="tab">Link to Assessment Templates</a>
                                </li>
                                <li class="link-step">
                                     <a href="#tab5" data-toggle="tab">Configurations</a>
                                </li>
                                <li class="link-step">
                                     <a href="#tab6" data-toggle="tab">Review</a>
                                </li>
                            </ul>
                        </div>
                    </section>
...
<script src="/scripts/prototype.goals.wizard.1.js"></script>
<?= createSiteEnd(); ?>
