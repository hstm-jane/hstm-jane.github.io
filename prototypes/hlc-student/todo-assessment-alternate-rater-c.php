                ...
                <section class="section section-main section-box" data-equalize="layout-columns">
                    ...
                    <section class="section" id="tasks">
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-competency-employee-summary.php">ED Anticipatory Rounding - Siegharter, Robert F.</a>',
                            'meta' => array(
                                array(
                                ...
                                array(
                                    'label' => 'Due: ',
                                    'value' => '<span class="meta-callout-label">Due:</span> Feb 18, 2016',
                                    'attributes' => array(
                        ...
                        $nested .= createSlat($slat);

                        $slat = array(
                            'attributes' => array(
                                array('class',array('slat','slat-attention','slat-callout'))
                            ),
                            'title' => '<a href="assessment-competency-employee-summary.php">ED EMT CPI Class - Bloechl, Jenna A.</a>',
                            'meta' => array(
                                array(
                                    'type' => 'Employee Assessment',
                                ),
                                ...
                                array(
                                    'label' => 'Due: ',
                                    'value' => '<span class="meta-callout-label">Due:</span> Feb 20, 2016',
                                    'attributes' => array(
                                        array('class','meta-callout'),
                                    )
                                ),
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-competency-employee-summary.php">Anticipatory Rounding - Hernandez, Lorrie A.</a>',
                            'meta' => array(
                                array(
                                    'type' => 'Employee Assessment',
                                ),
                                ...
                                array(
                                    'label' => 'Due: ',
                                    'value' => '<span class="meta-callout-label">Due:</span> Apr 1, 2016',
                                    'attributes' => array(
                                        array('class','meta-callout'),
                                    )
                                ),
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-competency-employee-summary.php">Bladder Scan - Hahn, Joni D.</a>',
                            'meta' => array(
                                array(
                                    'type' => 'Employee Assessment',
                                ),
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-competency-employee-summary.php">Blood Specimen Collection - Hahn, Joni D.</a>',
                            'meta' => array(
                                array(
                                    'type' => 'Employee Assessment',
                                ),
                        ...
                        $nested .= '<div class="slat"><a href="assessment-overview.php">+ 236 More</a></div>';
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-overview.php">Employee Assessments</a>',
                            'meta' => array(
                                array(
                                    'type' => 'Employee Assessment',
                                ),
                                ...
                                array(
                                    'label' => 'Due: ',
                                    'value' => '<span class="meta-callout-label">Due:</span>Feb 18, 2016 <a href="assessment-overview.php">First of 241 Assessments</a>',
                                    'attributes' => array(
                                        array('class','meta-callout'),
                                    )
                                )
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-competency-employee-summary.php">ED Anticipatory Rounding</a>',
                            'meta' => array(
                                array(
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-competency-employee-summary.php">Care of the Surgical Patient - Jones, John D.</a>',
                            'meta' => array(
                                array(
...
<?= createSiteScripts(); ?>
    ...
    <script>
        $(function(){
            ...
            $('.focus .meta-value:eq(0)').text($('#tasks > .slat').length);

            if ( $('.slat-attention').length === 0 ) {
                $('.focus .meta-value:eq(1)').closest('li').remove();
            } else {
                $('.focus .meta-value:eq(1)').text($('#tasks > .slat-attention').length);
            }
        });
    </script>
