    ...
    <div class="container">
        <section class="section section-main section-box">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="tag-group">
                            ...
                            <a href="#" class="tag tag-type">Type: Employee<i class="fa fa-times"></i></a>
                        </div>
                    </div>
            ...
            <section class="section" style="margin-top: -30px;">
                ...
                <div class="assessment assessment--header assessment--checkable">
                        ...
                        <div class="assessment__summary">
                            <div class="assessment__basics">
                                <div class="assessment__title">
                                    <a href="assessment-wide.php">2016 Performance Assessment<span> - <?= $assessment['employee'] ?></span></a>
                                </div>
                                <ul class="meta">
                            ...
                            <div class="assessment__actions">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="assessment-wide.php">View Assessment</a></li>
                                        ...
                                        <li class="divider"></li>
                                        <li><a href="#">View Similar Assessments</a></li>
                                        <li class="divider"></li>
                            ...
                            'html' => '
                                ...
                                <div class="btn-group dropup">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="#" class="js-checkbox-toggle" data-label="Select All|Deselect All">Select All</a></li>
                                        <li class="js-checkable-dependent"><a href="/assessment-manage-rater.php">Manage Rater</a></li>
                                        <li class="js-checkable-dependent"><a href="/assessment-manage-peers.php">Manage Peers</a></li>
                                        <li class="js-checkable-dependent"><a href="/assessment-manage-dynamic-sections.php">Manage Dynamic Sections</a></li>
                                    </ul>
                                </div>
                            ',
                        ),
