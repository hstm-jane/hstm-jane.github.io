    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-image:url('/content/images/modal-promo-simple-bg.jpg');">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="padding:0px;">Create Your HealthStream ID</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-7">
                        <p>HealthStream ID offers you:</p>
                        <ul>
                            <li>Portability of your Personal ePortfolio</li>
                            <li>Streamlined login and access to you To-Do List</li>
                            <li>Access to apps for professional development</li>
                        </ul>
                        <p>It’s simple (and free)!</p>
                        <p>Create your own personal HealthStream ID and go where HealthStream goes.</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <a href="healthstream-id-create-combined-summit.php" class="btn btn-success">Create ID</a>
