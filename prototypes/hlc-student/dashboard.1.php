...
<html lang="en">
    ...
    <body class="layout-dashboard-amanda">
                        ...
                        <div id="" class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="action-results-panel">
                                    <table id="table-ext-3" class="table table-striped table-bordered table-hover table-condensed">
                                      <thead>
                                         <tr>
                                            <th>Task name</th>
                                            <th>Progress</th>
                    ...
                    <div class="portlets-wrapper">
                        <div class="col-lg-7 ui-sortable" id="portlet-1" data-toggle="portlet">
                                ...
                                <div class="panel-wrapper">
                                    <div class="panel-body">
                                        <div class="task-types clearfix">
                                            ...
                                            <div class="task-type-item align-middle pt-xl">
                                                Live Classes
                                                <div class="task-type-value">4</div>
                                                <div class="task-type-meta">Next: 8/13/17</div>
                                            </div>
                                            <div class="task-type-item align-middle pt-xl">
                                                Manager Tasks
                                            ...
                                            <div class="task-type-item align-middle pt-xl">
                                                Rater Tasks
                                                <div class="task-type-value">9</div>
                                                <div class="task-type-meta">Next Due: 8/1/17</div>
                                            </div>
                                            <div class="task-type-item align-middle pt-xl">
                                                Goal Tasks
                            ...
                            <div id="panelPortlet3" class="panel panel-default">
                                <div class="panel-heading portlet-handler ui-sortable-handle">Success Panel</div>
                                <div class="panel-body">
                            ...
                            <div id="panelPortlet7" class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <canvas data-classyloader="" data-percentage="70" data-speed="20" data-font-size="40px" data-diameter="70" data-line-color="#23b7e5" data-remaining-line-color="rgba(200,200,200,0.4)" data-line-width="10" data-rounded-line="true" class="center-block js-is-in-view" width="200" height="200"></canvas>
                                    <div data-sparkline="" data-bar-color="#23b7e5" data-height="30" data-bar-width="5" data-bar-spacing="2" values="5,4,8,7,8,5,4,6,5,5,9,4,6,3,4,7,5,4,7" class="text-center">
                                        <canvas width="131" height="30" style="display: inline-block; width: 131px; height: 30px; vertical-align: top;"></canvas>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-5 ui-sortable" id="portlet-2" data-toggle="portlet"">
                            <div id="panelPortlet5" class="panel panel-default ">
                                <div class="panel-heading portlet-handler">
                                    ...
                                    <div class="panel-title">Upcoming Live Classes </div>
                                </div>
                                <div class="panel-body">
                                    <div class="row" style="margin-top:-15px;margin-bottom:5px;">
                                        <div class="col-lg-8"></div>
                                        <div class="col-lg-4">
                                           <button class="btn btn-default btn-xs pull-right "><i class="fa fa-calendar"></i></button>
                                           <button class="btn btn-default btn-xs pull-right active"><i class="fa fa-list"></i></button>
                                        </div>
                                    </div>
