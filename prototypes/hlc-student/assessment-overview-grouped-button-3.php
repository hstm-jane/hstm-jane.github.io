                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="section-header-action hidden-xs">
                                        <!--<a href="#tab-2" class="btn btn-default" data-toggle="tab">Group</a>-->
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="#tab-2" data-toggle="tab">Group by State</a></li>
                                            <li><a href="#tab-3" data-toggle="tab">Group by Title</a></li>
                                        </ul>
                                    </div>
                        ...
                        $stickybar = array(
                            'sets' => array(
                                array(
                                    ...
                                    </div> <a href="#modal-filter" class="btn btn-default" data-toggle="modal">Sort &amp; Filter</a>
                                    ',
                                ),
                            ),
                        );
                    ...
                    <section class="section">
                        <header class="section-header">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="section-header-action hidden-xs">
                                        <a href="#tab-1" class="btn btn-default" data-toggle="tab">Ungroup</a>
                                    </div>
                                </div>
                            </div>
                        </header>
                        ...
                        <?php
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">In Review State</a> <span class="badge">3</span>',
                                'meta' => array(
                                    array(
                                ...
                                'action' => array(
                                    ...
                                    'content' => '<div class="action action-single">
                                        <a href="#tab-1" data-toggle="tab" class="btn btn-default btn-sm hidden-xs">View</a>
                                    </div>',
                                ),
                            );
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">In Assigned State</a> <span class="badge">1</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">In Approval State</a> <span class="badge">1</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">In Evaluation State</a> <span class="badge">5</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">In Closed State</a> <span class="badge">30</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                    ...
                    <section class="section">
                        ...
                        <?php
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">Initial Nursing Competency Appraisal</a> <span class="badge">5</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">Nursing Skills Assessment – Reflective Plan 1 – Juniper, Stephanie</a> <span class="badge">1</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
                            ...
                            $slat = array(
                                ...
                                'title' => '<a href="#tab-1" data-toggle="tab">Annual Performance Appraisal</a> <span class="badge">1</span>',
                                'meta' => array(
                                    array(
                                        'type' => 'Employee Assessment',
                                    ),
