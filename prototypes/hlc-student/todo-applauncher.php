                            ...
                            <div class="filter-row">
                                <div class="filter-cell">
                                    <div class="filter-toggle">
                                        1Show: <i class="fa fa-fw fa-caret-down"></i>
                                    </div>
                                </div>
                                <div class="filter-cell">
                                    <ul>
                                        <li><label class="checkbox"><input type="checkbox" value='all' checked> All Tasks</label></li>
                                        <li><label class="checkbox"><input type="checkbox" value="1"> Assigned Learning</label></li>
                                        <li><label class="checkbox"><input type="checkbox" value="2"> Live Classes</label></li>
                                        <li><label class="checkbox"><input type="checkbox" value="3"> Elective Learning</label></li>
                            ...
                            <div class="slat slat-attention slat-spaced slat-callout" data-filter-category="1">
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout"><span class="meta-label">Due:</span><span class="meta-value"><span class="meta-callout-label">Due:</span>Mar 19, 2017</span>
                                        </li>
                                    </ul>
                                    <div class="action">
                            ...
                            <div class="slat slat-spaced slat-callout" data-filter-category="5">
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>Apr 25, 2017</span>
                                        </li>
                                    </ul>
                                    <div class="action action-split">
                                        <div class="btn-group">
                            ...
                            <div class="slat slat-spaced slat-callout" data-filter-category="5">
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>May 3, 2017</span>
                                        </li>
                                    </ul>
                                    <div class="action action-split">
                                        <div class="btn-group">
                            ...
                            <div class="slat slat-spaced slat-callout" data-filter-category="1">
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li><span class="meta-label">Status:</span><span class="meta-value">In Progress</span></li>
                                        <li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>May 18, 2017</span>
                                        </li>
                                    </ul>
                                    <div class="action">
                            ...
                            <div class="slat slat-spaced slat-callout" data-filter-category="5">
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        <li><span class="meta-type">Self Assessment</span></li>
                                        <li><span class="meta-label">State:</span><span class="meta-value">Evaluate</span></li>
                                        <li class="meta-callout"><span class="meta-label">Due:</span><span class="meta-value"><span class="meta-callout-label">Due:</span>May 25, 2017</span>
                                        </li>
                                    </ul>
                                    <div class="action action-split">
                                        <div class="btn-group">
                            ...
                            <div class="slat slat-spaced slat-callout" data-filter-category="2">
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li><span class="meta-label">Status:</span><span class="meta-value">Assigned</span></li>
                                        <li class="meta-callout"><span class="meta-label">Due:</span><span class="meta-value"><div><span class="meta-callout-label">Due:</span>May 28, 2017 at 2:30pm</div>
                                </span>
                                </li>
                                </ul>
                                <div class="action">
                ...
                <div class="slat slat-spaced slat-callout" data-filter-category="2">
                    <div class="slat-default">
                        ...
                        <ul class="meta">
                            ...
                            <li class="meta-callout"><span class="meta-label">Date:</span><span class="meta-value"><div>May 28, 2017 at 3:30pm - </div>
                                            <div>Jun 7, 2017 at 3:30pm</div></span></li>
                        </ul>
                        <div class="action action-split">
                            <div class="btn-group">
                    ...
                    <div class="slat-default">
                        ...
                        <ul class="meta">
                            ...
                            <li class="meta-callout"><span class="meta-label">Date:</span><span class="meta-value"><span class="meta-value">
                                            <div>Due: Jun 7, 2017, 2014</div></span></span>
                            </li>
                        </ul>
                        <div class="action">
                ...
                <div class="slat slat-spaced slat-callout" data-filter-category="2">
                    <div class="slat-default">
                        ...
                        <ul class="meta">
                            ...
                            <li class="meta-hide-xs"><span class="meta-label">Location:</span><span class="meta-value">Cummins Station: 450</span></li>
                            <li class="meta-callout"><span class="meta-label">Date:</span><span class="meta-value"><span class="meta-value"><div>Jun 7, 2017 at 3:30pm - </div>
                                            <div>Jun 17, 2017 at 3:30pm</div></span></span>
                            </li>
                        </ul>
                        <div class="action action-split">
                            <div class="btn-group">
