...
$patterns['start']['title'] = 'Select Job Descriptions';
$patterns['focus']['title'] = 'Select Job Descriptions';
        ...
        $('.add-selected').click(function(e){
            ...
            if ($('.checkable-checked').length < 1){
                ...
                $('#ValidationMessage').hide();
                  window.location.href = "assessment-dynamic-section-summit.php?returnFromJob&title=" + $('.checkable-checked').find('.title').text();
            }
        });
