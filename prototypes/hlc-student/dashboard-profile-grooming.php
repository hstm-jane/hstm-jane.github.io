                        ...
                        <div class="col-md-4">
                                ...
                                <div class="panel-body text-center clearfix">
                                    ...
                                    <h3 class="m0 text-bold">
                                     ...
                                     <small>
                                        ...
                                        <div class="m0 ">
                                             <h6 class="text-muted mt-sm" style="font-style:normal;">Last Login: Feb 20, 2018 at 9:20 am</h6>
                                     </div>
                                    ...
                                    <div class="text-center">
                                        <a href="#modal-message-single" data-toggle="modal" class="btn btn-primary">Send message</a>
                                    </div>
                            ...
                            <div class="panel panel-default  panel-direct-reports">
                                ...
                                <div class="panel-body">
                                    <div class="clearfix pr pt-sm"><small class="text-muted pull-right ">Showing 14 of 14 employees</small></div>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div id="notes" role="tabpanel" class="tab-pane">
                                                <section class="section">
                                                    <h2 class="mb-lg">
                                                                <a href="#modal-note-add-employee" data-toggle="modal" class="btn btn-primary pull-right">Add Note</a>
