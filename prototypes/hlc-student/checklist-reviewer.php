...
<?php
    ...
    $taskDetailsComments = '<div class="checklist-task-details">
    ...
    $taskDetailsMethods =   '<div class="checklist-task-details">
                                <div class="checklist-methods">
                                    <h5>Validation Method</h5>
                                    <ul class="list-unstyled">
                                        <li class="checkbox">
                                            <label><input type="checkbox" value="1"> Demonstration </label>
                                        </li>
                                        <li class="checkbox">
                                            <label><input type="checkbox" value=2"> Return Demonstration </label>
                                        </li>
                                        <li class="checkbox">
                                            <label><input type="checkbox" value="3"> Observation</label>
                                        </li>
                                        <li class="checkbox">
                                            <label><input type="checkbox" value="4"> Post-Test</label>
                                        </li>
                                        <li class="checkbox">
                                            <label><input type="checkbox" value="5"> Exemplar</label>
                                        </li>
                                        <li class="checkbox">
                                            <label><input type="checkbox" value="6"> Other <input type="text" class="form-control hidden"> </label>
                                        </li>
                                    </ul>
                                </div>
                            </div>'
...
<style>
    ...
    .checklist-actions .checklist-methods li{
        white-space: normal;
