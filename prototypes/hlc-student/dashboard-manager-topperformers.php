                    ...
                    <div class="portlets-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12" id="portlet-3" data-toggle="portlet">
                                ...
                                <!-- START panel-->
                                <div class="panel panel-transparent panel-performers" id="panelPortlet8">


                                    <ul role="tablist" class="nav nav-tabs nav-justified">
                                        <li role="presentation" class="active">
                                            <a href="#top-performers" aria-controls="top-performers" role="tab" data-toggle="tab" class="bb0">
                                                Top Performers</a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#bottom-performers" aria-controls="bottom-performers" role="tab" data-toggle="tab" class="bb0">
                                                Bottom Performers</a>
                                        </li>
                                    </ul>

                                    <div class="tab-content p0 bg-white mb0">
                                ...
                                <div class="panel panel-default panel-knowledgeq" id="panelPortlet9">
                                    <div class="panel-heading portlet-handler" style="position:relative;">
                                        <div class="panel-title">Knowledge<span>Q</span></div>
                                        <div class="kebab" style="top:5px;">
                                            <figure></figure>
                                            <figure class="middle"></figure>
                                            <p class="cross">x</p>
                                            <figure></figure>
                                    ...
                                    <div class="panel-body" style="min-height:267px">
                                        <a href="#" class="show-modal-knowledgeq">
                                            ...
                                            <div style="display:table;width:100%;">
                                                <div class="completed" style="position:static;display:table-cell;">
                                                    <div class="place-value" style="font-weight: 500!important;color:#777">20<span style="font-size:16px;">/28</span></div>
                                                    <div class="place-label">Completed</div>
                                                </div>
                                                <div class="completed" style="position:static;display:table-cell;">
                                                    <div class="place-value" style="font-weight: 500!important;color:#777">2</div>
                                                    <div class="place-label">due soon</div>
                                                </div>
                                                <div class="completed" style="position:static;display:table-cell;">
                                                    <div class="place-value" style="font-weight: 500!important;color:#fc7b00">3</div>
                                                    <div class="place-label">past due</div>
                                                </div>
                                            </div>
                                            <div class="team-name" style="color:#777;top:78px;font-size:14.5px">
                                                Employees Completed
                                            </div>
                                            <div class="chart-label" style="left:67px;top:100px;color:#aaa;font-size:10.5px;">
                                                Due within 12 months
                                            </div>


                                            <!-- <div class="label-cover"></div> -->
                                            <div class="needle-cap-value" style="top:219px;left:116px">80%</div>


                                            <div id="container" style="top:7px;left:-59px;"></div>
                                        </a>
                                    </div>
