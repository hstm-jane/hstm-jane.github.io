...
<style>
	...
	.modal-work-history-update .modal-content .slat {
		color: #666;
		background-color: #f9f9f9;
	}
	
	.modal-work-history-update .slat .question {
	margin-bottom: 0;
	}
	
	.modal-work-history-update .slat .answer .answer-icon{
		left:5px;
	}
	
	.modal-work-history-update .slat .answer {
		border-left: none;
	...
	.modal-work-history-update .slat .answer.selected{
	...
	.modal-work-history-update .slat{
		border-radius: 4px;
	}
...
<!-- Modal -->
<!-- Modal -->
<div id="modal-work-experience2" class="modal fade layout-wizard" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
			...
			<div class="modal-footer">
				<a href="#modal-work-history-update " class="btn btn-success" data-dismiss="modal" data-toggle="modal" >Save</a> <a href="#modal-work-history-update " class="btn btn-default" data-dismiss="modal" data-toggle="modal">Cancel</a>
			</div>
		</div>
	</div>
</div>
...
<div id="modal-work-history-update" class="modal modal-work-history-update fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
				...
				<h3 style="margin-top:0; margin-bottom:0; " class="text-left"> Please look over your current Work Experience.
			...
			<div class="modal-body">
				...
				<p style="font-size: 16px; line-height: 1.4; margin-top:10px; margin-right:20px;">Get more value out of our system by keeping your Work Experience up-to-date!</p>
				<div class="slat slat-ajax slat-callout" data-filter-category="0" style="margin-top:15px;">
					<div class="slat-default">
						<div class="title">Nursing: Registered Nurse - RN</div>
						<ul class="meta">
							<li><span class="meta-label">SETTING:</span><span class="meta-value">Hospital</span></li>
							<li><span class="meta-label">SPECIALTY:</span><span class="meta-value">Neonatal Intensive Care</span></li>
							<li class="meta-callout"><span class="meta-label">DATES:</span><span class="meta-value"><span class="meta-callout-label">DATES:</span>Sep 2009 - PRESENT</span></li>
						</ul>
					...
					<div class="slat-nested">
						...
						</div><a class="collapse-toggle toggle-text-initialized" data-hijax="true" data-toggle-text="Show additional information|Hide additional information" href="/HSAPP/UserWorkExperience/UserWorkExperienceAdditionalData?userWorkExperienceId=50ffc534-9966-4624-bede-0e089af53bff">Show additional information<i class="fa-fw fa-caret-down fa"></i></a>
					</div>
					<div class="text-center" style="border-top:1px dotted #ccc; padding-top:10px; margin-top:10px;">
						...
						<div class="update-old-record text-left" style=" padding-top: 20px;">

							<label>When was there a change?</label>
							...
							<a class=" btn btn-sm btn-default" data-dismiss="modal" href="#modal-work-experience2" data-toggle="modal">Add a New Work Experience</a>
						</div>
					</div>
			...
			<div class="modal-footer">
				<a href="#" class="btn btn-default" data-dismiss="modal">Confirm my Work Experience</a>
				<a href="#" class="btn btn-default" data-dismiss="modal">Ask Me Later</a>
			</div>
		</div>
	</div>
</div>
...
<script>
	$(document).ready(function() {
		$("#modal-work-history-update").modal('show');
		...
		$(function() {
			...
			$('label.answer').click(function(e) {
				...
				$o = $t.closest('.slat').find('.update-old-record');
