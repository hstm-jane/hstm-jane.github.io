...
?>
    ...
    ================================================== -->
        ...
        <title>Echo Credentialing - A HealthStream Company</title>
        <!-- Styles
    ================================================== -->
        <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1507748235">
        <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1507748235">
        <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1507748235">
        <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1507748235">
        <!-- IE 7/8 Handling
    ================================================== -->
        <script>
    ...
    ================================================== -->
        ...
        <style>
            ...
            .site-header .nav-main .nav>li.open.active>a, .site-header .nav-main .nav>li.open.active>a:hover, .site-header .nav-main .nav>li.open>a, .site-header .nav-main .nav>li.open>a:hover {
                background:#3EABD4;
            }
    ...
    <body>
        <div class="site-header site-header--assessments">
            <div class="container">
                ...
                <div class="branding">
                    <a href="/">
                <img src="./content/images/verity-logo.jpg" alt="Verity" class="logo-large">
            ...
            <nav class="nav-main">
                <div class="container">
                    <ul id="nav" class="nav">
                        <li class="active dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">My Apps <i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="#">link</a></li>
                            </ul>
                        </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">My Status <i class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="#">link</a></li>
                        </ul>
                    </li>
                        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">My Reviews <i class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="#">link</a></li>
                        </ul>
                    </li>
                        ...
                        <li class=""><a href="#" class="dropdown-toggle" data-toggle="dropdown">Resources <i class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="#">link</a></li>
                        </ul>
                    </li>
                        <li class=""><a href="hstream-workflow.todo.php?persona=<?= $persona ?>&workflow=1">Assigned Learning <span class="badge badge-alert ">4</span></a></li>
                        <!-- <li class="disabled"><a href="#">Help</a></li> -->
                        <!-- <li class="visible-xs"><a href="#">Logout</a></li> -->
                       <?php
                          include ('includes/applauncher.hstream.verity.php');
                        ?>
                    </ul>
                </div>
                <!-- /container -->
        ...
        <div class="layout">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <section class="section section-main section-box" data-equalize="layout-columns" style="height:700px;padding-top:0px;">
                            <img src="content/images/echo.png" />
                        </section>
                        <!-- /section-main -->
                    </div>
                    <!-- /column -->
        ...
        <script src="/scripts/prototype.hstream-workflow.js"></script>
        <script>
        $(function() {
