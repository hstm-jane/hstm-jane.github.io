...
<head>
    ...
    <!-- Styles
    ================================================== -->
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1492007324">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1492007324">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1492007324">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1492007324">
...
<div class="fph-cell fph-cell-icon"><div class="fph-icon" style="padding-top:10px"><i class="hs-icons-assessment"> </i></div><div class="fph-icon-label"><span>Employee Assessment </span></div></div>
<div class="fph-cell fph-cell-text">
<div class="fph-primary">
<h1>Assessment Summary</h1> 
</div>
<div class="fph-secondary"><ul class="meta">
<li><span class="meta-label">For Assessment:</span><span class="meta-value">
Annual Performance Appraisal</span></li>
</ul></div>
...
<div class="assessment-header">
    <div class="assessment-return">
        <a href="assessment-overview.php">
            <i class="fa fa-fw fa-chevron-left"></i>
            Return to Rater Overview
        </a> 
    </div>
</div>


<!--/Return to Rater Overview Link-->
...
Annual Performance Appraisal
        <span class="assessment-subtitle">
            Assessment Rating:  <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending <i class="fa fa-fw fa-info-circle"></i></a>
            ...
            <div class="mb-row">
                <div class="mb-cell" data-equalize="mb-cell">
                    ...
                    <div>
                        ...
                        <span class="meta-box-value">Park, Jennifer S.</span> 
                    </div>
                </div>
                <div class="mb-cell" data-equalize="mb-cell">
                    <div style="float:left;margin-right:10px;">
                ...
                <div class="mb-cell equalized">
                    ...
                    <span class="meta-box-value">Assigned</span> 
                </div>
                <div class="mb-cell equalized">
                    <span class="meta-box-label">Due</span> 
                    <span class="meta-box-value">May 12, 2017</span>  
                </div>
            </div>
        </div>
    </div>
...
<section class="section">
    <header class="section-header">
        <h2>Essential Attributes of Medical Surgical RNs<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-2">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="checkable"><div class="statement" data-statementid="statement-1">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-2&statement=statement-1&user=rater&state=1&progress=5">Critical Thinking</a></div>
    ...
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-2&statement=statement-1&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-2&statement=statement-1&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-1&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-1&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-1&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-1&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-1&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
            ...
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I am new and cannot rate this person</div>
        </div>
    </div>
...
</div><div class="select"><label><input type="checkbox" class="checkbox"><span class="icon"></span></label></div></div><div class="checkable"><div class="statement" data-statementid="statement-2">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-2&statement=statement-2&user=rater&state=1&progress=5">Communication</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-2&statement=statement-2&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-2&statement=statement-2&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5&actor=employee">Conner, Rosalyn F.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-2&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I am new and cannot rate this person</div>
...
</div><div class="select"><label><input type="checkbox" class="checkbox"><span class="icon"></span></label></div></div><div class="checkable"><div class="statement" data-statementid="statement-3">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-2&statement=statement-3&user=rater&state=1&progress=5">Prioritization, Organization, Delegation</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-2&statement=statement-3&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-2&statement=statement-3&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5&actor=employee">Conner, Rosalyn F.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-3&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I am new and cannot rate this person</div>
    ...
    <header class="section-header">
        <h2>Nursing Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-2">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="checkable"><div class="statement" data-statementid="statement-4">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-2&statement=statement-4&user=rater&state=1&progress=5">Relationship Based Care</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-2&statement=statement-4&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-2&statement=statement-4&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5&actor=employee">Conner, Rosalyn F.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-4&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I am new and cannot rate this person</div>
...
</div><div class="select"><label><input type="checkbox" class="checkbox"><span class="icon"></span></label></div></div><div class="checkable"><div class="statement" data-statementid="statement-5">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-2&statement=statement-5&user=rater&state=1&progress=5">Alcohol Withdrawal</a></div>
            <div class="description">Applies Relationship Based Care principals to strengthen teamwork and collaboration with all colleagues to improve the patient experience.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-2&statement=statement-5&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-2&statement=statement-5&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5&actor=employee">Conner, Rosalyn F.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-5&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I am new and cannot rate this person</div>
    ...
    <header class="section-header">
        <h2>Med-Surg Core Orientation<span class="average-rating">Section Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-2">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
    </header>
    <div class="checkable"><div class="statement" data-statementid="statement-6">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-2&statement=statement-6&user=rater&state=1&progress=5">Blood Transfusion</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-2&statement=statement-6&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-2&statement=statement-6&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5&actor=employee">Conner, Rosalyn F.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-6&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I am new and cannot rate this person</div>
...
</div><div class="select"><label><input type="checkbox" class="checkbox"><span class="icon"></span></label></div></div><div class="checkable"><div class="statement" data-statementid="statement-7">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=competency-2&statement=statement-7&user=rater&state=1&progress=5">Patient Controlled Analgesia - PCA</a></div>
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=competency-2&statement=statement-7&user=rater&state=1&progress=5" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=competency-2&statement=statement-7&user=rater&state=1&progress=5">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5&actor=rater">More</a></div>
        </div>
    </div>
</div>
        <div class="collapse-group collapse"><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5&actor=employee">Conner, Rosalyn F.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5&actor=peer-1">Peer 1</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5&actor=peer-2">Peer 2</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-2&statement=statement-7&user=rater&progress=5&actor=peer-3">Peer 3</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Apr 5, 2017:</span> I am new and cannot rate this person</div>
...
<a href="/assessment.php?assessment=competency-2&user=rater&state=3" class="btn btn-success js-submit-to-signoff">Begin Sign off Process</a>
            ...
            <div class="modal-body">
                ...
                <div class="modal-focus modal-focus--icon modal-focus--meta">
                    <div class="modal-focus__icon">
                        <img src="/content/images/prototype-actors/esthercrawford.jpg" class="modal-focus__avatar">
                    </div>
                    <div class="modal-focus__primary">
                        <h2 class="modal-focus__title">Rosalyn F. Conner</h2>
                    </div>
...
<li><span class="meta-label">Status:</span><span class="meta-value">In Progress</span></li>
<li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>Apr 12, 2017</span></li>
</ul>
</div>
</div>
                            ...
                            $(function() {
                              ...
                              $('.js-submit').click(function(e) {
                                var growl = {
                                  ...
                                  growlText: encodeURIComponent('<dl class="gritter-class"><dd>Assessment Summary</dd></dl>'),
                                  growlSticky: 'false'
                                }
                                e.preventDefault();
                              ...
                              $('.js-submit-to-review').click(function(e) {
                                ...
                                HealthStream.utilities.interrupt({
                                  ...
                                  actions: [{
                                      ...
                                      url: '/assessment.php?assessment=competency-2&user=rater&state=0&progress=1',
                                    }, {
                                      type: 'default',
                                      label: 'Cancel',
                                      url: '/assessment.php?assessment=competency-2&user=rater&state=1',
                                    }
