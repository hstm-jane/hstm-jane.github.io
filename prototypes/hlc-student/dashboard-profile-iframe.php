...
<head>
    ...
    <title>Brad K. Bruno | HealthStream | HealthStream</title>

    <!-- Styles
    ================================================== -->
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1507913309">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1507913309">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1507913309">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1507913309">
...
<body>
            ...
            <div class="layout layout-dashboard-manager" style="border-top:none !important;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <section class="profile-return-link">
                                <a href="dashboard-manager-team-chart-test7.php"><i class="fa fa-fw fa-chevron-left"></i>Return to Chart</a>
                            </section>
                            <div class="panel panel-default panel-employee">
                                <div class="panel-body text-center clearfix">
                                    <div class="pv-lg">
                                        ...
                                        <div class="profile-initial-circle center-block">
                                            BB
                                        </div>
                                    </div>
                                            ...
                                            <div class="btn-group">
                                               ...
                                               View All
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a href="dashboard-manager-team-chart-test6.php" target="_new">View All - Chart</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
<div class="slat slat-noaction">
<div class="slat-default">
<div class="title">This is my note</div>
<ul class="meta">
<li><span class="meta-label">Regarding:</span><span class="meta-value">Stephanie Juniper</span></li>
...
<a href="#" class="collapse-toggle" data-toggle-text="Show additional information|Hide additional information">Show additional information</a>
            ...
            <!-- /layout -->
            <div id="modal-team" class="modal fade modal-lg modal-team">
    <div class="modal-dialog" style="overflow-y:initial !important;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title">MyTeam</h4>
            </div>
            <div class="modal-body" style="max-height:80vh;overflow-y: auto;">
                <div class="myTeamTableHeader text-muted"></div>
                <table class="table table-bordered team-table dataTable" id="myTeamTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr data-id="9">
                            ...
                            <td class="team-action"><a href="dashboard-profile-dev-ready.php" class="btn btn-default btn-xs">View</a></td>
                        </tr>
                        <tr data-id="1">
                        ...
                        <tr data-id="5">
                            <td class="employee"><a href="dashboard-profile-dev-ready.php">Torres, Judith  P.</a></td>
                            <td>LPN - I.V. Certified</td>
                            <td class="team-action"><a href="dashboard-profile-dev-ready.php" class="btn btn-default btn-xs">View</a></td>
                        </tr>
                        <tr data-id="6">
                            <td class="employee"><a href="dashboard-profile-dev-ready.php">Aguilar, Nicholas J.</a></td>
                            <td>Nurse - Staff (RN) - Acute Care</td>
                            <td class="team-action"><a href="dashboard-profile-dev-ready.php" class="btn btn-default btn-xs">View</a></td>
                        </tr>
                        <tr data-id="7">
                            <td class="employee"><a href="dashboard-profile-dev-ready.php">Vasquez, Donna G.</a></td>
                            <td>LPN - I.V. Certified</td>
                            <td class="team-action"><a href="dashboard-profile-dev-ready.php" class="btn btn-default btn-xs">View</a></td>
                        </tr>
                        <tr data-id="8">
                            <td class="employee"><a href="dashboard-profile-dev-ready.php">Morris, Lawrence  S.</a></td>
                            <td>Nurse - Staff (RN) - Telephones</td>
                            <td class="team-action"><a href="dashboard-profile-dev-ready.php" class="btn btn-default btn-xs">View</a></td>
                        </tr>
                        <tr data-id="9">
...
<!-- /PROTOTYPE ONLY -->
    ...
    <script src="/scripts/prototype.validation/framework/bootstrap.min.js"></script>
                            ...
                            <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"54ac9448ca","applicationID":"9436983","transactionName":"YlxRYxdZWEcEVxBeCVsWZkUMF1JVFlwGWAdHXR5HF1dQXQlRSVMDQxRBUgRcTxoVXBQ=","queueTime":0,"applicationTime":4,"atts":"ThtSFV9DS0k=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>