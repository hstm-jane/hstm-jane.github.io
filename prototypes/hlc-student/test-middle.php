                ...
                <section class="section section-main section-box" data-equalize="layout-columns">
                    ...
                    <section class="section">
                        <div class="question">
                            <div class="question-header">
                                <h2 class="question-count">Question 3 <small>of 10</small><span class="label label-warning">Required Question</span></h2>
                    ...
                    <section class="section">
                        <div class="form-group">
                            <a href="test-first.php" class="btn btn-default">Previous Question</a>
                            <a href="test-last.php" class="btn btn-success">Next Question</a>
                        </div>
                    </section>
