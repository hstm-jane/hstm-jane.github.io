                ...
                <section class="section section-sidebar">
                    ...
                    <section class="section section-box-import section-box">
                        ...
                        <div class="hidden org-list animated pulse">
                            <h4 style="font-weight: 600">Select an Section to Review Records</h4>
                            ...
                            <ul class="list-links js-org-list">
                                ...
                                <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                            Education <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                 ...
                                 <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                            Licenses <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                 ...
                                 <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                            Certification <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                 ...
                                 <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                            Resucitation Programs <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                    ...
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                           Volunteer Service <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                 ...
                                 <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                           Committee Work <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                ...
                                <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                           Memberships & Associstions <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                ...
                                <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                           Teaching & Preceptorship <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                ...
                                <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                          Publications & Research <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                   ...
                                   <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                          Awards & Recognition <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
                                   ...
                                   <li class="org-unchecked org-2">
                                    <div class="form-group">
                                        <label class="checkbox"><input type="checkbox" id="ce-awarded-checkbox">
                                          Other <span class="new-count"> (2 new) </span>
                                       <!--      <?php
                                            $randomKey = array_rand($org_names);
                                            $randomOrg = $org_names[$randomKey]  ;
...
<script>
    ...
    $(".js-org-list").on('change', 'input' , function(){
        ...
        $(this).closest('li').toggleClass("org-unchecked");
   ...
   var importModeCount = 0;
    ...
    function toggleImportMode() {
        ...
        $(".slat-message h3").html("<h3>This section is empty.</h3>");
