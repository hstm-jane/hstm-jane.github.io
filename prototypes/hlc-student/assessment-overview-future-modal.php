...
?>
    <?= createSiteStart($patterns['start']); ?>
                           ...
                           // $groupings['state']['new'] = array_merge($groupings['state']['evaluate'], $groupings['state']['assigned']);
                            ...
                            ?>
                                        ...
                                        <section class="section groups-employee">
                                            <h3 class="assessment-groups__title">Grouped by Employee
                                ...
                                ?>
                                            ...
                                            .assessment-groups-employee-list td, .assessment-groups-employee-list th {
                                                text-align:center;
                                            }
                                            .assessment-groups-employee-list tr > td:nth-child(1), .assessment-groups-employee-list tr > th:nth-child(1) {
                                                text-align:left;
                                            }
        ...
        ?>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <a  class="close" data-dismiss="modal" aria-hidden="true" href="#modal-assessment-by-employee" class="btn btn-focus" data-toggle="modal"><i class="fa fa-times"></i></a>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a  class="btn btn-default" data-dismiss="modal" href="#modal-assessment-by-employee" class="btn btn-focus" data-toggle="modal">Close</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- /modal -->
                        <!-- Modal -->
                        <div id="modal-progress-from-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
