                            ...
                            <section class="section " style="padding-right:30px; border-right: 1px solid #ddd;">
                                        ...
                                        <div class="slat-group-header">
                                            ...
                                            <div class="slat-group-header-actions">
                                                ...
                                                if(isset($_GET['complete'])) { 
                                                     echo '<a class="btn btn-default btn-sm " href="#modal-work-experience" data-toggle="modal">Add</a> 
                                                    <div class="btn-group">
                                                   ...
                                                   // echo '<a class="btn btn-default btn-sm" href="#modal-work-experience" data-toggle="modal"><i class="fa fa-lock"></i> Locked</a> 
                                                   //';
                                                }
                                                ?>
                                        ...
                                        <div class="slat-group-content">
                                            <div class="slat">
                                                ...
                                                if(isset($_GET['complete'])) { 
                                                    ...
                                                    echo '<h3>Unlock this section by activating and linking your HealthStream ePortfolio.</h3>
                                                    <a class="btn btn-default btn-sm" href="#moadal-hid-valprop" data-toggle="modal"><i class="fa fa-unlock-alt"></i> Unlock</a>';
                                                }
                                                ?>
                                                    <!--<a class="btn btn-default btn-sm disabled" href="#modal-work-experience" data-toggle="modal">Add Work Experience</a> 
                                                    <a href="#" class="btn btn-default btn-sm hide-section disabled" data-section="work-experience">Hide Section</a>-->
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="slat-group-header">
                                            ...
                                            <div class="slat-group-header-actions">
                                                <div class="btn-group">
                                                   <?php 
                                                if(isset($_GET['complete'])) { 
                                                     echo '<a href="#modal-memberships" data-toggle="modal" class="btn btn-default btn-sm ">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle " data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                                    ...
                                                    echo '<a href="#modal-memberships" data-toggle="modal" class="btn btn-default btn-sm disabled">Add</a>
                                                    <div class="btn-group">
                                        ...
                                        <div class="slat-group-content">
                                            <div class="slat">
                                                ...
                                                if(isset($_GET['complete'])) { 
                                                    ...
                                                    echo '<h3>Add your first record by  <a class="js-healthstream-id">creating and linking</a> your HealthStream ID.</h3>';
                                    ...
                                    <div class="slat-group">
                                        <div class="slat-group-header">
                                            ...
                                            <div class="slat-group-header-actions">
                                                ...
                                                <?php 
                                                if(isset($_GET['complete'])) { 
                                                     echo '<a href="#modal-committee-work" data-toggle="modal" class="btn btn-default btn-sm ">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle " data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                                    ...
                                                    echo '<a href="#modal-committee-work" data-toggle="modal" class="btn btn-default btn-sm disabled">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle disabled" data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                        ...
                                        <div class="slat-group-header">
                                            ...
                                            <div class="slat-group-header-actions">
                                                <div class="btn-group">
                                                       ...
                                                       <?php 
                                                if(isset($_GET['complete'])) { 
                                                     echo ' <a href="#modal-activities" data-toggle="modal" class=" btn btn-default btn-sm">Add</a>
                                                    <div class="btn-group">
                                                    <a href="#" class="btn btn-default btn-sm dropdown-toggle " data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                                    ...
                                                    echo ' 
                                                    <a href="#modal-activities" data-toggle="modal" class="disabled btn btn-default btn-sm">Add</a>
                                                    <div class="btn-group">
                                                    <a href="#" class="btn btn-default btn-sm dropdown-toggle disabled" data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                ...
                                <section class="section teaching-container">
                                    <div class="slat-group">
                                        <div class="slat-group-header">
                                            <div class="slat-group-header-title">
                                                <h2>Teaching &amp; Preceptorships</h2>
                                            </div>
                                            <div class="slat-group-header-actions">
                                                <div class="btn-group">
                                                <?php 
                                                if(isset($_GET['complete'])) { 
                                                     echo '<a href="#modal-teaching" data-toggle="modal" class="btn btn-default btn-sm ">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle " data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                                    ...
                                                    echo ' 
                                                    <a href="#modal-teaching" data-toggle="modal" class="btn btn-default btn-sm disabled">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle disabled" data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                        ...
                                        <div class="slat-group-header">
                                            ...
                                            <div class="slat-group-header-actions">
                                                <div class="btn-group">
                                                    <?php 
                                                if(isset($_GET['complete'])) { 
                                                     echo '<a href="#modal-research" data-toggle="modal" class="btn btn-default btn-sm ">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle " data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                                    ...
                                                    echo ' 
                                                    <a href="#modal-research" data-toggle="modal" class="btn btn-default btn-sm disabled">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle disabled" data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                        ...
                                        <div class="slat-group-header">
                                            ...
                                            <div class="slat-group-header-actions">
                                                <div class="btn-group">
                                                     <?php 
                                                if(isset($_GET['complete'])) { 
                                                     echo '<a href="#modal-awards" data-toggle="modal" class="btn btn-default btn-sm ">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle " data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                                    ...
                                                    echo ' 
                                                    <a href="#modal-awards" data-toggle="modal" class="btn btn-default btn-sm disabled">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle disabled" data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                        ...
                                        <div class="slat-group-header">
                                            ...
                                            <div class="slat-group-header-actions">
                                                <div class="btn-group">
                                                    <?php 
                                                if(isset($_GET['complete'])) { 
                                                     echo '<a href="#modal-other" data-toggle="modal" class="btn btn-default btn-sm ">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle " data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
                                                    ...
                                                    echo ' 
                                                    <a href="#modal-other" data-toggle="modal" class="btn btn-default btn-sm disabled">Add</a>
                                                    <div class="btn-group">
                                                        <a href="#" class="btn btn-default btn-sm dropdown-toggle disabled" data-toggle="dropdown">
                                                            <i class="fa fa-caret-down"></i>
                                                        </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="control-label">Attachment</label>
                    <ul class="control-attachments control-attachments">
                        <li><button class="btn btn-xs btn-danger control-attachment-remove"><i class="fa fa-times"></i></button>
...
<div id="modal-healthstreamid-about" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>HealthStream ID provides a new way to access HealthStream products and applications. By creating your HealthStream ID using your personal email address, it will provide you with a streamlined login and will ultimately unify your HealthStream experience throughout your career.</p>
            </div>
            <div class="modal-footer">
                <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
            </div>
...
<div id="modal-healthstreamid-link" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>After you create your HealthStream ID, you can link it to your account by clicking the ‘I Already Have One’ button and submitting your credentials. If you work for multiple accounts, linking them all to the your HealthStream ID will provide portability of your personal ePortfolio in the future.</p>
            </div>
            <div class="modal-footer">
                <a href="#" class="btn btn-default" data-dismiss="modal">Close</a>
            </div>
...
<!-- /MANAGE MODALS -->
<!-- Modal Value Prop Goes Here-->

<div id="moadal-hid-valprop" class="modal modal-valprop fade">
    <div class="modal-dialog">
        <div class="modal-content value-prop">
        <!-- Modal Header -->
        <div class="modal-header">
            <img src="../content/images/logo-hstream-modal.png" alt="hStream">
        ...
        <div class="modal-body">
            <div class="content-container">
                <div class="accent-valprop">
                    <img src="../content/images/accent-hstream-modal.png" alt="hstream image">
                </div>
                <div class="content-valprop">
                    <ul>
                        <li>
                            <div class="container-icon"><i class="hs-icons-learning-event"></i></div>
                            <div class="container-value">
                                <strong>A single login</strong>
                            now access any HealthStream application with one login
                            </div>
                        </li>
                        <li>
                            <div class="container-icon"><i class="fas fa fa-archive"></i></div>
                            <div class="container-value">
                            <strong>Login preference</strong>
                            Login using your personal email OR phone number
                            </div>
                        </li>
                        <li>
                            <div class="container-icon"><i class="fas fa fa-archive"></i></div>
                            ...
                            Streamlined process for password resets
                            </div>
                        </li>
                    </ul>
                    <div><button class="btn btn-lg btn-success">Get Started</button></div>
                </div> 
            </div>
