                            ...
                            <div class="panel-body">
                                <div role="tabpanel">
                                    ...
                                    <ul role="tablist" class="nav nav-tabs">
                                        ...
                                        <li role="presentation" class="active"><a href="#activity" aria-controls="activity" role="tab" data-toggle="tab" style="padding-right: 10px;
                                        padding-left: 10px;">Activity  <span class="badge badge-success ">New!</span> </a>
                                        </li>
                                    ...
                                    <div id="goals" role="tabpanel" class="tab-pane">
                                        ...
                                        <div id="activity" role="tabpanel" class="tab-pane active">
                                        <style>
                                            #activity .media-box-heading {
                                                font-weight:600;
                                            }
                                            .list-group {
                                               ...
                                               <div class="media-box">
                                                  <div class="pull-left">
                                                     <span class="fa-stack">
                                                        ...
                                                        <i class="hs-icons-course text-white" style="position: absolute;
                                                        left: 0;
                                                        width: 100%;
                                                        text-align: center;"> </i>
                                                     </span>
                                                  ...
                                                  <div class="media-box-body clearfix">
                                                     <small class="text-muted pull-right ml">9/13/2018</small>
                                                     <div class="media-box-heading"><a href="#" class="text-info m0">COMPLETED COURSE</a>
                                                     </div>
                                                     <p class="m0">
                                               ...
                                               <div class="media-box">
                                                  <div class="pull-left">
                                                     <span class="fa-stack">
                                                        ...
                                                        <em class="fa fa-list fa-stack-1x fa-inverse text-white"></em>
                                                     </span>
                                                  </div>
                                                  <div class="media-box-body clearfix">
                                                     <small class="text-muted pull-right ml">9/12/2018</small>
                                                     <div class="media-box-heading"><a href="#" class="text-purple m0">PERFORMED CLINICAL DEVELOPMENT ASSESSMENT</a>
                                                     </div>
                                                     <p class="m0">
                                                        <a href="#">RN: Emergency Assessment</a>
                                                     </p>
                                                  </div>
                                               </div>
                                            </div>
                                               ...
                                               <div class="media-box">
                                                  <div class="pull-left">
                                                     <span class="fa-stack">
                                                        ...
                                                        <i class="hs-icons-class-live text-white" style="position: absolute;
                                                        left: 0;
                                                        width: 100%;
                                                        text-align: center;"> </i>
                                                  ...
                                                  <div class="media-box-body clearfix">
                                                     <small class="text-muted pull-right ml">7/15/2018</small>
                                                     <div class="media-box-heading"><a href="#" class="text-success m0">PRESENTED AT A CONFERENCE</a>
                                                     </div>
                                                     <p class="m0">
                                                        <a href="#"><small style="color:#656565">Nursing Summit 2018</small></a>
                                                     </p>
                                                  </div>
                                               </div>
                                            </div>
                                            <!-- END list group item-->
                                                ...
                                                <div class="media-box">
                                                    ...
                                                    <div class="media-box-body clearfix">
                                                        <small class="text-muted pull-right ml">7/2/2018</small>
                                                        <div class="media-box-heading"><a href="#" class="text-info m0">COMPLETED ELECTIVE COURSE</a>
                                                        </div>
                                                        <p class="m0">
                                                            <a href="#">Managment Development Skills</a>
                                                        </p>
                                                    </div>
                                                </div>
                                                </div>
                                                ...
                                                <div class="list-group-item">
                                                   <div class="media-box">
                                                      ...
                                                      <div class="media-box-body clearfix">
                                                         <small class="text-muted pull-right ml">6/24/2018</small>
                                                         <div class="media-box-heading"><a href="#" class="text-purple m0">PERFORMED CLINICAL DEVELOPMENT ASSESSMENT</a>
                                                         </div>
                                                         <p class="m0">
                                                            <a href="#">RN: Emergency Skills Self-Assessment</a>
                                                         </p>
                                                      </div>
                                                   </div>
                                                </div>
                                               ...
                                               <div class="list-group-item">
                                                  <div class="media-box">
                                                     ...
                                                     <div class="media-box-body clearfix">
                                                        <small class="text-muted pull-right ml">6/23/2018</small>
                                                        <div class="media-box-heading"><a href="#" class="text-danger m0">CHECK-IN</a>
                                                        </div>
                                                        <p class="m0"><small style="color:#656565">With
                                                           <em>Darcy Crane</em>
                                                        </small>
                                                        </p>
                                                     </div>
                                               ...
                                               <div class="list-group-item">
                                                  <div class="media-box">
                                                     ...
                                                     <div class="media-box-body clearfix">
                                                        <small class="text-muted pull-right ml">5/10/2018</small>
                                                        <div class="media-box-heading"><a href="#" class="text-warning m0">GOAL PROGRESS UPDATED</a>
                                                        </div>
                                                        <div class="progress progress-xs m0" style="width:180px;">
