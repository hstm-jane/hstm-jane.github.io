...
<div class="tab-pane fade in active" id="tab-7">
  <style>
    ...
    .accel-me-menu .list-group-item{
      border:none;
      border-top: 1px solid #ccc;
    }


    .accel-me-menu .list-group{
      margin-bottom: 0;
    }

    .sub-menu .list-group-item:not(:first-of-type) {
    ...
    <div class="col-md-3">
      ...
      <div class="accel-me-menu">
        <div class="list-group panel">
          <a href="#badges" class="list-group-item" data-toggle="collapse" data-parent="#MainMenu">Badges</a>
          <div class="collapse sub-menu" id="badges">
            <div class="list-group-item"><div class="badge1"><i fa fa-star></i></div> </div>

          </div>

          <a href="#demo3" class="list-group-item" data-toggle="collapse" data-parent="#MainMenu">Leadership Ladder <i class="fa fa-caret-down"></i>
            <div class="progress">
          ...
          <div class="collapse sub-menu" id="demo3">
            ...
            <a href="javascript:;" class="list-group-item">Level 5 </a>
            <a href="javascript:;" class="list-group-item">Level 4</a>
            <a href="javascript:;" class="list-group-item">Level 3</a>
            <a href="javascript:;" class="list-group-item">Level 2</a>
            <a href="javascript:;" class="list-group-item">Level 1</a>
          </div>
          <a href="#demo4" class="list-group-item list-group-item-success" data-toggle="collapse" data-parent="#MainMenu">Hospital Contest 4  <i class="fa fa-caret-down"></i></a>
