        ...
        <label><input type="checkbox"> Facet Name</label>
            ...
            <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                ...
                <span>Settings</span>
                            ...
                            <div class="form-group">
                              <select class="form-control">
                                <option>Career Ladder 1</option>
                                <option>Career Ladder 2</option>
                              </select>
                            </div>
                            ...
                            <ul>
                              ...
                              <li>
                                <a href="/event-single-settings.php">Level 10</a>
                              </li>
                              <li>
                                <a href="/event-single-permissions.php">Level 9</a>
                              </li>
                              <li>
                                <a href="/event-single-resources.php">Level 8</a>
                              </li>
                              <li>
                                <a href="/event-single-roster.php">Level 7</a>
                              </li>
                              <li>
                                <a href="/event-single-grading.php">Level 6</a>
                              </li>
                              <li>
                                <a href="/event-single-message.php">Level 5</a>
                              </li>
                              <li class="active">
                                <a href="/event-single-content.php">Level 4  </a>
                                <img src="/content/images/climbing-man.svg" class="climbing-man">
                              </li>

                              <li>
                                <a href="#" class="completed">Level 3</a>
                              </li>
                              <li>
                                <a href="#" class="completed">Level 2</a>
                              </li>
                              <li>
                                <a href="#" class="completed">Level 1</a>
                              </li>
                            </ul>
                          </div>
                          ...
                          <div class="layout-subnav-content">
                            ...
                            <section class="section">
                              <div class="container">
                                <h1 class="project-name">Level 4</h1>
                                <div id="timeline">
