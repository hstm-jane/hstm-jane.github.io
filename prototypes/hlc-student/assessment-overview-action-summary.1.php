...
$patterns['header'] = array(
    ...
    'mainNav' => '
        ...
        <li class="{active=todo}"><a href="/todo-nudge.php">To Do</a></li>
        ...
        <li class="{active=raters}"><a href="/assessment-overview-action-summary.1.php">Raters</a></li>
...
function makeGroupingBox($type,$title,$id=0,$total,$actionable=false,$image=false){
    if (($type == 'employee' || $type == 'state') || ($type == 'title' && $actionable > 0)) {
        ...
        if ($type == "state") {
            ...
            $html .= '<div class="assessment-group__title">'.$title.'<div class="assessment-group__meta"><a href="#" class="assessment-group__employee-action">see all</a></div></div>';
        }
        else {
            $html .= '<div class="assessment-group__title">'.$title.'</div>';
        }
        if ($type == "state" || $type == "title" ) {
...
<style>/* 
 .assessment {
    ...
    @media screen and (min-width:768px){
        ...
        .assessment-group--state .assessment-group__title-meta:after {
            content: '\A';;
            white-space: pre;
        }
...
@media screen and (min-width:1200px){
    ...
    .assessment-group__title-meta {
        font-size: 12px;
        text-transform: uppercase;
    }
    .assessment-group__total:hover {
        background: #e3e3e3;
    }
   ...
   /* .assessment-group__image-holder {
    ...
    /*.assessment-group__total {
      ...
      .assessment-group--state .assessment-group__total {
           /*   background-color: rgba(0, 115, 153, 0.72);*/
               font-weight: 500;
              width: 30px;
               font-size:22px;
        }
       
        .assessment-group--state .assessment-group__title-meta-value {
            font-size:22px;
           font-weight: 300;
        }
    .assessment-group__meta {
        font-size: 9px;
        text-transform: uppercase;

    }
    .assessment-group__employee-action {
        font-size:12px;
    }
   .assessment-group__total {
        display: table-cell;
         ...
         <?php
            ...
            <div class="tab-content" style="position: relative;">
                ...
                <div class="tab-pane" id="details" style="position: relative;">
                 <!--Filter Bar-->
                <div class="panel-group filter-bar" role="tablist" id="filterbar-panel-group">
                            ...
                            <div class="col-sm-12">
                                    ...
                                    <div class="assessment assessment--header">
                                        <div class="assessment__summary">
                                            ...
                                            <div id="slideout">
                                                <a class="btn btn-default btn-sm btn-sort" href="#modal-sort" data-toggle="modal">Sort Options</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
                ...
                'sets' => array(
                    array(
                        'position' => 'left',
                        'html' => '<a href="#modal-sort" class="btn btn-default btn-sm" data-toggle="modal">Sort Options</a>',
                    ),
                ),
        );
...
<?= createPrototypeNav(); ?>
<?= createSiteScripts(); ?>
<script src="/scripts/prototype.raters.action.summary.topfilters.js"></script>
