...
$patterns['header'] = array(
    'mainNav' => '
        ...
        <li class="{active=team}"><a href="/manager-assessments-new.php">Team</a></li>
                ...
                array (
                    ...
                    'controls' => array(
                        '<select class="form-control js-select2">
                            ...
                            <option>Assessment Status</option>
                ...
                array(
                    ...
                    "controls" => array(
                       '<label class="control-label">Name:</label><div class="input-group"><input type="text" class="form-control" placeholder="Search"><span class="input-group-btn"><button class="btn btn-default" type="button"><i class="fa fa-search"></i></button></span></div>',
                        '<label class="control-label">Kind:</label><ul class="list-unstyled"><li><label class="checkbox"><input type="checkbox" checked> All</label></li><li><label class="checkbox"><input type="checkbox"> All Assigned</label></li><li><label class="checkbox"><input type="checkbox"> Action Items</label></li><li><label class="checkbox"><input type="checkbox"> Not Assigned</label></li></ul>',
                        ...
                        '<label class="control-label">Status:</label><ul class="list-unstyled"><li><label class="checkbox"><input type="checkbox"> All</label></li><li><label class="checkbox"><input type="checkbox" checked> All Not Closed</label></li><li><label class="checkbox"><input type="checkbox"> Assigned</label></li><li><label class="checkbox"><input type="checkbox"> Evaluate</label></li><li><label class="checkbox"><input type="checkbox"> Review</label></li><li><label class="checkbox"><input type="checkbox"> Approval</label></li><li><label class="checkbox"><input type="checkbox"> Closed</label></li></ul>'
                    )
                ),
                array(
                        ...
                        <section class="section">
                            ...
                            <div class="slat slat-callout<?= $flag ?>">
                                ...
                                <div class="slat-nested">
                                    ...
                                    <!-- <a href="#" class="collapse-toggle" data-toggle-text="Show Progress|Hide Progress">Show Progress<i class="fa fa-fw fa-caret-down"></i></a> -->
                                    <!-- <a href="#" class="collapse-toggle">Toggle Progress<i class="fa fa-fw fa-sort"></i></a> -->
                                </div>
                            </div>
                            <?php } ?>
                        </section>
