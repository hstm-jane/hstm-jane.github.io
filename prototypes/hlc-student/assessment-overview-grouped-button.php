                        ...
                        $stickybar = array(
                            'sets' => array(
                                array(
                                    'position' => 'left',
                                    'html' => '
                                        <a href="#tab-2" class="btn btn-default" data-toggle="tab">Group</a> <a href="#modal-filter" class="btn btn-default" data-toggle="modal">Sort &amp; Filter</a>
                                    ',
                                ),
                            ),
                        );
                ...
                <div class="tab-pane" id="tab-2">
                    <section class="section">
                        ...
                        <table class="ag-chart-horizontal">
                            <tr>
                                <td class="chart-value"><a href="#tab-1" class="chart-tab" data-toggle="tab">Assigned <span class="badge">1</span></a></td>
                                <td class="chart-value"><a href="#tab-1" class="chart-tab" data-toggle="tab">Approval <span class="badge">1</span></a></td>
                                <td class="chart-value"><a href="#tab-1" class="chart-tab" data-toggle="tab">Review<span class="badge">3</span></a></td>
                                <td class="chart-value"><a href="#tab-1" class="chart-tab" data-toggle="tab">Evaluate<span class="badge">5</span></a></td>
                                <td class="chart-value"><a href="#tab-1" class="chart-tab" data-toggle="tab">Closed<span class="badge">30</span></a></td>
                            </tr>
                        </table>
