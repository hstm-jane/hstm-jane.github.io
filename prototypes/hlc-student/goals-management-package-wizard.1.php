...
<div class="layout layout-goal-management layout-wizard">
    <div class="container">
        <section class="section section-main section-box">
         <nav class="nav-focus">
                <div class="nav-mobile visible-xs visible-sm">
                    <span><i class="fa fa-caret-down"></i><span class="focus-nav-title">Create Package</span></span>
                    <a href="#nav-main" class="toggle"><i class="fa fa-bars"></i></a>
                </div>

                <ul class="nav">
                    <li class="li personal-information active" data-li="personal-information">
                        <a class="wizard-nav-link personal-information active" href="#" data-rel="personal-information">Set Dates</a>
                    </li>
                    <li class="li work-experience" data-li="work-experience">
                        <a class="wizard-nav-link work-experience" href="#" data-rel="work-experience">Rating Scale</a>
                    </li>
