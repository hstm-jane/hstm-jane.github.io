                ...
                <div class="tab-content">
                    <div class="collapse in active" id="step1">
                        ...
                        <section class="section" style="display:none;">
                            ...
                            <input type="hidden" id="SectionType" value="statements">
                        </section>
                        
                    </div> <!--/select type tab-->
                    <div class="collapse" id="step1-complete" style="display:none;">
                        ...
                        <section class="section">
                            ...
                            <small style="font-size:14px"> - <span style="font-style:normal;">(<a href="assessment-dynamic-section-summit.php" >Change Section</a></span> - You will lose any unsaved work on this section<span style="font-style:normal;">)</span></small></h4>
                        </section>
                    </div> <!--/select type tab-->

                    <div class="" id="step2-statements">

                       
                        
                        <!-- START: Statements - Display Selections -->
                        <section class="section statements-selected collpase" >
                            <h3>Step 1: Statements <small>Choose the items(s) to share</small></h3>
                    ...
                    <div class="collapse" id="step2-jobdescriptions">
                        ...
                        <section class="section jobdescriptions-selected collpase">
                            <h3>Step 1: Job Descriptions <small>Choose the items(s) to share</small></h3>
                        ...
                        <section class="section section-footer jobdescriptions-selected-footer collpase">
                            <a href="assessment-search-job-descriptions.summit.php?assessment=<?= $assessmentID ?>" class="btn btn-default">Select Job Descriptions</a>
                        </section>
                            ...
                            <div class="section-header">
                                <div class="row">
                                    <div class="col-xs-8 section-header-title">
                                        <h3>Step 2: People <small>Choose who receives the updates</small></h3>
                                    </div>
                            ...
                            'sets' => array(
                                array(
                                    'html' => '
                                        ...
                                        <a href="assessment-overview-dynamic.php" class="btn btn-default">Cancel</a>
                                    ',
                                ),
                            ),
                        );
    ...
    $(function(){
        ...
        $('#Add').click(function(e){
            ...
            if(IsValidDynamicSection()) {
                window.location.href = "/assessment-overview-dynamic-summit.php" + 
