...
<head>
    ...
    <!-- Styles
    ================================================== -->
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1479301846">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1479301846">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1479301846">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1479301846">
...
<body class=""><div class="site-header ">
    <div class="container">
...
<!--<ul class="meta">
<li class="meta-hidden-xs" class="meta-hidden-xs"><span class="meta-label">Assessment Approval</span></li>
</ul>-->
...
<li class="meta-hidden-xs"><span class="<meta-la></meta-la>bel">For Assessment: </span><span class="meta-value"><span class="meta-value">Initial Nursing Competency Appraisal</span></li>
</ul></div>
...
<section class="section assessment-action-section" id="jump-signoff">
   <h3>Sign Off</h3>
    ...
    <form class="validate">
        ...
        <div class="form-group">
            <h4 >Rater's Comments <small></small></h4>
...
<section class="section" id="ratings-top">
   <h2 style="font-weight:400;">Initial Nursing Competency Appraisal  
    <span class="average-rating">Assessment Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a> 
     |  <a href="#modal-state-detail-approval" data-toggle="modal">View Approval Activity</a></span></h2>
...
if ($empId != 1) {
    echo '<span class="meta-box-value">Chamberland, Marie</span>'; } else { echo '<span class="meta-box-value">Juniper, Stephanie P.</span>'; } ?>
                ...
                <div class="mb-cell">
                        ...
                        <span class="meta-box-value">Sign Off</span> 
                </div>
                <div class="mb-cell">
        ...
        $('.js-submit-to-review').click(function(e){
                    ...
                    HealthStream.utilities.interrupt({
                        ...
                        actions: [
                        {
                            ...
                            url: '/assessment.php?assessment=competency-1&user=rater&state=0&progress=1',
                        },
                        {
                            type: 'default',
                            label: 'Cancel',
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"54ac9448ca","applicationID":"9436983","transactionName":"YlxRYxdZWEcEVxBeCVsWZkUMF1dHFlEXRAtQV0caC11BQARWFxkWXUk=","queueTime":0,"applicationTime":22,"atts":"ThtSFV9DS0k=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>