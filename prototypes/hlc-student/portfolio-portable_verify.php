...
$patterns['header']['mainNav'] = ' <li class="{active=profile}"><a href="#">Portfolio</a></li>';
$patterns['focus']['title'] = 'ePortfolio';
...
.dropdown-menu>li>a.show-hidden-records{
    display: none;
}
        ...
        <section class="section section-main section-box">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="tab-1">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <section class="section">
                                <h2>About ePortfolio</h2>

                                <p><a href="#modal-portable-portfolio-about" data-toggle="modal">What is my ePortfolio?</a></p>
                            </section>
                ...
                <div class="tab-pane fade in active" id="tab-2">
                    <div class="row">
                        <div class="col-md-9">
                            <section class="section verified-slats" style="padding-right:30px; border-right: 1px solid #ddd;">
                                                    ...
                                                    'action' => array(
                                                        ...
                                                        'content' => '
                                                            <div class="action action-split">
                                                                <div class="btn-group">
                                                                    <a href="#modal-work-experience" data-toggle="modal" class="btn btn-default btn-sm hidden-xs">Manage</a>
                                                                    <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                                                        <i class="fa fa-caret-down"></i>
                                                                    </a>
                                                                    <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="slat-group">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li><a href="#" class="show-hidden-records">Show Hidden Items</a></li>
                                                            <li role="presentation" class="divider"></li>
                                                            <li><a href="#">Move Section Up</a></li>
                                                            <li><a href="#">Move Section Down</a></li>
                                        ...
                                        <div class="slat-group-content">
                                                ...
                                                $slat = array(
                                                    ...
                                                    'title' => 'Vanderbilt',
                                                    'description' => '<i class="fa fa-cloud-download"></i> Imported from HCA',
                                                    'meta' => array(
                                                        array(
                                                            'label' => 'Degree:',
                                                            'value' => 'Bachelors',
                                                        ...
                                                        array(
                                                            'label' => 'Verified By:',
                                                            'value' => 'Healthstream
                                                                <div class="verified"><span class="fa fa-stack text">
                                                ...
                                                $slat = array(
                                                    ...
                                                    'meta' => array(
                                                        ...
                                                        array(
                                                            ...
                                                            'value' => '<span class="meta-callout-label">Expires:</span>Feb 28, 2017',
                                                            'attributes' => array(
                                                                array('class','meta-callout'),
                                                            )
                                                        ),
                                ...
                                <section class="section certifications-container">
                                    <div class="slat-group">
                                        ...
                                        <div class="slat-group-content">
                                            ...
                                            $slatNonExpired = array(
                                                ...
                                                'meta' => array(
                                                    ...
                                                    array(
                                                            ...
                                                            'value' => '<span class="meta-callout-label">Expires:</span>Aug 31, 2016',
                                                            'attributes' => array(
                                                                array('class','meta-callout'),
                                                        )
                                                    ),
                                            ...
                                            echo createSlat($slatNonExpired);
                                            ...
                                            $slat = array(
                                                ...
                                                'title' => 'PMHCNS-BC - Adult Psychiatric-Mental Health Clinical Nurse Specialist',
                                                'meta' => array(
                                                    array(
                                                        'label' => 'Country:',
                                                        'value' => 'United States',
                                                    ...
                                                    array(
                                                            ...
                                                            'value' => '<span class="meta-callout-label">Expires:</span>Jul 15, 2016',
                                                            'attributes' => array(
                                                                array('class','meta-callout'),
                                                        )
                                                    ),
                                        ...
                                        ?>
                                            ...
                                            echo createSlat($slatNonVerified);
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <li role="presentat ion" class="divider"></li>
                                                            <li><a href="#">Move Section Up</a></li>
                                                            <li><a href="#">Move Section Down</a></li>
                                          ...
                                          <div class="slat-group-content">
                                                ...
                                                echo createSlat($slat);
                                                 ...
                                                 $slat = array(
                                                    ...
                                                    'title' => 'NRP Instructor - NRP Instructor Card (6th Edition)
                                                                ',
                                                    'meta' => array(
                                                        array(
                                                        ...
                                                        array(
                                                         ...
                                                         array(
                                                            ...
                                                            'value' => '<span class="meta-callout-label">Expires:</span>Jun 28, 2017',
                                                            'attributes' => array(
                                                                array('class','meta-callout'),
                                                            )
                                                        ),
                                                    ...
                                                    'meta' => array(
                                                        ...
                                                        array(
                                                         ...
                                                         array(
                                                            ...
                                                            'value' => '<span class="meta-callout-label">Dates:</span>Jul 2011 - Present',
                                                            'attributes' => array(
                                                                array('class','meta-callout'),
                                                            )
                                                        ),
                ...
                <div class="row">
                        <div class="col-md-9">
                            <section class="section" style="padding-right:30px; border-right: 1px solid #ddd;">
                                <section>
                                    <h2>Why is my data not displayed?</h2>
                                ...
                                <section>
                                    <h2>Unavailable ePortfolio Sections</h2>
                                    <p>A few sections currently are not available in your ePortfolio. As each section becomes available, it will be enabled for you to start entering your records. Check back soon to get started.</p>
                                </section>
...
$(document).ready(function(){
    $(".hide-record").click(function(){
        $(this).closest(".slat").fadeOut();
        $(this).closest(".slat-group").find(".show-hidden-records").show();

    });

    $(".show-hidden-records").click(function(){

        $(this).parents(".slat-group").find(".slat").fadeIn();
        $(this).hide();
    });
});
