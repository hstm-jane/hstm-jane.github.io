...
/*Form Wizard*/
.bs-wizard {border-bottom: solid 1px #dadada; padding: 0 0 10px 0;}
.bs-wizard > .bs-wizard-step {padding: 0; position: relative;width:40px;}
.bs-wizard > .bs-wizard-step + .bs-wizard-step {}
.bs-wizard > .bs-wizard-step .bs-wizard-stepnum {color: #888; font-size: 14px; font-weight:600;margin-bottom: 5px;}
.bs-wizard > .bs-wizard-step .bs-wizard-info {color: #999; font-size: 14px;}
.bs-wizard > .bs-wizard-step > .bs-wizard-dot {position: absolute; width: 30px; height: 30px; display: block; background: #cce4cc; top: 45px; left: 50%; margin-top: -25px; margin-left: -15px; border-radius: 50%;} 
...
.bs-wizard > .bs-wizard-step > .progress {position: relative; border-radius: 0px; height: 8px; box-shadow: none; margin: 11px 0;background-color:#dadada;}
.bs-wizard > .bs-wizard-step > .progress > .progress-bar {width:0px; box-shadow: none; background: #cce4cc;}
.bs-wizard > .bs-wizard-step.complete > .progress > .progress-bar {width:100%;}
.bs-wizard > .bs-wizard-step.active > .bs-wizard-dot {background-color:#c0e0ea;}
.bs-wizard > .bs-wizard-step.active > .bs-wizard-dot:after {background-color:#09c;}
.bs-wizard > .bs-wizard-step.active > .progress > .progress-bar {width:50%;}
.bs-wizard > .bs-wizard-step:first-child.active > .progress > .progress-bar {width:0%;}
.bs-wizard > .bs-wizard-step:last-child.active > .progress > .progress-bar {width: 100%;}
.bs-wizard > .bs-wizard-step.disabled > .bs-wizard-dot {background-color: #dadada;}
.bs-wizard > .bs-wizard-step.disabled > .bs-wizard-dot:after {opacity: 0;}
.bs-wizard > .bs-wizard-step:first-child  > .progress {left: 50%; width: 50%;}
.bs-wizard > .bs-wizard-step:last-child  > .progress {width: 50%;}
.bs-wizard > .bs-wizard-step.disabled a.bs-wizard-dot{ pointer-events: none; }
/*END Form Wizard*/
.profress-description {
    text-transform: uppercase; 
    text-align:center;
    font-size:12px;
    font-weight:600;
...
<div class="layout layout-assessment">
   ...
   <div class="meta-box">
    ...
    <div class="meta-box-cell" style="text-align:right;width:350px;vertical-align:middle; text-align:right;">
        <div style="display:table;text-align:right;max-width:350px;">
            <div style="display:table-cell;vertical-align:middle;padding-right:10px;text-align:right;">
                <a href="#"><i class="fa fa-fw fa-chevron-left" style="font-size:20px;"></i></a>
            </div>
            <div style="display:table-cell;text-align:right;">
                            ...
                            <div class="profress-description">Statement Rating Progress</div>
            </div>
            <div style="display:table-cell;vertical-align:middle;padding-left:10px;text-align:right;">
                <a href="#"><i class="fa fa-fw fa-chevron-right" style="font-size:20px;"></i></a>
            </div>
        </div>
    </div>
