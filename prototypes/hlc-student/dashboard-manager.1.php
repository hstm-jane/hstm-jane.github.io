                            ...
                            <li>
                                ...
                                <div class="app-drawer-content-panel">
                                    <ul class="app-drawer-nav-item">
                                        ...
                                        <li class="app-drawer-nav-item">
                                            <a target="_blank" href="http://hstm-sail-hstream-auth.patternmanager.com/view-apps.php">
                                                <div class="app-drawer-nav-item-logo">
                                                    <div class="svg-icon-wrap">
                                                        <img src="content/images/hstream-logo.png" style="width: 40px;height: 10px;margin-left: 5px;margin-top: 16px;">
                                                    </div>
                                                </div>
                                                <div class="app-drawer-nav-item-content">
                                                    <h5 class="title">View hStream Cloud Apps</h5>
                                                    <p class="description">View all hStream Cloud apps.</p>
                                                </div>
                                            </a>
                                        </li>
                    ...
                    <div class="portlets-wrapper">
                        <div class="col-lg-3 ui-sortable" id="portlet-1" data-toggle="portlet">
                           ...
                           <div class="">Bruno, Brad K.
                               <div class="text-sm text-muted">Clinical Nurse Supervisor (RN)</div>
                           </div>
                       </div>
                   </div>
                   <div class="media">
