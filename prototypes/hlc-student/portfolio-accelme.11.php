...
<div class="container accel-me-container">
  ...
  <div class="progress" style="margin:0 auto 40px">
    <div class="progress-bar js-overall-progress" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" >
      <span>40%</span>
    </div>
  </div>
    ...
    <div class="tab-pane fade active in" id="level-2">
      <div class="container" style="margin-top:25px;">
        <div class="row">
          <div class="col-md-3 col-sm-6">
            <div class="card-container manual-flip completed">
              <div class="card card-level journey-badge" onclick="rotateCard(this)">
                <div class="front">
                  <div class="cover">
