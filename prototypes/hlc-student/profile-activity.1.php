...
?>
                  ...
                  <section class="section">
                    <div class="slat-group">
                      <div class="slat-group-header ">
                        <h2>Education <a href="#" class="btn btn-warning btn-sm js-review-btn">Mark Section as Reviewed</a><i class="fa fa-check-circle done"></i> </h2>
                      </div>
                      <div class="slat-group-content">
                        <div class="slat">
