	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group profession">
					<label class="control-label text-normal">Select your current Profession</label>
					<select class="form-control">
						<option>Choose a Profession</option>
						<option value="with-specialty" data-profession="surgeon">Surgeon: With a specialty</option>
						<option value="without-specialty" data-profession="tech">Without a specialty</option>
					...
					<div class="form-group">
						<label class="control-label text-normal">What's the Setting?</label>
						<select class="form-control">
							<option>Choose a Setting</option>
							<option>...</option>
							<option>...</option>
							...
							<option>...</option>
									...
									<div class="form-group">
										<label class="control-label text-normal">When did you start?</label>
										<div class="row">
											<div class="col-xs-3">
												<select class="form-control">
													<option disabled="" selected="">MM</option>
												...
												<label class="text-normal"><small class="text-white">Optional</small></label>
											</div>
											<div class="col-xs-3">
												<select class="form-control">
													<option disabled="" selected="">YYYY</option>
			...
			<div class="modal-footer pt0">
				<a href="#" class="btn btn-default" data-dismiss="modal">Update my Work Experience</a>
