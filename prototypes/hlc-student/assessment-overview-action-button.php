...
include "includes/data/assessments-overview.1.php";
...
<style>
    ...
    .assessment__actionss {
        width:140px;
    }
    .assessment__actionss .btn-group .btn{
        width:90px;
    }
    .assessment__actionss .btn-group .dropdown-toggle{
        width:25px;
    }
    .btn-sort {
        display: none;
                        ...
                        <?php foreach ($assessments as $assessment) { ?>
                                ...
                                <?php } ?>
                                    <div class="assessment__summary">
                                        ...
                                        <div class="assessment__actionss">
                                         <div class="action action-split">
                                            <div class="btn-group"> 
                                                <a href="<?= $assessment['url'] ?>" class="btn btn-default btn-sm hidden-xs" data-toggle="modal"><?= $assessment['action-label'] ?></a>
                                                <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"><i class="fa fa-caret-down"></i></a>
                                           
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="#" class="js-progress" data-id="<?= $assessment['progress_id'] ?>">View Assessment</a></li>
