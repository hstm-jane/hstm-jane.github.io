        ...
        <div class="fph-table">
            <div class="fph-row">
                ...
                <div class="fph-cell fph-cell-supporting">
                    <img src="/content/images/coaching-quick.png"> </div>
            </div>
        </div>
    </div>
    <div class="layout">
                    ...
                    <section class="section section-main section-box" data-equalize="layout-columns">
                        ...
                        <section class="section" id="tasks">
                            ...
                            <div class="slat slat-attention slat-spaced slat-callout slat-peer-assessment slat2" data-filter-category="5">
                                ...
                                <div class="slat-default">
                                    <div class="title">
                                        <a href="assessment.php?assessment=performance-2&Status=4">SIGN OFF: Nursing Competency Appraisal - Bennet, Betty</a>
                                    </div>
                                    <ul class="meta">
                                        <li>
                                            <span class="meta-label">Status:</span>
