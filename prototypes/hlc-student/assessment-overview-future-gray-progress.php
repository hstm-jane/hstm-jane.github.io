...
if ($range != false ){
    $assessments = array_filter($assessments, function ($var) use ($range) {
     ...
     switch($range) {
        ...
        // default: 
        //     print "hey";
        //     return($assessment['days'] <= intval($range));
        //     break;
    }
});
}
...
<style>
  ...
  @media screen and (min-width:768px){
    ...
    .assessment .progress-bar, .modal-progress__table .progress-bar {
         ...
         <?php
            ...
            <div class="tab-content" style="position: relative;">
                ...
                <div class="tab-pane" id="summary" >
                    ...
                    <section class="section">
                        ...
                        <section class="section">
                            ...
                            <a href="#" class="see-more pull-right" >See More</a>
                            <?php }?>
                             ...
                             <div class="filter-item filter-employee">
                                <div class="form-group">
                                    ...
                                    <div class="filter-text">
                                        ...
                                        <i class="fa fa-times" style="color:#908e8e;font-size:14px;margin-left:5px;"></i>
                ...
                'sets' => array(
                    array(
                        'position' => 'left',
                         'html' => '<a class="btn btn-default btn-sm reset-filters" >Reset Filters</a>
