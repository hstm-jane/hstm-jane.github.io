    ...
    <div style="display:table; font-size:14px;">
        <div style="display:table-row">
            <div style="display:table-cell;padding: 5px 10px 0 5px;"></span>
                <span style="margin-right:7px;"><span class="meta-box-label">Assessment Rating:</span> <a href="#" class="js-rating-definitions" data-params="assessment=competency-1">Pending<i class="fa fa-fw fa-info-circle"></i></a></span> 
                <!--<span style="margin-right:7px;"><span class="meta-label">Approval Activity:</span> <a href="#modal-state-detail-approval" data-toggle="modal">View<i class="fa fa-fw fa-info-circle"></i></a></span>-->
            </div>
        </div>
        <div style="display:table-row">
