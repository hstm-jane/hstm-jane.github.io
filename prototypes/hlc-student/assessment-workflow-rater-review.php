                ...
                $stickybar = array(
                    'sets' => array(
                        array(
                            ...
                            'html' => '
                                <a href="assessment-workflow-rater-signoff.php" class="btn btn-success" id="btn-signoff">Begin Sign off Process</a>
                        ...
                        array(
                            ...
                            'html' => '
                                <a href="assessment-workflow-rater-signoff.php" class="btn btn-success" id="btn-signoff">Sign off</a>
                                <div class="btn-group dropup">
                                    <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Employee <i class="fa fa-caret-up"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-header">About Stephanie P. Juniper</li>
