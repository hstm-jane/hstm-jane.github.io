...
<div class="layout layout-assessment">
    <div class="container">
        <section class="section section-main section-box">
             <div class="assessment-header">
                <div class="assessment-return"><a href="assessment-overview.php"><i class="fa fa-fw fa-chevron-left"></i>Return to To Do</a> </div>
            </div>
   ...
   <!--<div style="display:table; font-size:14px;">
    ...
    <div style="display:table; font-size:14px;">
        ...
        <div style="display:table-row">
            <div style="display:table-cell;padding: 5px 10px 0 5px;">
