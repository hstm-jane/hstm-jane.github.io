        ...
        <section class="section section-main section-box">
            ...
            <section class="section section-dynamic">
                ...
                <?= makeStatement(array(
                    ...
                    'url' => 'assessment-performance-rater-rate-job.php',
                    'actors' => $hasrating,
                )) ?>
             ...
             <section class="section section-dynamic">
                ...
                <footer class="section-footer">
                    <a href="assessment-search-job-descriptions.php?single" class="btn btn-default btn-sm">Select Job Descriptions</a>
                </footer>
            </section>
            ...
            <section class="section">
                ...
                <?= makeStatement(array(
                    ...
                    'url' => 'assessment-performance-rater-rate.php',
                    'actors' => $hasrating,
                )) ?>
                <?= makeStatement(array(
                    'editable' => true,
    ...
    $('.js-submit-to-review').click(function(e){
        ...
        HealthStream.utilities.interrupt({
            ...
            actions: [
            {
                ...
                url: '/assessment-performance-rater-review.php',
            },
            {
                type: 'success',
