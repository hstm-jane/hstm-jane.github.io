                                ...
                                <div class="tab-pane" id="summary">
                                    <div class="clearfix" >
                                        <div class="smart-actions pull-right">
                                            <div class="smart-actions-label" >Filter All by Due Date: </div>
                                    ...
                                    <section class="section">
                                        <section class="section groups-action">
                                            ...
                                            <div class="assessment-groups">
                                                <?php 
                           // $groupings['state']['new'] = array_merge($groupings['state']['evaluate'], $groupings['state']['assigned']);
                            // print_r ($groupings['state']['new']);
                            // echo "<br> hey";
                            // print_r ($groupings['state']['evaluate']);
                            // print_r ($groupings['state']['assigned'][1]);
                            ?>
                                        ...
                                        <section class="section groups-employee">
                                            <div class="clearfix">
                                                <h3 class="assessment-groups__title pull-left">Grouped by Employe </h3>
                                                <div class="smart-actions pull-right" style="margin-top:10px;">
                                                    <div class="smart-actions-label">Sort Group by: </div>
                                                    <div class="smart-actions-control">
                                                        <select id="dateRangeSelect" class="form-control pull-right" style="width:220px;">
                                                            <option selected>Employee Name A-Z</option>
                                                            <option value="">Employee Name Z-A</option>
                                                            <option value="">Action Items - Most to Least </option>
                                                            <option value="">Action Items - Least to Most </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                ?>
                                            ...
                                            .assessment-groups-employee-list td,
                                            .assessment-groups-employee-list th {
                                                text-align: center;
                                            }
                                            
                                            .assessment-groups-employee-list tr > td:nth-child(1),
                                            .assessment-groups-employee-list tr > th:nth-child(1) {
                                                text-align: left;
                                            }
                                            
                                            .assessment-groups-employee-list tr > th > a {
                                                color: #333;
                                            ...
                                            .assessment-groups-employee-list tr {
                                                cursor: pointer;
                                            }
                                            </style>
                                            <!--  -->
                                        ...
                                        <section class="section groups-assessment">
                                            <div class="clearfix">
                                                <h3 class="assessment-groups__title pull-left">Grouped by Assessment Title </h3>
                                                <div class="smart-actions pull-right" style="margin-top:10px;">
                                                    <div class="smart-actions-label">Sort Group by: </div>
                                                    <div class="smart-actions-control">
                                                        <select id="dateRangeSelect" class="form-control pull-right" style="width:220px;">
                                                            <option selected>Assessment Title A-Z</option>
                                                            <option value="">Assessment Title Z-A</option>
                                                            <option value="">Action Items - Most to Least </option>
                                                            <option value="">Action Items - Least to Most </option>
                                                        </select>
                                                    </div>
                            ...
                            <?= createPrototypeNav(); ?>
                                <?= createSiteScripts(); ?>
                                    ...
                                    $(function() {
                                        ...
                                        $('.assessment-groups-employee-list tr').click(function() {
                                            alert('Clicking on a row will show the modal just like clicking on a box. ')
                                        })
