                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="learning-activities">
                            ...
                            <section>
                                ...
                                $slat = array(
                                    'title' => '<a href="test-start.php">Assessment</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Assessment',
                                        ),
            ...
            <div class="col-md-3">
                <section class="section section-sidebar" data-equalize="layout-columns">
                    <section class="section section-box">
                        <h3>Options</h3>
                        <p>This course is within an equivalent and can be exchanged for another to fullfill the requirement.</p>
                        <p><a href="equivalent-with-selection.php">View Alternate Courses</a></p>
                        <hr>
                        <p><a href="#" id="unenroll-confirm" class="btn btn-danger btn-sm">Un-Enroll From Course</a></p>
                    </section>
...
$(function(){
    ...
    $('#unenroll-confirm').click(function(e){
        e.preventDefault();
        HealthStream.utilities.interrupt({
            type: 'warning',
            title: 'Are you sure you want to un-enroll?',
            text: 'Unenrolling from this couse will cause you to lose any work you have already performed.',
            actions: [
            {
                type: 'danger',
                label: 'Un-enroll from this course'
            },
            {
                label: 'Cancel'
            }
