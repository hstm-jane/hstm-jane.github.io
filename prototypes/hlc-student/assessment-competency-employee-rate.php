...
$patterns['focus']['meta_primary'] = array(
    array(
        ...
        'value' => '<a href="'.$return.'" class="meta-value">Competency Appraisal - Employee Workflow</a>',
        'attributes' => array(
                    ...
                    <section class="section" data-equalize="layout-columns" id="rating-form">
                        <form class="validate">
                            ...
                            <div class="form-group">
                                ...
                                <label id="label-comments-optional" class="control-label">
                                    <small>Optional</small>
                                </label>
                                <textarea class="form-control"<?= ($readonly)?' disabled':''; ?>></textarea>
                                <?php if (!$readonly) { ?>
                                <div class="control-add-new">
                                    <a href="#modal-notes" data-toggle="modal">Select Notes</a>
                                </div>
                                <?php } ?>
                            </div>
                            <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" data-dismiss="modal">Add Selected</button>
                <button class="btn btn-success" data-dismiss="modal" id="NewNote">New Note</button>
...
<script>
    $(function(){
        ...
        $(document).on("click", "#NewNote", function () {
            var noteType = "other";
            $('.modal-body input[name=type][value=other]').prop('checked', 'checked');
             $("#modal-note-add").modal("show");
        });
       

        $("#CancelAddNewNoteButton").click(function() {
            $("#modal-note-add").modal("hide");
            $("#modal-notes").modal("show");
        });

        $("#SaveAddNewNoteButton").click(function() {
            $("#modal-note-add").modal("hide");
            $("#modal-notes").modal("show");
        });

         $("#modal-note-add").on('shown.bs.modal', function() {
           handleNoteTypeChange("other");
