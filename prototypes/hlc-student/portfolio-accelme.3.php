...
#timeline .timeline-item.completed .timeline-content {
  ...
  transition: all .2s ease;
          ...
          ul.progress li.active:after {
            box-shadow: 6px -6px 0 3px #0099cc;
          }
  ...
  <section class="section">
    <section class="section section-results-header">
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            <label class="control-label">What Challenge Would You Like to Explore?</label>
            <select class="form-control">
              <option>Career Path 1</option>
              <option>Department Challenge 1</option>
              <option>Department Challenge 2</option>
              <option>Badges Earned</option>
            </select>
          </div>
        </div>
        <div class="col-md-6 text-right">
          <div class="leader-board">
            <div class="leader-number">300</div>
            <div id="star-five"></div>
            <div class="leader-group">out of 400</div>
          </div>
        </div>
      </div>
      <section class="section">
        <div class="container">
          <ul class="progress">
            ...
            <li class="active"><a href="">Level 4</a></li>
          ...
          <div id="timeline">
            <div class="timeline-item completed">
              ...
              <div class="timeline-content  ">
                <h3>Complete Your Personal Profile <i class="fa fa-check-square-o fa-lg completed-icon"></i> </h3>
