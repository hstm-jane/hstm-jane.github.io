...
<div id="modal-healthstream-id-reset-password" class="modal show modal-external" data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form data-toggle="validator" id="forgotPasswordForm" method="post" action="healthstream-id-reset-password-sent.php">
                <div class="modal-body">
                    <h3 class="title">Reset HealthStream ID Password</h3>
