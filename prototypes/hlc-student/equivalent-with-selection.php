                        ...
                        <div class="tab-pane fade active in" id="courses">
                            ...
                            <section class="section">
                                ...
                                $slat = array(
                                    ...
                                    'action' => array(
                                        'type' => 'custom',
                                        'content' => '<div class="action"><a class="btn btn-sm btn-danger" href="#" id="modal-unenroll-course" data-toggle="modal">Un-enroll<i class="fa fa-times visible-xs"></i> </a></div>',
                                    )
                                );
