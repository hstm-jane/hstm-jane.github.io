...
<div class="layout layout-assessment">
 ...
 <style>
   ...
   .assessment-action-section {
    ...
    .assessment-details {
         /*box-shadow: 0 3px 3px rgba(0,0,0,0.07   ), 0 3px 3px rgba(0,0,0,0.07);*/
           /*box-shadow: 0px 5px 5px rgba(0,0,0,0.07), 0px -5px 5px rgba(0,0,0,0.07);*/
            /*box-shadow:   4px 4px 5px 0px rgba(0,0,0,0.07),       4px 4px 5px 0px rgba(0,0,0,0.07);*/
               /*box-shadow:   2px 2px 5px 0px  rgba(0,0,0,0.07),*/
               /*-2px -2px 5px 0px  rgba(0,0,0,0.07);*/
...
<!--<section><hr class="shadow-line"></section>-->
