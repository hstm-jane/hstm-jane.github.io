            ...
            <div class="col-md-3">
                <section class="section section-sidebar" data-equalize="layout-columns">
                    ...
                    <section class="section section-box">
                        <h3>Synchronizing Accounts</h3>
                        <p>Your organization has not yet given permission to synchronize this information with your portable portfolio. It will move over automatically when available.</p>
                    </section>
