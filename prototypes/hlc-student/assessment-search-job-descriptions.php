...
$patterns['start']['title'] = 'Job Description Search';
$patterns['focus']['title'] = 'Job Description Search';
                            ...
                            $stickybar = array(
                                'sets' => array(
                                    array(
                                        ...
                                        'html' => '
                                            <a href="#" class="btn btn-success add-selected">Add</a>
                                    ...
                                    array(
                                        ...
                                        'html' => '
                                            <div class="btn-group dropup">
                                                <button type="button" class="btn btn-default dropdown-toggle results" data-toggle="dropdown">Results 1-11 of 11 <i class="fa fa-caret-up"></i></button>
                                                <ul class="dropdown-menu" role="menu">
                                                <li class=""><a href="#">5 per page</a></li>
                                                    <li class="active"><a href="#">25 per page</a></li>
                                                    <li class=""><a href="#">50 per page</a></li>
