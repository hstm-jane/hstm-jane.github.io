...
<div class="layout layout-assessment">
   ...
   <div class="meta-box">
    ...
    <div class="meta-box-cell" style="text-align:right;width:300px;vertical-align:middle;">
        <div style="display:table;text-align:right;max-width:300px;">
            <!--<div style="display:table-cell;vertical-align:middle;padding-right:10px;text-align:right;">
                <a href="#"><i class="fa fa-fw fa-chevron-left"></i>Previous</a>
            </div>-->
            <div style="display:table-cell;text-align:right;">
                <div class="pb-container">
                    <ul class="progressbar">
                        <li class="complete"><span class="value">1</span></li>
                        <li class="complete"><span class="value">2</span></li>
                        <li class="complete"><span class="value">3</span></li>
                        <li class="active"><span class="value">4</span></li>
                        <li><span class="value">5</span></li>
                        <li><span class="value">6</span></li>
                        <li><span class="value">7</span></li>
                    </ul>
                </div>
            </div>
            <!--<div style="display:table-cell;vertical-align:middle;padding-left:10px;text-align:right;">
                <a href="#">Next<i class="fa fa-fw fa-chevron-right"></i></a>
            </div>-->
        </div>
    </div>
