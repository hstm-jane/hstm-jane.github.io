                        ...
                        <section class="section">
                         <h3 class="assessment-groups__title">Grouped by Action</h3>
                            <div class="assessment-groups">
                                <?php echo makeGroupingBox('state','evaluate',0,0,0); ?>
                                <?php echo makeGroupingBox('state','review',0,0,0); ?>
                                <?php echo makeGroupingBox('state','signoff',0,0,0); ?>
                            </div>
                        </section>
                            ...
                            <div class="assessment-groups">
                                <div class="slat no-assessments ">
                                    <div class="slat-message">
                                         <h3>You currently have no action items.</h3>
                                    </div>
                                </div>
                            </div>
