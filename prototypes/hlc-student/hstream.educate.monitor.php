                ...
                <div class="row">
                    <div class="col-md-12">
                        <section class="section section-box section-main " style="padding:0px 10px 0px 10px;">
                            <a href="hstream.educate.monitor.2.php?org=<?= $org ?>" class="padbtn"></a>
                            <a href="hstream.educate.monitor.3.php?org=<?= $org ?>" class="padbtn-details"></a>
                            <?php
                                if ($org == '3') {
                                    echo '<img src="/content/images/PAD-1-Mainline-size.svg" nopin="nopin"/>';
                                }
                                else if ($org == '2') {
                                    echo '<img src="/content/images/PAD-1-Ascension-size.svg" nopin="nopin"/>';
                                }
                                else if ($org == '1') {
                                    echo '<img src="/content/images/PAD-1-CHS-size.svg" nopin="nopin"/>';
                                }
                                else {
                                    echo '<img src="/content/images/PAD-1-HCA-size.svg" nopin="nopin"/>';
                                }
                            ?>
                        </section>
                    </div>
