...
<head>
    ...
    <title>My Connections | HealthStream</title>
    <!-- Styles
    ================================================== -->
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1497392479">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1497392479">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1497392479">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1497392479">
    <!-- IE 7/8 Handling
    ================================================== -->
    <script>
...
<h1>Focus Title</h1> 
        ...
        <!-- </div> -->
        <!-- </div> -->
        <div class="row dashboard-focus" style="">
    ...
    <div class="layout layout-connections">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4" style="background-color:#ccc;"> sdf </div>
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel widget">
                                <div class="row ">
                                    ...
                                    <div class="col-md-2 col-sm-3 hidden-xs pv text-center br">
                                        <div class="text-info text-sm">In Progress</div>
                                        <div class="text-muted text-md">
                                           <i class="hs-icons-assessment"> </i>
                                        </div>
                                        <div class="text-muted text-smaller">10
                    ...
                    <div class="row ">
                        <div class="col-lg-12">
                            <div class="col-lg-6 dashboard-focus">
                                <section class="dashboard-todo dashboard-box" style="">
                                    <div class="dashboard-todo-header">
                                        <h3> Online Activities To Do
                                            <span class="badge">8</span>
                                        </h3>
                                    </div>
                                    <a class=" slat-dashboard" href="course.php">
                                        <div class="date">Jun 6, 2017 at 5:16pm</div>
                                        <div class="title">Second Event Last Week</div>
                                    </a>
                                    <a class=" slat-dashboard" href="course.php">
                                        <div class="date">Jun 6, 2017 at 5:16pm</div>
                                        <div class="title">Second Event Last Week</div>
                                    ...
                                    <div class="slat-dashboard-plus"> Plus 2 more... </div>
                                </section>
                            </div>
                            <div class="col-lg-6 dashboard-focus">
                                <section class="dashboard-todo dashboard-box" style="">
                ...
                <div class="col-lg-8 ">
                    <!--   <div class="col-lg-4">
                        <section class="dashboard-todo dashboard-box" style="">
                            ...
                            <div class=" box-dashboard" href="course.php">
                                <div class="date">Jun 6, 2017 at 5:16pm</div>
                                <div class="title">Second Event Last Week</div>
                            </div>
                            <div class=" box-dashboard" href="course.php">
            ...
            <div class="row">
                <div class="col-md-4">
                    <section class="section section-box connections-links" data-equalize="home-sections">
                        <h3 class="connection-links-header">What's New
                            <span><i class="fa fa-fw fa-bullhorn"></i></span>
                        </h3>
                        <ul class="list-unstyled">
                            <li>
                                <a href="#">New Policies from your HR Team</a>
                            </li>
                            <li class="link-attention">
                                <a href="#">OSHA News and Updates</a>
                            </li>
                            <li>
                                <a href="#">Weekly Newsletter</a>
                            </li>
                            <li>
                                <a href="#">New Releases in the Catalog</a>
                            </li>
                            <li>
                                <a href="#">CMS and Value-Based Pricing</a>
                            </li>
                        </ul>
                    </section>
                </div>
                ...
                <div class="col-md-4">
                    <section class="section section-box connections-links" data-equalize="home-sections">
                        <h3 class="connection-links-header">Learning Links
                            <span><i class="fa fa-fw fa-graduation-cap"></i></span>
                        </h3>
                        <ul class="list-unstyled">
                            <li>
                            ...
                            <li>
                                <a href="#">Lippencott - Glucose Monitoring</a>
                            </li>
                            <li class="link-attention">
                                <a href="#">ICD-10 Clinical User Bundle</a>
                            </li>
                            <li>
                ...
                <div class="col-md-4">
                    <section class="section section-box connections-links" data-equalize="home-sections">
                        <h3 class="connection-links-header">Resources
                            <span><i class="fa fa-fw fa-bookmark"></i></span>
                        </h3>
                        <ul class="list-unstyled">
                            <li class="link-attention">
                                <a href="#">Professional Portfolio</a>
                            </li>
                            <li class="link-attention">
                                <a href="#">Education Calendar</a>
                            </li>
                            <li>
                                <a href="#">Leave of Absence Policy</a>
                            </li>
                        </ul>
                    </section>
                </div>
