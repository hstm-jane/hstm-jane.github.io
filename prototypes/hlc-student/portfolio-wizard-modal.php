                ...
                <div class="col-md-12">
                    ...
                    <!-- WIZARD GROUP PERSONAL INFO -->
                        ...
                        <section class="section wizard-group"  id="licenses">
                            ...
                            <div class="licenses-container-manage" style="display: none;">
                            ...
                            <div class="licenses-container-add" style="display: none;">
                                <h2>Add License</h2>
                                <form>
                                    <div class="form-group">
                                        <label class="control-label">Discipline</label>
                            ...
                            <div class="licenses-container">
                                <div class="slat-group">
                                    <div class="slat-group-header">
                                        ...
                                        <div class="slat-group-header-actions">
                                            <div class="btn-group">
                                                <a href="#" class="btn btn-default btn-sm show-add size-check" data-section="licenses">Add</a>
                                                <div class="btn-group">
                                                    <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                                        <i class="fa fa-caret-down"></i>
                                                    </a>
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="#" class="show-add size-check" data-section="licenses">Add Item</a></li>
                                                        <li role="presentation" class="divider"></li>
                                                        <li><a href="#" class="hide-section size-check" data-section="licenses">Hide Section</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            'action' => array(
                                                ...
                                                'content' => '
                                                    <div class="action action-split">
                                                        <div class="btn-group">
                                                            <a href="#" class="btn btn-default btn-sm hidden-xs show-manage size-check" data-section="licenses">Manage</a>
                                                            <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                                                <i class="fa fa-caret-down"></i>
                                                            </a>
                                                            <ul class="dropdown-menu dropdown-menu-right">
                                                                <li><a href="#" class="show-manage size-check" data-section="licenses">Manage</a></li>
                                    ...
                                    <div class="slat-group-footer">
                                        <div class="timestamp">Last Update: Aug 13, 2015</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="display: none">
                                <div class="section-footer-licenses">
                                    ...
                                    <div class="licenses-save-experience">
                                        <a class="btn btn-success size-check hide-add hide-manage" href="#" data-section="licenses"><span class="button-label">Save</a>
                                        <a class="btn btn-default hide-add hide-manage size-check" href="#" data-section="licenses">Cancel</a>
                                    </span>
                                </div>
                            </div>
                        ...
                        <section class="section wizard-group" id="awards">
                            ...
                            <div class="awards-container-add" style="display: none;">
                                <h2>Add Awards &amp; Recognition</h2>
                                <form>
                                    <div class="form-group">
                            ...
                            <div class="awards-container">
                                ...
                                <div class="slat-group">
                                    <div class="slat-group-header">
                                        ...
                                        <div class="slat-group-header-actions">
                                            <div class="btn-group">
                                                <a href="#modal-awards" data-section="awards" class="btn btn-default btn-sm show-add size-check">Add</a>
                                                <div class="btn-group">
                                                    <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                                        <i class="fa fa-caret-down"></i>
                                                    </a>
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="#" data-section="awards" class="show-add size-check">Add Item</a></li>
                                                        <li role="presentation" class="divider"></li>
                                                        <li><a href="#" class="hide-section size-check" data-section="awards">Hide Section</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="slat-group-content">
                                        <div class="slat">
                                            <div class="slat-message">
                                                <h3>This section is empty, add your first item.</h3>
                                                <a href="#" data-section="awards" class="btn btn-default btn-sm show-add size-check">Add Awards &amp; Recognition</a> <a href="#" class="btn btn-default btn-sm hide-section size-check" data-section="awards">Hide Section</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="slat-group-footer"></div>
                            ...
                            <div style="display: none">
                                <div class="section-footer-awards">
                                    <div class="awards-next-step">
                                        <a class="wizard-nav-link btn btn-success size-check" href="#" data-rel="other"><span class="button-label">Next: </span>Other</a>
                                        <a class="btn btn-default" href="#" onClick ="window.parent.closeModal(); return false;">Finished</a>
                                    </div>
                                    <div class="awards-save-experience">
                                        <a class="btn btn-success size-check hide-add" href="#" data-section="awards"><span class="button-label">Save</a>
                                        <a class="btn btn-default hide-add size-check" href="#" data-section="awards">Cancel</a>
                                    </span>
                                </div>
                            </div>
                        ...
                        <section class="section wizard-group" id="other">
                            ...
                            <div class="other-container-add" style="display: none;">
                                <h2>Add Other</h2>
                                <form>
                                    <div class="form-group">
                                        <label class="control-label">Title</label>
                            ...
                            <div class="other-container">
                                ...
                                <div class="slat-group">
                                    <div class="slat-group-header">
                                        ...
                                        <div class="slat-group-header-actions">
                                            <div class="btn-group">
                                                <a href="#" data-section="other" class="btn btn-default btn-sm show-add size-check">Add</a>
                                                <div class="btn-group">
                                                    <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                                        <i class="fa fa-caret-down"></i>
                                                    </a>
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="#" data-section="other" class="show-add size-check">Add Item</a></li>
                                                        <li role="presentation" class="divider"></li>
                                                        <li><a href="#" class="hide-section size-check" data-section="other">Hide Section</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="slat-group-content">
                                        <div class="slat">
                                            <div class="slat-message">
                                                <h3>This section is empty, add your first item.</h3>
                                                <a href="#modal-other" data-section="other" class="btn btn-default btn-sm show-add size-check">Add Other</a> <a href="#" class="btn btn-default btn-sm hide-section size-check" data-section="other">Hide Section</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="slat-group-footer"></div>
                            ...
                            <div style="display: none">
                                <div class="section-footer-other">
                                    <div class="other-next-step">
                                        <a class="btn btn-default" href="#" onClick ="window.parent.closeModal(); return false;">Finished</a>
                                    </div>
                                    <div class="other-save-experience">
                                        <a class="btn btn-success size-check hide-add" href="#" data-section="other"><span class="button-label">Save</a>
                                        <a class="btn btn-default hide-add size-check" href="#" data-section="other">Cancel</a>
                                    </span>
                                </div>
                            </div>
...
<?= createPrototypeNav(); ?>
<?= createSiteScripts(); ?>
<script src="/scripts/prototype.portfolio.wizard.modal.js"></script>
<?= createSiteEnd(); ?>
