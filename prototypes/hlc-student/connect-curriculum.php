...
$patterns['start']['title'] = 'HeartCode BLS G2015';
$patterns['focus']['title'] = 'HeartCode BLS G2015';
...
$tabs = ['Getting Started','Licenses','Courses','Overview','CE and Cards','Completions'];
                ...
                <section class="section section-main section-box" data-equalize="layout-columns">
                    ...
                    <nav class="nav-focus">
                        ...
                        <ul class="nav">
                            ...
                            <li class="unenrolled"><a href="#" id="nav-start"><i class="fa fa-caret-down"></i>Start Curriculum</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade<?php if ($tab == '1') { echo ' in active'; } ?>" id="tab-1">
                            ...
                            <div class="connect-item unenrolled">
                                <div class="connect-item-text">
                                    <h2>Start Curriculum <small>Start a new curriculum enrollment</small></h2>
                                    <i class="fa fa-chevron-right"></i>
                                </div>
                            ...
                            <div class="connect-item enrolled">
                                <div class="connect-item-text">
                                    <h2>Resume Curriculum <small>Pick up where you left off</small></h2>
                                    <i class="fa fa-chevron-right"></i>
                                </div>
                        ...
                        <div class="tab-pane fade<?php if ($tab == '3') { echo ' in active'; } ?>" id="tab-3">
                            <section>
                                <h2>Courses <small>in this Curriculum</small></h2>
                                <?php
                                ...
                                $nested = createSlat(array(
                                    ...
                                    'title' => 'BLS Example Learning Activity',
                                    'meta' => array(
                                        array(
                                            'type' => 'Test',
                                        ),
                                ...
                                $slat = array(
                                    ...
                                    'title' => '<a href="#">HeartCode® BLS Part 1 - G-2015</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Course',
                                        ),
                                ...
                                $slat = array(
                                    ...
                                    'title' => '<a href="#">HeartCode® BLS Parts 2 and 3</a>',
                                    'meta' => array(
                                        array(
                                            'type' => 'Equivalent',
                                        ),
                        ...
                        <div class="tab-pane fade<?php if ($tab == '4') { echo ' in active'; } ?>" id="tab-4">
                            ...
                            <section class="section">
                                ...
                                <p>You will earn or renew the following credits upon successful completion of this curriculum.</p>
                            ...
                            <section class="section">
                                ...
                                <p>You will earn or renew the following certifcations upon successful completion of this curriculum.</p>

                                <?php

                                $slat = array(
                                    'attributes' => array(
                                        array('class',array('slat','slat-default')),
                                    ),
                                    'title' => 'NRP Instructor - NRP Instructor Card (7th Edition)',
                                    'meta' => array(
                                        array(
                                    ...
                                    'action' => array(
                                        ...
                                        'content' => '
                                            <div class="action action-multi">
                                                <div class="btn-group">
                                                    <a href="#" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options
                                                        <i class="fa fa-caret-down"></i>
                                                    </a>
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="#">Manage Item</a></li>
                                                        <li><a href="#modal-view-ecard" data-toggle="modal">View eCard</a></li>
                                                        <li><a href="#">Email eCard</a></li>
                                                        <li><a href="#modal-view-email-history" data-toggle="modal">View Email History</a></li>
                                                        <li><a href="#">Create Instructor Application</a></li>
                                                        <li><a href="#">View Instructor Application</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ',
                                ...
                                $slat = array(
                                    ...
                                    'meta' => array(
                                        array(
                                            'label' => 'Certifying Body:',
                                            'value' => 'American Heart Association (AHA)',
                                        ),
                                        array(
                                            'label' => 'Certification Period:',
                                            'value' => '2 Years',
            ...
            <div class="col-md-3">
                <section class="section section-sidebar" data-equalize="layout-columns">
                    <section class="section section-box">
                        <h3>Options</h3>
                        <p>You can exit this course by closing the browser window.</p>
                    </section>
...
<!-- Modal -->
<div id="modal-view-email-history" class="modal fade" role="dialog" aria-labelledby="modal-view-email-history-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title">View Email History</h4>
            </div>
            <div class="modal-body">
                <section class="section">
                    <h2>Dec 16, 2014 - Dec 16, 2015</h2>
                    <?php
                    ...
                    $slat = array(
                        ...
                        'title' => 'There are no emails in this date range',
                        'meta' => array(),
                        'action' => array()
                    );
                    echo createSlat($slat);
...
<!-- Modal -->
<div id="modal-view-ecard" class="modal fade" role="dialog" aria-labelledby="modal-view-ecard-label" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title">View eCard</h4>
            </div>
            <div class="modal-body">
                <div style="margin: 20px auto; width: 412px;">
                    <img src="/content/images/prototype.nrp-instructor-card.png" alt="NRP Instructor Card">
                </div>
            </div>
        </div>
    </div>
...
<?= createSiteScripts(); ?>
    <script>
        $(function(){
            ...
            // Fix for modal appearing under modal backdrop
