...
<div class="layout ">
    ...
    <script>
        $(".col-md-3 .section-sidebar .section-box:first-of-type").html('<h3>ePortfolio Support</h3><ul class="list-links"><li><a href="http://www.healthstream.com/eportfolio/support/" target="_blank">ePortfolio FAQs and Help</a></li><li><a href="#modal-portable-portfolio-about"</li><li><a href="#" >Manage Login and Password</a></li></ul>');
