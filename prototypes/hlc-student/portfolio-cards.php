            ...
            <div class="tab-content">
                <div class="tab-pane fade" id="tab-1">
                    <div class="row">
                        ...
                        <div class="col-md-3" data-equalize="layout-columns">
                ...
                <div class="form-group">
                    ...
                    <ul class="control-attachments control-attachments">
                        <li>
                            ...
                            <a href="#" class="manage-author"><span class="control-attachment-link no-icon">Joe Smith</span></a>
                        </li>
                        <li>
                            <button class="btn btn-xs btn-danger control-attachment-remove"><i class="fa fa-times"></i></button>
                            <a href="#" class="manage-author"><span class="control-attachment-link no-icon"></i>Jane Doe</span></a>
                        </li>
                    </ul>
                    <div class="control-add-new">
                        <a href="#" class="add-author">Add Author</a>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
<!-- Modal -->
<div id="modal-author-add" class="modal fade layout-wizard" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label class="control-label">Select Document(s) <small><a href="#">Upload New Document</a></small></label>
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-success close-add-modal">Save and Close</a> <a class="btn btn-success refresh-add-modal" href="#">Save and Add Another</a>  <a href="#" class="btn btn-default close-add-modal">Cancel</a>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal -->
<div id="modal-author-manage" class="modal fade layout-wizard" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title">Manage Author</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="control-label">Rank</label>
                ...
                <div class="form-group">
                    <label class="control-label">Organization</label>
                    <input type="text" class="form-control" value="Americal Medical Authors">
                </div>
                <div class="form-group">
                    <label class="control-label">Select Document(s) <small><a href="#">Upload New Document</a></small></label>
                    <select class="form-control" multiple="multiple" size="3">
                        <option>Document 1</option>
                        <option selected>Document 2</option>
                        <option>Document 3</option>
                        <option selected>Document 4</option>
                        <option>...</option>
                        <option>...</option>
                    </select>
                </div>
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-success close-manage-author">Save and Close</a>  <a href="#" class="btn btn-success close-manage-author">Cancel</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $( ".manage-author" ).click(function(e) {
        e.preventDefault();
        $('#modal-publications').modal('hide');
        var delay = setTimeout(function(){ $('#modal-author-manage').modal('show'); }, 400);
    });

    $( ".close-manage-author" ).click(function(e) {
        e.preventDefault();
        $('#modal-author-manage').modal('hide');
        var delay = setTimeout(function(){ $('#modal-publications').modal('show'); }, 400);
    });

    $( ".add-author" ).click(function(e) {
        e.preventDefault();
        $('#modal-publications').modal('hide');
        var delay = setTimeout(function(){ $('#modal-author-add').modal('show'); }, 400);
    });

    $( ".close-add-modal" ).click(function(e) {
        e.preventDefault();
        $('#modal-author-add').modal('hide');
        var delay = setTimeout(function(){ $('#modal-publications').modal('show'); }, 400);
    });


    $( ".refresh-add-modal" ).click(function(e) {
        e.preventDefault();
        $('#modal-author-add').modal('hide');
        var delay = setTimeout(function(){ $('#modal-author-add').modal('show'); }, 400);
    });
