              ...
              <div class="col-md-9">
                ...
                <section class="section section-main section-box" data-equalize="layout-columns">
                  <section class="section">
                    ...
                    <div class="slat-group alert alert-warning">
                      <div class="slat-group-header">
                        <div class="slat-group-header-title">

                          <h2>Certifications <i class="fa fa-check-circle done"></i> <a href="#" class="btn btn-warning btn-sm js-review-btn">Mark Section as Reviewed</a></h2>
                        </div>
...
?>
                  ...
                  <section class="section">
                    <div class="slat-group alert alert-warning">
                      <div class="slat-group-header ">
                        <h2>Education <i class="fa fa-check-circle done"></i><a href="#" class="btn btn-warning btn-sm js-review-btn">Mark Section as Reviewed</a> </h2>
                      </div>
                      <div class="slat-group-content">
                        <div class="slat">
                  ...
                  <section class="section">
                    <div class="slat-group alert alert-warning">
                      <div class="slat-group-header">
                        <div class="slat-group-header-title">
                          <h2>Licenses <i class="fa fa-check-circle done"></i><a href="#" class="btn btn-warning btn-sm js-review-btn">Mark Section as Reviewed</a></h2>
                        </div>
                        <div class="slat-group-header-actions">
              ...
              <?= createSiteScripts(); ?>
                <script>
                  $(".js-review-btn").click(function(e) {
                    ...
                    $(this).hide();
                    $(this).parents(".slat-group h2").find(".done").show();
                ...
                <?= createSiteEnd(); ?>
                  ...
                  <style>
                    .section-main .alert.slat-group-header {
                      padding: 5px;
                    }
