...
$patterns['header'] = array(
    ...
    'mainNav' => '
        <li class="{active=dashboard}"><a href="/dashboard-manager.php">Dashboard</a></li>
                     ...
                     <div class="col-md-4">
                         <div class="panel panel-default panel-employee">
                             <section class="return-link">
                                <a href="dashboard-manager.php"><i class="fa fa-fw fa-chevron-left"></i>Return to Dashboard</a>
                             ...
                             <div class="panel-body text-center">
                                 ...
                                 <div class="text-center"><a href="#" class="btn btn-blue">Send message</a>
                                 </div>
                             </div>
                         </div>
                             ...
                             <div class="panel-body">
                                 <div class="media">
                                     ...
                                     <div class="media-body pt-sm">
                                         <div class="pull-right"> <a href="dashboard-profile.php" type="button" class="btn btn-info btn-xs" >View</a>
                                         </div>
