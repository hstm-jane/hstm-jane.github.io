...
<head>
   ...
   .slat-icon-peer-assessment .md-btn {
            ...
            <div class="row">
                <div class="col-md-9">
                    <section class="section section-main section-box" data-equalize="layout-columns">
                        <div class="filter-dropdown"> <b style="font-weight:600">Show My:</b>
                        ...
                        <section class="section" id="tasks">
                            ...
                            <div class="slat slat-attention slat-spaced slat-callout slat-assessment slat2" data-filter-category="5">
                            ...
                            <div class="slat-icon-label">Schedule</span>
                                   ...
                                   <button md-ink-ripple="" class="md-btn green"> <i class="hs-i-calendar new-slat-icon"></i>
                                        <div class="btn-container">
                                            <div class="tn-placed"></div>
                                        </div>
                                    </button>
