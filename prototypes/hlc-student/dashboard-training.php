                ...
                <div class="row">
                    <div class="portlets-wrapper">
                        ...
                        <div id="panelPortlet2" class="panel panel-default"  style="padding-bottom:10px;">
                                             ...
                                             <div class="panel-body">
                                                <div class="media">
                                                   ...
                                                   <div class="media-body pt-sm ">
                                                      <div class="pull-right " style="margin-top:15px;">
                                                         <a href="dashboard-manager-person.php" type="button" class="btn btn-info btn-xs">View</a>
                                                      </div>
                                                      <div class="">Bruno, Brad
                                                         <div class="text-sm text-muted">17 Tasks</div>
                                                         <div class="text-sm text-warning">3 Past Due</div>
                                                      </div>
                                                   </div>
                                                </div>
                                               <div class="media">
                                                  ...
                                                  <div class="media-body pt-sm ">
                                                     ...
                                                     <div class="">Chambers, Marie
                                                        <div class="text-sm text-muted">3 Tasks</div>
                                               ...
                                               <div class="media">
                                                  ...
                                                  <div class="media-body pt-sm ">
                                                     ...
                                                     <div class="">Conner, Rosalyn
                                                        <div class="text-sm text-muted">9 Tasks</div>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="media">
                                                  ...
                                                  <div class="media-body pt-sm ">
                                                     ...
                                                     <div class="">Flangan, Simon
                                                        <div class="text-sm text-muted">1 Task</div>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="media">
                                                  ...
                                                  <div class="media-body pt-sm ">
                                                     ...
                                                     <div class="">Franks, Iva
                                                        <div class="text-sm text-muted">0 Tasks</div>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="media">
                                                  ...
                                                  <div class="media-body pt-sm ">
                                                     ...
                                                     <div class="">Juniper, Stephanie
                                                        <div class="text-sm text-muted">8 Tasks</div>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="media">
                                                  ...
                                                  <div class="media-body pt-sm ">
                                                     ...
                                                     <div class="">Lewis, Audrey
                                                        <div class="text-sm text-muted">5 Tasks</div>
                                                        <div class="text-sm text-warning">1 Past Due</div>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="media">
                                                  ...
                                                  <div class="media-body pt-sm ">
                                                     ...
                                                     <div class="">Montoya, Alice
                                                        <div class="text-sm text-muted">2 Tasks</div>
                                                     </div>
                                                  </div>
                                               </div>
                                               <div class="media">
                                             ...
                                             <div class="panel-body"><a href="dashboard-manager-team-chart.php" class="btn btn-success btn-xs" style="margin-left:35%;">View chart</a>
                                             </div>
                                          </div>
                                                  ...
                                                  <div class="col-lg-4 col-sm-6">
                                                     ...
                                                     <div class="panel widget bg-purple" style="height:75px;padding-bottom:85px;" >
                                                        <div class="row row-table">
                                                           ...
                                                           <div class="col-xs-12 pv-lg text-center" >
                                                              <!-- -->
                                                              <div class="text-uppercase" style="margin-bottom:5px;">Flight Risk</div>
                                          ...
                                          <div class="col-lg-4 col-sm-6">
                                             ...
                                             <div class="panel widget bg-green" style="height:75px;padding-bottom:85px;"">
                                                <div class="row row-table">
                                                   ...
                                                   <div class="col-xs-12 pv-lg text-center">
                                                      <!-- -->
                                                      <div class="text-uppercase">Attrition</div>
...
<div class="list-group">
        ...
        <script src="/dashboard-assets/Flot/jquery.flot.js"></script>
        <script src="/dashboard-assets/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
        <script src="/dashboard-assets/Flot/jquery.flot.resize.js"></script>
        <script src="/dashboard-assets/Flot/jquery.flot.pie.js"></script>
        <script src="/dashboard-assets/Flot/jquery.flot.time.js"></script>
        <script src="/dashboard-assets/Flot/jquery.flot.categories.js"></script>
        <script src="/dashboard-assets/flot-spline/js/jquery.flot.spline.min.js"></script>
        <script src="/scripts/dashboard-training-flot.js"></script>
