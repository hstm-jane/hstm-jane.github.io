...
<body class="">
    <!-- /site-header -->
    <div id="people"></div>
    <input id="insertNodesWithNewData" type="button" value="insert nodes with new json data object" />
    <input id="insertNodesWithEvent" type="button" value="insert 10 nodes with insertnode event" />
    <!-- PROTOTYPE ONLY -->
    ...
    document.getElementById("insertNodesWithEvent").addEventListener("click", function() {
        var newNodeData = { name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "10", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" };
        var i = 0;
        while (i < 10) {
            orgChart.insertNode(3, newNodeData);
            i = i + 1;
        }
        orgChart.expand(orgChart.nodes["3"]);
    ...
    document.getElementById("insertNodesWithNewData").addEventListener("click", function() {
        ...
        var data = [
            ...
            { id: 49, parentId: 1, name: "Riley Bray", title: "Nurse - Staff (RN)", tasks: "3", image: "/content/images/prototype-actors/rhein_wein.jpg", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 50, parentId: 1, name: "Callum Whitehouse", title: "Nurse - Staff (RN)", tasks: "3", image: "/content/images/prototype-actors/uxceo.jpg", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 53, parentId: 3, name: "Evie Johnson", title: "Nurse - Staff (RN)", tasks: "3", image: "/content/images/prototype-actors/brynn.jpg", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 54, parentId: 13, name: "Paul Shetler", title: "Nurse - Staff (RN)", tasks: "3", image: "/content/images/prototype-actors/himanshuchanda.jpg", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 55, parentId: 13, name: "Rebecca Francis", title: "Nurse - Staff (RN)", tasks: "3", image: "/content/images/prototype-actors/himanshuchanda.jpg", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 56, parentId: 13, name: "Jon Sims", title: "Medical Assistant", tasks: "5", pastdue: "1", image: "/content/images/prototype-actors/63.jpg", secondParenId: 1, CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 57, parentId: 13, name: "Amber McKenzie", title: "Nurse - Staff (RN)", tasks: "4", image: "/content/images/prototype-actors/8.jpg", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            ...
            { id: 71, parentId: 47, name: "Rebecca Francis", title: "Nurse - Staff (RN)", tasks: "3", image: "/content/images/prototype-actors/himanshuchanda.jpg", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 72, parentId: 47, name: "Jon Sims", title: "Medical Assistant", tasks: "5", pastdue: "1", image: "/content/images/prototype-actors/63.jpg", secondParenId: 1, CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 73, parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 74, parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 75, parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 76,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 77,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 78,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 79,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 80,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 81,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 82,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 83,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
            { id: 84,parentId: 3, name: "New Node Inserted with InsertNode Event", title: " Inserted with InsertNode Event", tasks: "0", image: "/content/images/avatar-default.png", CustomHtml: "<button class='btn btn-default'>View Profile</button>" },
        ];
        ...
        // orgChart.highlightNode("3"); //Highlight and Expand Michele Brown
    });
    ...
    function renderNodeHandler(sender, args) {
        for (var i = 0; i < args.content.length; i++) {
            ...
            if (args.node.data['CustomHtml'] !== undefined) {
                args.content[i] = args.content[i].replace("[CustomHtml]", "<foreignObject x='210' y='143' width='130' height='35'><a href='dashboard-profile-dev-ready.php'>" + args.node.data["CustomHtml"] + "</a></foreignObject>");
            }
