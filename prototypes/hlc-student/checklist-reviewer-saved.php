...
<?php
    ...
    $taskDetailsLocked = '
                        <div class="checklist-task-details">
                            <div class="checklist-methods">
                                <h5>Verification Method</h5>
                                <ul class="list-unstyled">
                                <li class="checkbox">
                                    <label><input type="checkbox" value="1" checked disabled > Demonstration/Direct Observation/Documentation Audit</label>
                                </li>
                                <li class="checkbox">
                                    <label><input type="checkbox" value="2" disabled> Review of Written or Visual Materials/Policy/Procedure Review</label>
                                </li>
                                <li class="checkbox">
                                    <label><input type="checkbox" value="3" disabled> Knowledge Assessment Test</label>
                                </li>
                                <li class="checkbox">
                                    <label><input type="checkbox" value="4" checked disabled> Verbalization</label>
                                </li>
                                <li class="checkbox">
                                    <label><input type="checkbox" value="5" disabled> Other</label>
                                </li>
                                </ul>
                            </div>
                            <div class="checklist-comments">
                                <h5>Comment</h5>
                                <p>This is a previously saved comment and this item is locked.
                                </p>
                                <div class="form-modified">Reviewed: Sep 20, 2013 at 3:27pm by sjuniper
                                </div>
                            </div>
                        </div>'
?>
            ...
            <div class="col-md-9">
                <section class="section section-main section-box" data-equalize="layout-columns">
                    <section class="section">
                        ...
                        <div class="checklist-item checklist-item-review checklist-item-locked">
                            ...
                            <div class="checklist-row">
                                ...
                                <div class="checklist-col checklist-actions checklist-actions-3btn">
                                    <button class="btn btn-sm btn-success checklist-btn-pass selected">Met</button>
                                    <button class="btn btn-sm btn-default checklist-btn-fail disabled">Unmet</button>
                                    <button class="btn btn-sm btn-default checklist-btn-skip disabled">N/A</button>
                                </div>
                            </div>
                        </div>
                        <div class="checklist-item checklist-item-review checklist-item-locked">
                            ...
                            <div class="checklist-row">
                                ...
                                <div class="checklist-col checklist-actions checklist-actions-3btn">
                                    <button class="btn btn-sm btn-default checklist-btn-pass disabled">Met</button>
                                    <button class="btn btn-sm btn-danger checklist-btn-fail selected">Unmet</button>
                                    <button class="btn btn-sm btn-default checklist-btn-skip disabled">N/A</button>
                                </div>
                            </div>
                        </div>

                        <div class="checklist-item checklist-item-review  checklist-item-selected ">
                            ...
                            <div class="checklist-row">
                                    ...
                                    <div class="checklist-task-details">
                                        <div class="checklist-methods">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="checkbox">
                                                    <label><input type="checkbox" value="3"> Knowledge Assessment Test</label>
                                                </li>
                                                <li class="checkbox">
                                                    <label><input type="checkbox" value="4"> Verbalization</label>
                                                </li>
                                                <li class="checkbox">
                                        ...
                                        <div class="checklist-comments">
                                            <div class="collapse-group in">
                                                <h5>Comment</h5>
                                                <textarea class="form-control">This is a previously saved comment by the current user and is editable.</textarea>
                                            </div>
                                            <a href="#" class="collapse-toggle" data-toggle-text="Add Comment|Remove Comment">Remove Comment</a>
                                        </div>
                                    </div>
                                ...
                                <div class="checklist-col checklist-actions checklist-actions-3btn">
                                    ...
                                    <button class="btn btn-sm btn-skip checklist-btn-skip selected">N/A</button>
                                </div>
                            </div>
                        </div>
                            ...
                            'sets' => array(
                                ...
                                array(
                                    ...
                                    'html' => '
                                        ...
                                        <a href="#" class="btn btn-success js-checklist-all-success">Mark All Yes</a>
