...
<style>
.mb-cell {
    background: rgba(54,175,215,.07) !important;
    border: 1px solid rgba(54,175,215,.12) !important;
}
.additional-ratings {
...
<div class="action-meta">
          ...
          <h2 style="font-weight:400;">Relationship Based Care 
                <!--<span class="assessment-subtitle">
                   For Assessment: Initial Nursing Competency Appraisal
                </span>-->
          </h2>
          <!--Meta Boxes-->
    <div class="meta-box" style="margin-top:-10px;">
        <div class="mb-table">
            <div class="mb-row">
                  <div class="mb-cell equalized" style="width:30%;">
                    <span class="meta-box-label">Assessment</span> 
                    <span class="meta-box-value">Initial Nursing Competency Appraisal</span>
                </div>
                ...
                <div class="mb-cell equalized" style="width:10%;">
                    
                    <span class="meta-box-label">Statement&nbsp;Status</span> 
                    <!--<div class="col-md-4" style="padding:0">-->
                    <span class="meta-box-value">Rated <i class="fa fa-check" style="color:#5cb85c;font-size:18px;"></i></span> 
                    <!--</div>
                     <div class="col-md-8" style="padding:0;text-align:right;">
                    <span class="meta-box-value"><a href="#" style="font-size:18px;"><i class="fa fa-fw fa-chevron-left"></i></a> 4 of 7 <a href="#" style="font-size:18px;"><i class="fa fa-fw fa-chevron-right"></i></a></span> -->
                    <!--</div>-->
                </div>
