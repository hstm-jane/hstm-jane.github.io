                ...
                <div class="tab-content">
                    <div class="collapse in active" id="step1">
                        ...
                        $stickybar = array(
                            'sets' => array(
                                array(
                                    'html' => '
                                        <a href="assessment-overview-dynamic-summit.php" class="btn btn-default">Cancel</a>
                                    ',
                                ),
                            ),
                        );
                    ...
                    <div class="collapse" id="step2-statements">
                        ...
                        <section class="section section-footer statements-selected-footer collpase">
                            <a href="assessment-search-statements-summit.php?assessment=<?= $assessmentID ?>" class="btn btn-default">Select Statements</a>
                        </section>
                    ...
                    <div class="collapse" id="step2-jobdescriptions">
                        ...
                        <section class="section jobdescriptions-not-selected collpase">
                            <h3>Job Descriptions <small>Choose the items(s) to share</small></h3>
                            <div class="slat">
                                <div class="slat-message">
