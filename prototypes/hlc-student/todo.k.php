...
.hs-i-calendar {
    ...
    */
    ...
    .slat-course {
        border-left: 5px solid #008bad !important;
    }
    ...
    .slat-icon-schedule .md-btn {
        background-color: #efaa06;
    }
    
    .slat-schedule {
        border-left: 5px solid #efaa06 !important;
    }
    ...
    .slat-profile-activity {
        border-left: 5px solid #C2185B !important;
    }
    ...
    .slat-attention {
        border-left-color: rgba(252, 123, 0, 0.55) !important
    }
                ...
                <div class="col-md-9">
                    <section class="section section-main section-box" data-equalize="layout-columns">
                        ...
                        <section class="section" id="tasks">
                            <!-- <h2 class="hdr-1" style="display:inline-block; margin-top:5px; font-size:18px;  ">Next 7 days</h2> -->
                            <h3 class="" style="display:block;margin-top:5px; font-size:18px;  ">Urgent Attention Needed</h3>
                            ...
                            <h3 class="hdr-2" style="display:inline-block; margin-top:10px; font-size:18px;  ">Today</h3>
                            <div class="slat slat-spaced slat-callout slat-course" data-filter-category="1" style="margin-top:-5px">
                                <div class="slat-cell-icon slat-icon-course  hidden-xs">
                                    <button md-ink-ripple="" class="md-btn green"> <i class="hs-icons-course new-slat-icon"></i>
                                        <div class="btn-container">
                                            <div class="tn-placed"></div>
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            <span class="meta-label">Due: </span>
                                            <span class="meta-value">
                                                <span class="meta-callout-label">Due:</span><?= date('M j, Y') ?></span>
                                        </li>
                                    </ul>
                                    <div class="action">
                                        <a class="btn btn-sm btn-default" href="course-institution-specific.php"> <i class="fa fa-fw fa-play  hidden-xs" style="color:#777; padding-right:15px;"></i>Start<i class="fa fa-fw fa-play visible-xs" style="color:#777;"></i></a>
                            ...
                            <h3 class="hdr-2" style="display:inline-block; margin-top:10px; font-size:18px;  ">This Week</h3>

                            <div class="slat slat-spaced slat-callout slat-virtual-class" data-filter-category="2"  style="margin-top:-5px">
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            ...
                                            <span class="meta-value">
                                               <span class="meta-callout-label">Starts:</span><?= date('M j, Y',strtotime('+3days')) ?>
                                    ...
                                    <div class="slat-default">
                                        ...
                                        <ul class="meta">
                                            ...
                                            <li class="meta-callout">
                                                <span class="meta-label">Due: </span>
                                                <span class="meta-value">
                                                   <span class="meta-callout-label">Due:</span><?= date('M j, Y',strtotime('+3days')) ?></span>
                                            </li>
                                        </ul>
                                        <div class="action">
                            ...
                            <h3 class="hdr-2" style="display:inline-block; margin-top:10px; font-size:18px;  ">This Month</h3>

                            <div class="slat slat-spaced slat-callout slat-peer-assessment" data-filter-category="5"  style="margin-top:-5px">
                                <div class="slat-cell-icon slat-icon-assessment hidden-xs ">
                                    <button md-ink-ripple="" class="md-btn green"> <i class="hs-icons-assessment new-slat-icon"></i>
                                        <div class="btn-container">
                                            <div class="tn-placed"></div>
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            <span class="meta-label">Due:</span>
                                            <span class="meta-value">
                                               <span class="meta-callout-label">Due:</span><?= date('M j, Y',strtotime('+15days')) ?></span>
                                        </li>
                                    </ul>
                                    <div class="action">
                                        <a class="btn btn-sm btn-default" href="course-institution-specific.php"> <i class="fa fa-fw fa-play hidden-xs " style="color:#777; padding-right:15px;"></i>Start<i class="fa fa-fw fa-play visible-xs" style="color:#777;"></i></a>
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            <span class="meta-label">Due: </span>
                                            <span class="meta-value">
                                                <span class="meta-callout-label">Due:</span><?= date('M j, Y',strtotime('+16days')) ?></span>
                                        </li>
                                    </ul>
                                    <div class="action">
                                        <a class="btn btn-sm btn-default" href="course-institution-specific.php"> <i class="fa fa-fw fa-play hidden-xs " style="color:#777; padding-right:15px;"></i>Start<i class="fa fa-fw fa-play visible-xs" style="color:#777;"></i></a>
                            ...
                            <h3 class="hdr-2" style="display:inline-block; margin-top:10px; font-size:18px;  ">Next Month</h3>
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            <span class="meta-label">Due: </span>
                                            <span class="meta-value">
                                               <span class="meta-callout-label">Due:</span><?= date('M j, Y',strtotime('+29days')) ?></span>
                                        </li>
                                    </ul>
                                    <div class="action">
                                        <a class="btn btn-sm btn-default" href="course-institution-specific.php"> <i class="fa fa-fw fa-play hidden-xs " style="color:#777; padding-right:15px;"></i>Resume<i class="fa fa-fw fa-play visible-xs" style="color:#777;"></i></a>
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            <span class="meta-label">Due:</span>
                                            <span class="meta-value">
                                              <span class="meta-callout-label">Due:</span><?= date('M j, Y',strtotime('+35days')) ?></span>
                                        </li>
                                    </ul>
                                    <div class="action">
                                        <a class="btn btn-sm btn-default" href="course-institution-specific.php"> <i class="fa fa-fw fa-play hidden-xs " style="color:#777; padding-right:15px;"></i>Start<i class="fa fa-fw fa-play visible-xs" style="color:#777;"></i></a>
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            <span class="meta-label">Starts: </span>
                                            <span class="meta-value">
                                                <span class="meta-callout-label">Starts:</span><?= date('M j, Y',strtotime('+36days')) ?>
                                ...
                                <div class="slat-default">
                                    ...
                                    <ul class="meta">
                                        ...
                                        <li class="meta-callout">
                                            <span class="meta-label">Due: </span>
                                            <span class="meta-value">
                                                <span class="meta-callout-label">Due:</span><?= date('M j, Y',strtotime('+40days')) ?></span>
                                        </li>
                                    </ul>
                                    <div class="action">
                                        <a class="btn btn-sm btn-default" href="course-institution-specific.php"> <i class="fa fa-fw fa-play hidden-xs " style="color:#777; padding-right:15px;"></i>Resume<i class="fa fa-fw fa-play visible-xs" style="color:#777;"></i></a>
                            ...
                            <h3 class="hdr-2" style="display:inline-block; margin-top:10px; font-size:18px;  ">Due Soon</h3>

                            <div class="slat slat-spaced slat-callout slat-curriculum" data-filter-category="1" style="margin-top:-5px">
                                <div class="slat-icon-nested">
                                    <div class="slat-cell-icon slat-icon-curriculum hidden-xs ">
                                    ...
                                    <div class="slat-default">
                                        ...
                                        <ul class="meta">
                                            ...
                                            <li class="meta-callout">
                                                <span class="meta-label">Due: </span>
                                                <span class="meta-value">
                                                   <span class="meta-callout-label">Due:</span><?= date('M j, Y',strtotime('+55days')) ?></span>
                                            </li>
                                        </ul>
                                        <div class="action">
                                            <a class="btn btn-sm btn-default" href="course-institution-specific.php"> <i class="fa fa-fw fa-play hidden-xs " style="color:#777; padding-right:15px;"></i>Resume<i class="fa fa-fw fa-play visible-xs" style="color:#777;"></i></a>
