       ...
       <!--  <div class="focus focus-pageheader">
        ...
        <div class="layout ">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <section class="section section-box section-main " style="padding:0px 10px 0px 10px;">
                          <a href="hstream.educate.monitor.php?org=<?= $org ?>" class="padbtn"></a>
                           <?php
                             if ($org == '3') {
                                 echo ' <a href="hstream.educate.monitor.3.php?org='. $org .'"><img src="/content/images/PAD-2-Mainline-size1.png" nopin="nopin"/></a>';
                             }
                            else if ($org == '2') {
                                echo ' <a href="hstream.educate.monitor.3.php?org='. $org .'"><img src="/content/images/PAD-2-Ascension-size1.png" nopin="nopin"/></a>';
                            }
                            else if ($org == '1') {
                             echo ' <a href="hstream.educate.monitor.3.php?org='. $org .'"><img src="/content/images/PAD-2-CHS-size1.png" nopin="nopin"/></a>';
                            }
                            else {
                              echo ' <a href="hstream.educate.monitor.3.php?org='. $org .'"><img src="/content/images/PAD-2-HCA-size1.png" nopin="nopin"/></a>';
                            }
                            ?>
