                    ...
                    <div class="app-drawer-content-panel">
                        <ul class="app-drawer-nav-item">
                           <!--  <li class="app-drawer-nav-item">
                            ...
                            <li class="app-drawer-nav-item ">
                                <a   href="hstream-workflow.todo.php?persona=<?= $persona ?> ">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                            ...
                            <?php } ?>
                            <?php if (($currentpage != 'hstream-workflow.alert.php') && ($persona == '5' || $persona == '6' || $persona == '7' ||$persona =='9')) { ?>
                            <li class="app-drawer-nav-item ">
                                <a   href="hstream-workflow.alert.php?persona=<?= $persona ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                                            <img src="content/images/hstream-alert-logo-100.png " style="width:48px;height:48px;  "  alt="hStream Alert "> alt="hStream Alert ">
                                        </div>
                                    </div>
                                    <div class="app-drawer-nav-item-content ">
                                        <h5 class="title ">hStream Alert</h5>
                                        <p class="description ">Track your employee's credentialing and licensing status.</p>
                                    </div>
                                </a>
                            </li>
                            <?php } ?>
