                    ...
                    <div class="show-hidden-items">
                        <div class="checkbox c-checkbox">
                            <label class="text-muted">
                                <input type="checkbox" class="show-hidden-licenses" />
                ...
                <table class="table  table-striped license-table dataTable" id="licenseTable">
                    ...
                    <tbody>
                        ...
                        <tr data-id="3" class="hidden">
                            ...
                            <td><a href="dashboard-profile-dev-ready.php#professional">Flangan, Sarah H.</a>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/men/23.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/women/27.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/women/30.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
