...
?>
    ...
    <div id="modal-assessment-by-employee" class="modal modal-xl fade modal-assessment-by-employee" tabindex="-1">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-assessment modal-assessment-data <?= $assessment['class'] ?>
                        ...
                        <div class="assessment__summary">
                            ...
                            <div class="assessment__employee" style="display:none;">
                                <?= $assessment['employee'] ?>
                            </div>
                          ...
                          <div class="assessment__actions-lg" >
