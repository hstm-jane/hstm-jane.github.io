...
?>
    ...
    <div id="modal-assessment-by-state" class="modal modal-xl fade modal-assessment-by-state" tabindex="-1">
                ...
                <div class="modal-body">
                    <div class="assessment assessment--header">
                        <div class="assessment__summary">
                            <div class="assessment__basics">Assessment</div>
                            <div class="assessment__employee">Employee</div>
                    ...
                    <div class="modal-assessment modal-assessment-data <?= $assessment['class'] ?>
                                <?php if ($assessment['actionable'] == true) { ?>
                                    assessment-flag 
                                <?php } ?>" data-state="<?= $assessment['data-state'] ?>" data-action-state="<?= $assessment['data-action-state'] ?>" data-titleid="<?= $assessment['title-id'] ?>" data-empid="<?= $assessment['empid'] ?>" data-actionable="<?= $assessment['actionable'] ?>" data-employee-progress="<?= $assessment['data-employee-progress'] ?>">
                        <div class="assessment__summary">
                            ...
                            <div class="assessment__state" style="display:none;" data-state="<?= $assessment['data-state'] ?>" data-action-state="<?= $assessment['data-action-state'] ?>">
                                <?= $assessment['state'] ?>
