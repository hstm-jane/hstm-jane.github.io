<div id="modal-dashboard-knowledgeq" class="modal fade modal-xl modal-dashboard-knowledgeq dashboard-modal-table">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title">28 Employees Assigned KnowledgeQ Course </h4>
            </div>
            <div class="modal-body">
                <div class="modal-header-left pull-left">
                    <div class="knowledgeqHeader text-muted"></div>
                   
                </div>
                <table class="table table-striped knowledgeq-table dataTable " id="knowledgeqTable">
                    <thead>
                        <tr>
