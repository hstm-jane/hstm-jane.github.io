<div id="modal-dashboard-cards" class="modal fade modal-xl modal-dashboard-cards dashboard-modal-table">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title">19 Employees with 22 Outstanding Resuscitation Credentials </h4>
            </div>
            <div class="modal-body">
                <div class="modal-header-left pull-left">
                    <div class="outstandingCardsHeader text-muted"></div>
                    <div class="show-hidden-items">
                        <div class="checkbox c-checkbox">
                            <label class="text-muted">
                                <input type="checkbox" class="show-hidden-cards" />
                                <span class="fa fa-check"></span>Show hidden items
                            </label>
                        </div>
                    </div>
                </div>
                <table class="table  table-striped cards-table dataTable" id="cardsTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr data-id="3">
                            <td><img src="/content/images/prototype-actors/himanshuchanda.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                            <td><a href="dashboard-profile-dev-ready.php#professional">Flangan, Simon P.</a><div class="text-muted text-sm">Diabetes Educator (RN)</div></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/men/8.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/women/47.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/men/40.jpg"" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/men/22.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/women/26.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/women/14.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/men/49.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/men/84.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/women/11.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
                        ...
                        <tr data-id="6">
                            <td><img src="https://randomuser.me/api/portraits/women/73.jpg" alt="Image" class="media-box-object img-circle thumb38 img-thumbnail tn-sm"></td>
