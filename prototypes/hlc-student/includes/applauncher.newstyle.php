            ...
            <div class="app-drawer-content-panel">
                <ul class="app-drawer-nav-item">
                    <li class="app-drawer-nav-item">
                        <a href="hstream-validate.php" target="_blank">
                    ...
                    <li class="app-drawer-nav-item">
                        <a href="hstream-monitor.php" target="_blank">
                            <div class="app-drawer-nav-item-logo">
                                <div class="svg-icon-wrap">
                   ...
                   <!-- <li class="app-drawer-nav-item">
                       <a target="_blank" href="hstream.echo.php">
                           <div class="app-drawer-nav-item-logo">
                               ...
                               <h5 class="title">Credentialing</h5>
                    ...
                    <li class="app-drawer-nav-item">
                        <a target="_blank" href="#">
                            <div class="app-drawer-nav-item-logo">
                                <div class="svg-icon-wrap" >
                                    <img src="content/images/ampt-logo.png" alt="AMPT" title="AMPT">
                                </div>

                            </div>
                                <h5 class="title">AMPT</h5>
                  ...
                  <!--   <li class="app-drawer-nav-item">
                        <a target="_blank" href="/hstream.educate.php">
                            <div class="app-drawer-nav-item-logo">
                                <div class="svg-icon-wrap" >
                                    <img src="content/images/hstream-educate-logo-100.png"   alt="hStream Educate">
                                </div>

                            </div>
                                <h5 class="title">Educate</h5>
