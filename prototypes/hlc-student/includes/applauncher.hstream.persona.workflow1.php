                ...
                <li>
                    ...
                    <div class="app-drawer-content-panel">
                        <ul class="app-drawer-nav-item">
                            ...
                            <?php if (($currentpage != 'hstream-workflow.verity.php') && ($persona == '4')) { ?>
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.verity.php?persona=<?= $persona ?>&workflow=<?= $workflow ?>">
                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap ">
                                           <img src="content/images/verity-logo.png " alt="Verity " >
                                        </div>
                                    </div>
                                    <div class="app-drawer-nav-item-content ">
                            ...
                            <li class="app-drawer-nav-item ">
                                <a href="hstream-workflow.alert.echo.php?persona=<?= $persona ?>&workflow=<?= $workflow ?>">

                                    <div class="app-drawer-nav-item-logo ">
                                        <div class="svg-icon-wrap " style=" ">
                                            <img src="content/images/hstream-alert-logo-100.png " style="width:48px;height:48px;  " alt="hStream Validate ">
                                        </div>
                                    </div>
                                    <div class="app-drawer-nav-item-content ">
                                        <h5 class="title ">hStream Validate</h5>
                                        <p class="description ">(CMO/CHRO Only) View employee alerts.</p>
                                    </div>
                                </a>
                            </li>
                            <?php } ?>
                            ...
                            <li class="app-drawer-nav-item ">
                                ...
                                <a href="hstream-workflow.hlcprofile.php?persona=<?= $persona ?>&workflow=<?= $workflow ?>" target="_blank">
                                    ...
                                    <div class="app-drawer-nav-item-content ">
                                        <h5 class="title ">hStream Monitor</h5>
