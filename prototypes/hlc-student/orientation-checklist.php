...
$patterns['focus']['supporting'] = '
    <figure class="fph-chart-holder">
        <canvas class="fph-chart" data-type="Doughnut" data-segments="[[4,0],[5,0],[6,0],[6,0],[9,0],[3,0],[2,0],[2,0],[6,0],[8,0],[5,0],[7,0],[7,0],[4,0],[4,0],[6,0],[7,0],[11,0],[2,0]]" width="108" height="108"></canvas>
...
@media screen and (max-width: 767px) { /* Set for print width more than anything else */
    .orientation-checklist .boxes {
        padding-bottom: 10px;
        margin-bottom: 10px;
    }
            ...
            <section class="section assessment-group">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">1.</div> <div class="td">Uses evidence-based processes to collect data for assessing the educational needs of perioperative personnel.</div>
                    </div>
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">2.</div> <div class="td">Involves internal and external stakeholders, as applicable, in data collection.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">3.</div> <div class="td">Determines priorities for educational activities based on the needs of perioperative services, the organization, and perioperative patients.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                    ...
                    <div class="box-heading mobile-only">Not Met (Explain Why)</div>
                    <div class="box box3">
                        <textarea class="form-control" rows="2" placeholder="Explain why not met..."></textarea>
                    </div>
                </div>
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">4.</div> <div class="td">Considers a variety of evidence-based strategies to meet the cognitive, psychomotor, and affective domains of learners.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
            ...
            <section class="section assessment-group">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">1.</div> <div class="td">Synthesizes collected data to identify issues and variances relative to perioperative education.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">2.</div> <div class="td">Reports issues and variances to internal and external stakeholders as applicable.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">3.</div> <div class="td">Identifies the effect of individual learning styles and interpersonal interactions on learner outcomes.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">4.</div> <div class="td">Identifies educational resources and teaching modalities that will meet the needs of learners.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">5.</div> <div class="td">Recognizes multicultural, generational, and experiential effects on learning.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
            ...
            <section class="section assessment-group">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">1.</div> <div class="td">Develops outcomes for perioperative education using assessment findings and analysis.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">2.</div> <div class="td">Supports perioperative personnel and other health care personnel to achieve quality patient care outcomes.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">3.</div> <div class="td">Advises and counsels perioperative personnel to achieve professional goals.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">4.</div> <div class="td">Promotes acquisition of effective educational resources and activities to support safe perioperative practice and worker safety.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">5.</div> <div class="td">Identifies a time frame in which to achieve the educational outcomes.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
                ...
                <div class="boxes">
                    ...
                    <div class="box box1">
                        ...
                        <div class="td">6.</div> <div class="td">Modifies outcomes based on issues and research.</div>
                    </div>
                    <div class="box-heading mobile-only">Verification Method</div>
                    <div class="box box2">
