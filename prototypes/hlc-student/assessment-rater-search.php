<?php
    ...
    $patterns['start']['title'] = 'Select Rater';
    $patterns['focus']['title'] = 'Select Rater';
                            ...
                            $stickybar = array(
                                'sets' => array(
                                    array(
                                        ...
                                        'html' => '<a href="assessment-manage-rater-peers.php?returnFromRaters'.$returnFromPeers.''.$single.'"  class="btn btn-success js-checkable-dependent">Add</a> <a href="' . $returnCancelUrl . '" class="btn btn-default">Cancel</a>',
                                    ),
                                    array(
                                        'position' => 'left',
                                        'classes' => array('visible-md','visible-lg'),
                                        'html' => '<a href="assessment-manage-rater-peers.php?returnFromRaters'.$returnFromPeers.''.$single.'" class="btn btn-success js-checkable-dependent">Add Selected</a> <a href="' . $returnCancelUrl . '" class="btn btn-default">Cancel</a>',
                                    ),
                                    array(
                                        'position' => 'right',
