...
$patterns['header'] = array(
    ...
    'mainNav' => '
        ...
        <li class="{active=catalog}"><a href="/catalog.php">Cwatalog</a></li>
                      ...
                      <section class="profile-return-link">
                         ...
                         <div class="panel panel-default panel-employee">
                             ...
                             <div class="panel-body text-center">
                                 <div class="pv-lg">
                                     <img src="/content/images/prototype-actors/brynn.jpg" alt="Contact" class="center-block img-responsive img-circle img-thumbnail thumb96">
                                     <!-- <div class="profile-initial-circle center-block">
                                        BB
                                      </div> -->
                                 </div>
                                 <h3 class="m0 text-bold">
                                     <span class="employee-name">Marie S. Chambers</span>
                                     <small>
                                         <span class="job-title">Nurse Manager - Acute Care</span>
                                                 ...
                                                 <div class="col-md-12">
                                                     ...
                                                     <form class="form-horizontal p-20">
                                                         <div class="form-group">
                                                             ...
                                                             <div class="col-sm-8">
                                                                 2717 Valley View Ln.<br>Nashville, TN 37217
                                                             </div>
                                                         </div>
                                                         <div class="form-group">
...
<script>
$(function(){
    $('.site-header').addClass('site-header-border-bottom');
});
</script>
