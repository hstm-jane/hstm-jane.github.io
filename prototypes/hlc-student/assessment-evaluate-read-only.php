...
<head>
    ...
    <title>Assessment Sign Off | HealthStream</title>

    <!-- Styles
    ================================================== -->
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1484068607">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1484068607">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1484068607">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1484068607">
...
<div class="fph-cell fph-cell-icon"><div class="fph-icon" style="overflow:hidden;"><img src="/content/images/avatar.jpg" width="100%" height="100%"></div><div class="fph-icon-label"><span>Self Assessment</span></div></div>
<div class="fph-cell fph-cell-text">
<div class="fph-primary">
<h1>Assessment Sign Off</h1> 
</div>
<div class="fph-secondary"><ul class="meta">
<li><span class="meta-label">For Assessment:</span><span class="meta-value">Nursing Fundamentals Appraisal</span></li>
</ul></div>
...
<div class="assessment-header">
    <div class="assessment-return">
        <a href="assessment-overview.php"><i class="fa fa-fw fa-chevron-left"></i>Return to To Do</a>
    </div>
</div>
...
<section class="section page-header">
   ...
   <!--Assessment Title and Subtitle-->
    <h2 >Nursing Fundamentals Appraisal
        <span class="assessment-subtitle">
    ...
    <div class="meta-box">
        <div class="mb-table">
            <div class="mb-row">
                 <div class="mb-cell" data-equalize="mb-cell">
                        <div style="float:left;margin-right:10px;">
                          <div class="fph-icon" style="overflow:hidden;"><img src="/content/images/avatar.jpg" width="100%" height="100%"></div>
                        </div>
                        <div>
                          <span class="meta-box-label">Employee</span>
                          <span class="meta-box-value">
<?php
if ($empId != 1) {
    echo '<span class="meta-box-value">Chamberland, Marie</span>'; } else { echo '<span class="meta-box-value">Juniper, Stephanie P.</span>'; } ?>
                          </span>
                        </div>
                      </div>
                      <div class="mb-cell" data-equalize="mb-cell">
                        <div style="float:left;margin-right:10px;">
                          <div class="fph-icon" style="overflow:hidden;">
                            <img src="/content/images/prototype-actors/allisongrayce.jpg" width="100%" height="100%">
                          </div>
                        </div>
                        <div>
                          <span class="meta-box-label">Rater</span>
                          <span class="meta-box-value">Crane, Darcy L.</span>
                        </div>
                      </div>
                <div class="mb-cell equalized">
                    <span class="meta-box-label">State</span> 
                    <span class="meta-box-value">Review</span> 
                </div>
                <div class="mb-cell equalized">
                    <span class="meta-box-label"> Due</span> 
                    <span class="meta-box-value">Feb 9, 2017</span>  
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="assessment-description">
        <h4>Description</h4>
        <p>This assessment is intended to measure the Frontline Nurse's critical thinking abilities, an essential component of a nurses' performance. This brief but critical assessment measures the primary core skills essential for critical thinking. The results will guide your individual development plan.</p>
    </div>
    <!--/Assessment Description-->
    ...
    <div class="assessment-instructions">
        ...
        <div id="assessment-instructions-body" class="collapse-group in">
            <div class="assessment-instructions__content">
                For this evaluation, please consider employee performance from March 1st, 2012 through February 28th, 2013.
                <br><br>
                <b>Employees:</b> If your manager requests a self-evaluation, please complete all sections of the self-assessment as soon as possible after receiving the assignment. You must select Submit after you have finalized your ratings.
                <Br><b>Peers:</b> If a manager requests you rate another employee, please complete the peer evaluation as soon as possible after receiving the assignment. You are not required to complete the entire assessment. Complete only the areas where you have experience with the employee.
                <Br><b>Manager:</b> Please complete all sections of your employee’s assessment and select Submit when you have finalized your ratings. Please assure the employee and peers (if applicable) have completed their ratings prior to submitting the assessment. After approval from your manager (if required), you may review the assessment with your employee. After the employee review, please sign off the assessment with the employee to complete your responsibilities. Note: For certain overall assessment ratings, you will be required to configure a Reflective Plan before sign off.
            </div>
        </div>
        <a href="#assessment-instructions-body"  class="assessment-instructions__toggle collapse-toggle" data-toggle-text="Show instructions|Hide instructions">Hide instructions</a>
    </div> 
    <!--/Assessment Instructions-->
...
<section class="section">
    ...
    <div class="statement" data-statementid="statement-1">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-1&user=employee&state=4&progress=6">Registered Nurse</a></div>
            <div class="description">The Registered Nurse provides professional nursing care to patients within an assigned department using the nursing process, functions as a liaison between patient and physician, and practices in the roles of care provider, educator, and member of the interdisciplinary team.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
    ...
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-1&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-1&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    <div class="actors">
        <div class="actor actor--rater actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6&actor=employee">More</a></div>
        </div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            ...
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
        </div>
    </div>
</div><div class="actor actor--peer actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-1&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
        </div>
    </div>
</div>
    ...
    <header class="section-header">
        <h2>Organizational Expectations</h2>
    </header>
    <div class="statement" data-statementid="statement-2">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-2&user=employee&state=4&progress=6">Mission Vision Value</a></div>
            <div class="description">Supports the mission, vision, and values of the organization.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-2&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-2&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-2&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
...
</div><div class="statement" data-statementid="statement-3">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-3&user=employee&state=4&progress=6">Service to Customers and Patients</a></div>
            <div class="description">Demonstrates service commitment to key constituents, patients, coworkers, and organization.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-3&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-3&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-3&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
...
</div><div class="statement" data-statementid="statement-4">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-4&user=employee&state=4&progress=6">Integrity</a></div>
            <div class="description">Acts with integrity.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-4&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-4&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-4&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
    ...
    <div class="statement" data-statementid="statement-5">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-5&user=employee&state=4&progress=6">Professional Development</a></div>
            <div class="description">Communicates effectively with others.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-5&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-5&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-5&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
...
</div><div class="statement" data-statementid="statement-6">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-6&user=employee&state=4&progress=6">Effective Communication</a></div>
            <div class="description">Communicates effectively with others.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-6&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-6&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-6&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
...
</div><div class="statement" data-statementid="statement-7">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-7&user=employee&state=4&progress=6">Patient Controlled Analgesia - PCA</a></div>
            <div class="description">Safely cares for patient receiving PCA.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-7&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-7&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-7&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
    ...
    <div class="statement" data-statementid="statement-8">
    <div class="summary">
        <div class="basics">
            <div class="title"><a href="/assessment-statement.php?assessment=performance-2&statement=statement-8&user=employee&state=4&progress=6">Participate in Department Engagement Team</a></div>
            <div class="description">Contribute to ES Department Engagement Team on inititatives to improve work environment and team collaboration.</div>
            <div class="rating"><label>My Rating:</label> Expert</div>
        </div>
        <div class="rating">
        ...
        <div class="action action-multi">
    <div class="btn-group">
        <a href="/assessment-statement.php?assessment=performance-2&statement=statement-8&user=employee&state=4&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
        <ul class="dropdown-menu dropdown-menu-right">
            <li><a href="/assessment-statement.php?assessment=performance-2&statement=statement-8&user=employee&state=4&progress=6">View Statement Details</a></li>
            <li><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6">View All Ratings</a></li>
        </ul>
    </div>
</div>
    </div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>rater</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--rater"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6&actor=rater">More</a></div>
        </div>
    </div>
</div><div class="actor actor--employee actor--rated">
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>employee</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--employee"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6&actor=employee">More</a></div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6&actor=peer-1">Andrzejewski, Alexa A.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6&actor=peer-2">Ng, Grace C.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option rating-selected"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
    ...
    <div class="actor__basics">
        <div class="actor__row">
            <div class="actor__role"><label>peer</label></div>
            <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=performance-2&statement=statement-8&user=rater&progress=6&actor=peer-3">Chanda, Himanshu Y.</a></div>
            <div class="actor__rating">
                <div class="rating-control rating-control--peer"><div class="rating-control-row"><div class="rating-control-cell rating-option-0"><span class="rating-option rating-option-na rating-selected"></span></div><div class="rating-control-cell rating-option-1"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-2"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-3"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-4"><span class="rating-option"></span></div><div class="rating-control-cell rating-option-5"><span class="rating-option"></span></div><div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div></div></div>
            </div>
            <div class="actor__summary"><span class="actor__summary-date">Jan 3, 2017:</span> I am new and cannot rate this person</div>
        ...
        <div class="stickybar-floater">
            <div class="stickybar-outer">
                <div class="stickybar-inner">
                    <div class="stickybar-left"><div class="hidden-xs hidden-sm">
                    ...
                    <div class="btn-group dropup">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-header">About Alice G. Montoya</li>
            ...
            <div class="modal-body">
                ...
                <div class="modal-focus modal-focus--icon modal-focus--meta">
                    <div class="modal-focus__icon">
                        <img src="/content/images/avatar.jpg" class="modal-focus__avatar">
                    </div>
                    <div class="modal-focus__primary">
                        <h2 class="modal-focus__title">Stephanie P. Juniper</h2>
                    </div>
                    <div class="modal-focus__secondary">
                        <ul class="meta">
                            <li><span class="meta-label">Employee ID:</span><span class="meta-value">sjuniper</span></li>
                        </ul>
                    </div>
                </div>
...
<div class="slat">
<div class="slat-default">
<div class="title">Charge Nurse</div>
<div class="action">
    <a class="btn btn-sm btn-default" href="#">Print <i class="fa fa-fw fa-print visible-xs"></i></a>
</div></div>
<div class="slat-nested">
<div class="collapse-group collapse">
...
<div class="slat slat-attention slat-spaced slat-callout-w" data-filter-category="1">
<div class="slat-default">
...
<div class="slat slat-attention slat-spaced slat-callout-w" data-filter-category="2">
<div class="slat-default">
...
<div class="slat slat-spaced slat-callout-w" data-filter-category="2">
<div class="slat-default">
<div class="title">Course Name: Class Name</div>
<ul class="meta">
<li><span class="meta-type">Live Class</span></li>
...
<li class="meta-callout"><span class="meta-value"><span class="meta-value"><div>Jul 15, 2014 at 3:30pm - </div>
                                    <div>Jul 25, 2014 at 3:30pm</div></span></span></li>
</ul>
</div>
</div>
...
<li><span class="meta-label">Status:</span><span class="meta-value">Registered</span></li>
<li class="meta-hide-xs"><span class="meta-label">Location:</span><span class="meta-value">Cummins Station: 450</span></li>
<li class="meta-callout"><span class="meta-value"><div>Aug 27, 2014</div><div>5:30am - 6:30am</div></span></li>
</ul>
</div>
</div>


<div class="slat slat-spaced slat-callout-w" data-filter-category="1">
<div class="slat-default">
...
<div class="slat slat-spaced slat-callout-w" data-filter-category="5">
<div class="slat-default">
<div class="title">Competency Appraisal - Employee Assesses Self</div>
<ul class="meta">
<li><span class="meta-type">Self Assessment</span></li>
<li><span class="meta-label">Status:</span><span class="meta-value">In Progress</span></li>
<li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>Jan 10, 2017</span></li>
</ul>
</div>
</div>


<div class="slat slat-spaced slat-callout-w" data-filter-category="3">
<div class="slat-default">
...
<div class="slat-default">
<div class="title">AMA PRA Category 1 Credit&trade;</div>
<ul class="meta">
...
<div class="slat-default">
<div class="title"><a href="#modal-selects-statements-view" data-toggle="modalpage">This is the title of a dynamic statement</a></div>
<ul class="meta">
<li><span class="meta-label">Owner:</span><span class="meta-value">General Healthcare</span></li>
<li><span class="meta-label">Updated:</span><span class="meta-value">Dec 13, 2015</span></li>
</ul>
</div>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Participate in Department Engagement Team</a></div>
<ul class="meta">
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Room Cleanliness &amp; Courtesy</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Increase Competency</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Facilitate Communication</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Improve Logistics</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Reduce Waste</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Highlight Achievements</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Reduce Onboarding Time</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Improve Training Materials</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
...
<div class="slat slat-modal">
<div class="slat-default">
<div class="title"><a href="#modal-selects-goals-view" data-toggle="modalpage">Reduce Repetitive Redundancy</a></div>
<ul class="meta">
<li><span class="meta-label">Status:</span><span class="meta-value">Active</span></li>
</ul>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vel orci aliquet, porta nisi quis, semper dolor. Fusce eget quam tristique, ornare neque quis, commodo metus. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
...
//   window.onresize = resize;
        ...
        $('.js-submit').click(function(e){
            var growl = {
                ...
                growlText: encodeURIComponent('<dl class="gritter-class"><dd>Assessment Sign Off</dd></dl>'),
                growlSticky: 'false'
            }
            e.preventDefault();
        ...
        $('.js-submit-to-review').click(function(e){
                    ...
                    HealthStream.utilities.interrupt({
                        type: 'warning',
                        title: 'You are about to move your ratings to Review state',
                        text: '<p>You have selected to move the Assessment to the review state.</p>Once the Assessment is in review the ratings cannot be changed.',
                        actions: [
                        {
                            type: 'success',
                            label: "Yes, move to Review state",
                            url: '/assessment.php?assessment=performance-2&user=rater&state=0&progress=1',
                        },
                        {
                            type: 'default',
                            label: 'Cancel',
                            url: '/assessment.php?assessment=performance-2&user=rater&state=1',
                        }
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"54ac9448ca","applicationID":"9436983","transactionName":"YlxRYxdZWEcEVxBeCVsWZkUMF1dHFlEXRAtQV0cZFVBG","queueTime":0,"applicationTime":13,"atts":"ThtSFV9DS0k=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>