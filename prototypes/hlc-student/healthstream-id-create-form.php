...
$patterns['start']['title'] = 'Activate Your HealthStream ePortfolio™';
$patterns['header']['mainNavActive'] = 'none';
$patterns['focus']['title'] = 'Activate Your HealthStream ePortfolio™';
            ...
            <div class="col-md-9">
                <section class="section section-box section-main" data-equalize="layout-columns">
                    <section class="section">
                        <h2>Activate Your HealthStream ePortfolio™</h2><p><a href="#modal-hstm-id-explanation" data-toggle="modal">What is a HealthStream ID?</a></p>
                        ...
                        <form data-toggle="validator" id="createIdForm" method="post" action="global-id-growl.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="collapse-group in collapse password-requirements" >
                                            Your password:
                                            <ul>
                                        ...
                                        <a href="#" class="collapse-toggle toggle-text-initialized password-toggle-text" data-toggle-text="Hide password requirements|Show password requirements">Hide password requirements<i class="fa-fw fa-caret-up fa"></i></a>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Current NRP Instructor</label>                                        
                                        <label class="checkbox js-nrp-checkbox"><input type="checkbox"> Yes, I'm a 6th Edition NRP Instructor</label>   
                                        <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="checkbox"><input type="checkbox" name="privacy" value="Yes" required> Yes, I've read the <a href="http://www.healthstream.com/privacy-statement" target="_blank">Terms of Use</a></label>
                                    </div>
