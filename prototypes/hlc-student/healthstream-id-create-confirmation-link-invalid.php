    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="title">HealthStream ID Registration Complete</h3>

                <p>The registration for this HealthStream ID has already been completed. You may login using the username and password you provided during registration.</p>
