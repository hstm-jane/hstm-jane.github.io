...
<!-- Modal -->
<div id="modal-healthstream-id-hlc-did-you-know" class="modal fade in-app">
            ...
            <form data-toggle="validator" id="loginForm" method="post" action="portfolio.php">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <p>Did you know that the HLC may be accessed using your HealthStream ID?.</p>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <div class="checkbox pull-left">
                        <label>
                            <input type="checkbox"> Do not show me this again
                        </label>
                    </div>
                    <button type="submit" class="btn btn-default pull-right" data-dismiss="modal" aria-hidden="true">Close</button>
                </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div id="modal-healthstream-id-create-success" class="modal fade in-app">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="title">Reminder to Complete Registration</h3>
    ...
    $(function() {
        ...
        setTimeout(function(){
            HealthStream.utilities.growl({
                type: 'info',
                title: 'Did You Know?',
                text: 'You can use your HealthStream ID to log in to this organization. <label class="checkbox" style="line-height:20px"><input type="checkbox"> Don\'t show again</label>',
                sticky: true
            });
        },500);
    });
