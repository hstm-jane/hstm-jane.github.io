        ...
        <nav class="nav-main">
            <div class="container">
                <ul id="nav" class="nav">
                    ...
                    ?>
                        <!-- <li><div class="container-fluid"><div class="row"><span href="#" class="btn btn-info col-xs-10 take-tour" id="startTour"><i class="fa fa-car"></i>Take a Tour</span></div></div></li> -->
                </ul>
            </div>
            <!-- /container -->
        </nav>
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12  col-xs-12 panel-metrics-col">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12 panel-metrics">
                                    <div class="metric">
                                        <div class="panel panel-default">
                                            <a href="#modal-cert" data-toggle="modal">
                                                <div class="panel-body text-center">
                                                    <div class="metric-box-header">
                                ...
                                <!--End Outstanding Certifications-->
                                    ...
                                    <div class=" col-lg-6 col-md-6 col-sm-6  col-xs-12 panel-metrics">
                                        <div class="metric">
                                            <div class="panel panel-default">
                                                <a href="#modal-dashboard-assignment" data-toggle="modal" class="assignment-widget" id="assessment-widget">
                                                    <div class="panel-body text-center">
                                                        <div class="metric-box-header">
                                                            <!-- <span class="highlight-text">39</span>  -->
                                                            Employees with
                                    ...
                                    <div class=" col-lg-6 col-md-6 col-sm-6  col-xs-12 panel-metrics">
                                        <div class="metric">
                                            <div class="panel panel-default">
                                                <a href="#modal-dashboard-assessment" data-toggle="modal" class="assessment-widget" id="assessment-widget">
                                                    <div class="panel-body text-center">
                                                        <div class="metric-box-header">
                                                            <!-- <span class="highlight-text">39</span>  -->
                                                            Employees with
                               ...
                               <!--  <div class=" panel-metrics">
                                    <div class="metric">
                                        <div class="panel panel-default panel-metrics">
                                            <a href="#modal-upcoming-classes" data-toggle="modal">
                                                <div class="panel-body text-center">
                                                    <div class="metric-box-header">
                                                        Employees with
                                                    ...
                                                    <div class="metric-box upcoming-classes">
                                                        ...
                                                        <div class="chart-container">
                                                            <canvas id="UpcomingClassesChart" height="175" width="175"></canvas>
                                                        </div>
                                                    </div>
                                                    <div class="metric-box-footer">
                                                        within next 30 days
                            ...
                            <div class="panel-heading">
                               ...
                               <div class="pull-right" style="margin-right:-5px;">
                                  ...
                                  <?php } ?>
                                    ...
                                    <div class="clearfix pr pt-sm" style="margin-right:-15px;margin-top:5px;"><small class="text-muted pull-left ">Showing 1 - <span class="number-employees">25</span> of 49</small>
                                    </div>
                                        <!-- <br></div><div class="tag">mont <i class="fa fa-times"></i></div> -->
                                    <!-- <div class="clearfix pr pt-sm"><small class="text-muted pull-right " style="font-style:normal;">Filtered by 'mont' <a href="#">clear</a></small></div> -->
                            </div>

                            <div class="panel-body">
                                <!-- <div class="employee-container" style="position:relative; overflow:hidden; height:1220px;"> -->
                                <div class="employee-container">
                                    <!-- <div class="first-10-employees"> -->
                                    ...
                                    <!--  <div class="clearfix">
                                       <a class=" team-view-next text-sm pull-right mr" data-toggle="modal">Next 25 > </a>
                                   </div> -->
                                    <!-- </div> -->
                            ...
                            <div class="panel-footer clearfix">
                              <div class="input-group" style="display:table;">
                                 ...
                                 <span class="input-group-btn" style="display:table-cell;">
                                    <button type="submit" class="btn btn-success btn-sm btn-search-employees"><i class="fa fa-search"></i>
                                    </button>
                                 </span>
