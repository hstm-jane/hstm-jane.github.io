    ...
    <div class="container">
        ...
        <div class="assessment-header">
            ...
            <section class="section assessment-action-section" id="jump-signoff">
                <h3>Waiting for Rater Sign Off</h3>
                 <p>You cannot proceed until the Rater has signed off on their ratings.</p>

                 <form class="validate">
                    <div class="form-group">
                        <label class="control-label">Employee's Comments</label>
                        <blockquote class="signoff-comments">I agree with the rating given to me by my supervisor.</blockquote>
                    </div>
                </form>
