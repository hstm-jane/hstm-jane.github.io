...
$patterns['header'] = array(
    ...
    'mainNav' => '
        ...
        <li class="{active=raters}"><a href="/assessment-overview.php">Raters <span class="badge">4</span></a></li>
                ...
                <section class="section section-main section-box" data-equalize="layout-columns">
                    ...
                    <section class="section" id="tasks">
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="assessment-overview.php">Assessment Rater Activities</a>',
                            'meta' => array(
                                array(
                                    'type' => 'Assessment',
                                ),
