...
<nav class="nav-pagetabs">
    ...
    <ul class="nav">
        <li class="active"><a href="#tab-1">Ratings</a></li>
        <li><a href="#tab-2">Approval Activity</a></li>
    </ul>
</nav>
...
<section class="section" id="ratings-top">
    <h2>About this Assessment<span class="average-rating">Assessment Rating: <a href="#" class="js-rating-definitions" data-params="assessment=competency-8">Pending<i class="fa fa-fw fa-info-circle"></i></a></span></h2>
