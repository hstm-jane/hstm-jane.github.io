                            ...
                            <ul class="stepper  pl0" >
                                <li class="step  active">
                                    ...
                                    <div class="row">
										...
										<div class="alert alert-success alert-nudge ">
                            <div class="nudge-container">
                                <div class="title"><i class="fa fa-check-circle"></i>
                                    We found a match! Enter your password. 
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-8">
											...
											<a href="#" class="pull-right text-sm">Reminder</a>
											<a href="#" class="pull-right text-sm">Reset</a>
