            ...
            <ul class="nav">
             ...
             <li>
                    <a href="hstream.docs.flow.php">
                      ...
                      <ul class="dashed">
                        <li class="active"><a href="hstream.docs.flow.enrollment.php">Enrollment and Completion API</a></li>
                ...
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        <div class="places-buttons">
                            <div class="row">
                                <div class="col-md-12">
<h3  id="get-a-users-tasks"><a name="user-content-get-a-users-tasks" href="#get-a-users-tasks" class="headeranchor-link" aria-hidden="true"><span class="headeranchor"></span></a>Enrollment and Completion API</h2>
...
<table class="table table-condensed table-striped">
    ...
    <tr>
     ...
     <tr>
        <td>Enrollment Date Range<br></td>
        <!--<td>URL</td>-->
        <!--<td>string</td>-->
    ...
    <tr>
        <td>User Status<br></td>
        <!--<td>URL</td>-->
        <!--<td>string</td>-->
        <td></td>
    </tr>
    <tr>
        <td>Course Completion Status<br></td>
        <!--<td>URL</td>-->
        <!--<td>string</td>-->
        <td></td>
    </tr>
...
<table class="table table-condensed table-striped">
    ...
    <tr>
        <td>Date of Class Employee Registered For </td>
        <!--<td>Internal Server Error</td>-->
    </tr>
    <tr>
        <td>Time of Class Employee Registered For </td>
        <!--<td>Internal Server Error</td>-->
    </tr>
    <tr>
        <td>Assigned (Y/N)</td>
    ...
    <tr>
        <td>Enrollment Date (with Time)</td>
        <!--<td>Internal Server Error</td>-->
    </tr>
    <tr>
        <td>Start Date (with Time)</td>
        <!--<td>Internal Server Error</td>-->
    </tr>
    <tr>
