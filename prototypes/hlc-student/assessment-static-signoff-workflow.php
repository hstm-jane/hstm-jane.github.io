...
<head> 
    ...
    <title>Performance Appraisal - Rater Workflow | HealthStream</title>

    <!-- Styles
    ================================================== -->
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1482182277">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1482182277">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1482182277">
    <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1482182277">
...
<body><div class="site-header ">
    <div class="container">
        ...
        <nav class="nav-account">
            <div class="name">Davy L. Crane</div>
            <div class="avatar">
                <i class="fa fa-user"></i>
                <img src="https://s3.amazonaws.com/uifaces/faces/twitter/holdenweb/128.jpg">
            </div>
...
<li><span class="meta-label">Rater:</span><span class="meta-value">Crane, Davy L.</span></li>
<li><span class="meta-label">State:</span><span class="meta-value">Sign Off</span></li>
<li><span class="meta-label">Due:</span><span class="meta-value">Dec 19, 2016</span></li>
</ul></div>-->
    ...
    <div class="container">
        <section class="section section-main section-box">
            ...
            <div class="assessment-header">
                <div class="assessment-return"><a href="assessment-overview.php"><i class="fa fa-fw fa-chevron-left"></i>Return to Assessment Review</a></div>
            </div>

            <section class="section page-header" style="padding-left:10px;padding-top:10px;">
                <h2>Sign Off</h2>
    ...
    $(function(){
        ...
        $('.js-signoff').click(function(e){
            var growl = {
                ...
                growlText: encodeURIComponent('<dl class="gritter-class"><dd>Performance Appraisal - Rater Workflow</dd></dl>'),
                growlSticky: 'false'
            }
            e.preventDefault();
        ...
        $('.js-signoff-remote').click(function(e){
            var growl = {
                ...
                growlText: encodeURIComponent('<p>Stephanie Juniper was notified to complete sign off.</p><br><dl class="gritter-class"><dd>Performance Appraisal - Rater Workflow</dd></dl>'),
                growlSticky: 'false'
            }
            e.preventDefault();
            window.location.href = '/?' + $.param(growl);
