...
?>
    ...
    ================================================== -->
        ...
        <title>Assignment Dashboard | HealthStream</title>
        <!-- Styles
    ================================================== -->
            ...
            <div class="container">
                ...
                <div class="branding" style="display:table;">
                    ...
                    <div style="display:table-cell;font-size:28px; padding-bottom:10px;margin-left:15px;vertical-align:bottom;width:500px;color:#000;">
                        <span style="border-left:1px solid black;margin-left:20px;padding-left:10px;">Assignment Dashboard</span>
                    </div>
                </div>
    ...
    ?>
                        ...
                        <a href="alerts.php" class="alerts"></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <section class="section section-box section-main " style="padding:0px">
                            <img src="/content/images/dashboard-assignment.png" style="width:1150px;display:block;margin-top:0px;" />
                        </section>
                    </div>
                </div>
                <!-- col -->
