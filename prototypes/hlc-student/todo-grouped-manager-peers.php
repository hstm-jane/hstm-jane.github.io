                ...
                <section class="section section-main section-box" data-equalize="layout-columns">
                    ...
                    <section class="section" id="tasks">
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="/assessment-overview-summary.php?click=review#details">Rater Assessments in Review</a> <span class="badge">2</span>',
                            'meta' => array(
                                array(
                                    'type' => 'Rater Task',
                                ),
                                ...
                                array(
                                    'label' => 'Due: ',
                                    'value' => '<span class="meta-callout-label">Due:</span>' .date('M j, Y',strtotime('-60days')).'<a href="/assessment-overview-summary.php?click=review#details">First of 2 Due</a>',
                                    'attributes' => array(
                            ...
                            'action' => array(
                                'type' => 'custom',
                                'content' => '<div class="action"><a class="btn btn-sm btn-default" href="/assessment-overview-summary.php?click=review#details">View<i class="fa fa-fw fa-chevron-right visible-xs"></i></a></div>',
                            )
                        );
                        ...
                        $slat = array(
                            ...
                            'title' => '<a href="/assessment-overview-summary.php?click=evaluate#details">Rater Assessments in Evaluate</a> <span class="badge">14</span>',
                            'meta' => array(
                                array(
                                    'type' => 'Rater Task',
                                ),
                                ...
                                array(
                                    'label' => 'Due: ',
                                    'value' => '<span class="meta-callout-label">Due:</span>' .date('M j, Y',strtotime('+10days')).'<a href="/assessment-overview-summary.php?click=evaluate#details">First of 14 Due</a>',
                                    'attributes' => array(
                                        array('class','meta-callout'),
                                    )
                                ),
                            ...
                            'action' => array(
                                'type' => 'custom',
                                'content' => '<div class="action"><a class="btn btn-sm btn-default" href="/assessment-overview-summary.php?click=evaluate#details">View<i class="fa fa-fw fa-chevron-right visible-xs"></i></a></div>',
                            )
                        );
                        echo createSlat($slat);
