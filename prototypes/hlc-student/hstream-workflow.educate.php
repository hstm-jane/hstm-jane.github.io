            ...
            <nav class="nav-main">
                <div class="container">
                  <ul id="nav" class="nav">
                                   ...
                                   <li class=""><a href="#">Be Informed</a></li>
                                   <li class=""><a href="#">Determine Needs</a></li>
                                   <li class=""><a href="#">Discover &amp; Compare</a></li>
                                   <li class=""><a href="#">Shop &amp; Save</a></li>
               ...
               <div class="row">
                   <div class="col-md-12">
                       <section class="section section-box section-main " style="padding:0px">
                          ...
                          <img src="/content/images/hStream-Educate.png" style="width:1150px;display:block;margin-top:0px;"/>
