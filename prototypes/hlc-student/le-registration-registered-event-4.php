                    ...
                    <section class="section">
                        ...
                        <section>
                            ...
                            <?php
                                ...
                                $slat = array(
                                    'attributes' => array(
                                        array('class', array('slat', 'slat-callout', 'slat-muted')),
                                    ),
                                    'title' => 'Leadership Training PreTest',
                        ...
                        <h3>Activities to Complete After the Event</h3>
                            ...
                            <?php
                                ...
                                $slat = array(
                                    ...
                                    'title' => 'Leadership Event Evaluation',
                            ...
                            <?php
                                ...
                                $slat = array(
                                    ...
                                    'title' => 'Leadership Instructor Evaluation',
