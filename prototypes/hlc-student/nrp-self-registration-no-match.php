	...
	<div class="login-window modal">
		...
		<div class="modal-body">
			<div id="tab-register" class="tab-pane selected">
				...
				<p style="margin-bottom:20px;">First let's see if you have a HealthStreamID we can use to get you set up faster</p>
							...
							<div class="row">
								<div class="form-group col-lg-8">
									<label class="control-label">Your personal email
										<small>
											<div>This will be your User ID and HealthStreamID</div>
										</small></label>
							...
							<div class="row">
								<div class="step-actions">
									...
									<div class="step-actions-right">
										<a href="nrp-self-registration-no-match-new-account.php" class="button-primary button">Continue</a>
									</div>
								</div>
							</div>
						</div>
