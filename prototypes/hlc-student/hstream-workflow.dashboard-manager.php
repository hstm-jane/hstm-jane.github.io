                        ...
                        <div class="col-lg-3 ui-sortable" id="portlet-1" data-toggle="portlet">
                            ...
                            <div id="panelPortlet2" class="panel panel-default"  style="padding-bottom:10px;">
                               <div class="panel-heading">
                                <div class="panel-title">My Team</div><a href="dashboard-manager-team-chart.1.php" class="btn btn-success btn-xs" style="float:right; margin-top:-20px;" >View chart</a>
                            </div>
