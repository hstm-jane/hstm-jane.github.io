...
================================================== -->
  ...
  <title>Assessment Summary | HealthStream</title>
  <!-- Styles
================================================== -->
  <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.bootstrap.css?cache=1469723778">
  <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.plugins.css?cache=1469723778">
  <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.app.css?cache=1469723778">
  <link rel="stylesheet" type="text/css" href="/content/styles/healthstream.prototype.css?cache=1469723778">
  <!-- IE 7/8 Handling
================================================== -->
  <script>
...
================================================== -->
  ...
  <?php
$empId = (!empty($_GET['empId']))?$_GET['empId']:'1';
$titleid = (!empty($_GET['titleid']))?$_GET['titleid']:'1';
    ...
    <nav class="nav-main">
      <div class="container">
        <ul id="nav" class="nav">
          ...
          <li><a href="/assessment-overview.php">Raters</a></li>
    ...
    <div class="fph-table">
      <div class="fph-row">
        <div class="fph-cell fph-cell-icon">
          ...
          <div class="fph-icon-label"><span>Employee Assessment</span></div>
        </div>
        <div class="fph-cell fph-cell-text">
          ...
          <div class="fph-secondary">
            <ul class="meta">
              <li><span class="meta-label">For Assessment:</span><span class="meta-value">Care of the Surgical Patient</span></li>
              <!--<li><span class="meta-label">Rater:</span><span class="meta-value">Crane, Darcy L.</span></li>
<li><span class="meta-label">State:</span><span class="meta-value">Review</span></li>
<li><span class="meta-label">Due:</span><span class="meta-value">Aug 27, 2016</span></li>-->
            </ul>
          </div>
        </div>
      </div>
      ...
      <section class="section section-main section-box">
        <div class="assessment-header">
          <div class="assessment-return">
            <div class="assessment-return"><a href="assessment-overview.php"><i class="fa fa-fw fa-chevron-left"></i>Return to Rater Overview</a></div>
          </div>
        </div>
        <section class="section page-header">
          <?php
if ($titleid == 1) { ?>
            <h2>Care of the Surgical Patient</h2>
            <?php } else { ?>
...
if ($empId != 1) {
    echo '<span class="meta-box-value">Chamberland, Marie</span>'; } else { echo '<span class="meta-box-value">Juniper, Stephanie P.</span>'; } ?>
                      ...
                      <div class="mb-cell equalized">
                        ...
                        <span class="meta-box-value">Completed</span>
                      </div>
                      <div class="mb-cell equalized">
                        <span class="meta-box-label">Completed</span>
                        <span class="meta-box-value">Feb 3, 2017</span>
                      </div>
                    </div>
                  </div>
                </div>
...
Instructions
                  ...
                  <div id="assessment-instructions-body" class="collapse-group in">
                    <div class="assessment-instructions__content">
                      ...
                      <br><b>Peers:</b> If a manager requests you rate another employee, please complete the peer evaluation as soon as possible after receiving the assignment. You are not required to complete the entire assessment. Complete only the areas
                      where you have experience with the employee.
                      ...
                      the assessment. After approval from your manager (if required), you may review the assessment with your employee. After the employee review, please sign off the assessment with the employee to complete your responsibilities. Note:
                      For certain overall assessment ratings, you will be required to configure a Reflective Plan before sign off.
                    </div>
                  </div>
                  <a href="#assessment-instructions-body" class="assessment-instructions__toggle collapse-toggle toggle-text-initialized" data-toggle-text="Show instructions|Hide instructions">Hide instructions<i class="fa-fw fa-caret-up fa"></i></a>
                </div>
        </section>
        <section class="section">
          <header class="section-header">
            <h2>Essential Attributes of Medical Surgical RNs</h2>
          </header>
          <div class="statement">
            <div class="summary">
              <div class="basics">
                <div class="title"><a href="/assessment-statement.php?assessment=competency-1&statement=statement-1&user=rater&state=5&progress=6">Critical Thinking</a></div>
                <div class="description">Demonstrates ability to consistently apply critical thinking abilities to positively impact patient and organizational outcomes.</div>
                <div class="rating">
                  <label>My Rating:</label> Expert</div>
              </div>
              <div class="rating">
              </div>
              <div class="action action-multi">
                <div class="btn-group">
                  <a href="/assessment-statement.php?assessment=competency-1&statement=statement-1&user=rater&state=5&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="/assessment-statement.php?assessment=competency-1&statement=statement-1&user=rater&state=5&progress=6">View Statement Details</a></li>
                    <li><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6">View All Ratings</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="actor actor--rater actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--rater">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option rating-selected"></span></div>
                          <div class="rating-control-cell"><span class="rating-label" data-label="Expert">Expert</span></div>
                        </div>
                      </div>
                    </div>
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust
                      in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=rater">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--employee actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--employee">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action
                      plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=employee">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    <div class="actor__role">
                      <label>peer</label>
                    </div>
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=peer-1">Peer 1</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          ...
                          <div class="rating-control-cell"><span class="rating-option rating-selected"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-label" data-label="Proficient">Proficient</span></div>
                        </div>
                      </div>
                    </div>
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is a great communicator and always follows up on her shared tasks.Her unique IT background brings a new perspective and I’ve personally learned a lot from her.</div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=peer-2">Peer 2</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> I look to her as a role model and mentor. She is also very resourceful and can solve almost any problem.</div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-1&user=rater&progress=6&actor=peer-3">Peer 3</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-option"></span></div>
                          <div class="rating-control-cell"><span class="rating-label" data-label="Not Applicable">Not Applicable</span></div>
                        </div>
                      </div>
                    </div>
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> I am new and cannot rate this person</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="statement">
            <div class="summary">
              <div class="basics">
                <div class="title"><a href="/assessment-statement.php?assessment=competency-1&statement=statement-2&user=rater&state=5&progress=6">Communication</a></div>
                <div class="description">Conveys and presents information clearly, confidently and effectively in one-on-one and group settings in a timely manner.</div>
                <div class="rating">
                  <label>My Rating:</label> Expert</div>
              </div>
              <div class="rating">
              ...
              <div class="action action-multi">
                <div class="btn-group">
                  <a href="/assessment-statement.php?assessment=competency-1&statement=statement-2&user=rater&state=5&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="/assessment-statement.php?assessment=competency-1&statement=statement-2&user=rater&state=5&progress=6">View Statement Details</a></li>
                    <li><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6">View All Ratings</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="actor actor--rater actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--rater">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust
                      in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=rater">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--employee actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--employee">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action
                      plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=employee">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=peer-1">Peer 1</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=peer-2">Peer 2</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-2&user=rater&progress=6&actor=peer-3">Peer 3</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div>
          ...
          <div class="statement">
            <div class="summary">
              <div class="basics">
                <div class="title"><a href="/assessment-statement.php?assessment=competency-1&statement=statement-3&user=rater&state=5&progress=6">Prioritization, Organization, Delegation</a></div>
                <div class="description">Demonstrates ability to prioritize, delegate and organize the care to be delivered and as well as the team delivering the care.</div>
                <div class="rating">
                  <label>My Rating:</label> Expert</div>
              </div>
              <div class="rating">
              ...
              <div class="action action-multi">
                <div class="btn-group">
                  <a href="/assessment-statement.php?assessment=competency-1&statement=statement-3&user=rater&state=5&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="/assessment-statement.php?assessment=competency-1&statement=statement-3&user=rater&state=5&progress=6">View Statement Details</a></li>
                    <li><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6">View All Ratings</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="actor actor--rater actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--rater">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust
                      in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=rater">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--employee actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--employee">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action
                      plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=employee">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=peer-1">Peer 1</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=peer-2">Peer 2</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-3&user=rater&progress=6&actor=peer-3">Peer 3</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div>
        ...
        <section class="section">
          <header class="section-header">
            <h2>Nursing Orientation</h2>
          </header>
          <div class="statement">
            <div class="summary">
              <div class="basics">
                <div class="title"><a href="/assessment-statement.php?assessment=competency-1&statement=statement-4&user=rater&state=5&progress=6">Relationship Based Care</a></div>
                <div class="description">Applies Relationship Based Care principals to strengthen teamwork and collaboration with all colleagues to improve the patient experience.</div>
                <div class="rating">
                  <label>My Rating:</label> Expert</div>
              </div>
              <div class="rating">
              ...
              <div class="action action-multi">
                <div class="btn-group">
                  <a href="/assessment-statement.php?assessment=competency-1&statement=statement-4&user=rater&state=5&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="/assessment-statement.php?assessment=competency-1&statement=statement-4&user=rater&state=5&progress=6">View Statement Details</a></li>
                    <li><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6">View All Ratings</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="actor actor--rater actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--rater">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust
                      in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=rater">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--employee actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--employee">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action
                      plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=employee">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=peer-1">Peer 1</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=peer-2">Peer 2</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-4&user=rater&progress=6&actor=peer-3">Peer 3</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div>
          ...
          <div class="statement">
            <div class="summary">
              <div class="basics">
                <div class="title"><a href="/assessment-statement.php?assessment=competency-1&statement=statement-5&user=rater&state=5&progress=6">Alcohol Withdrawal</a></div>
                <div class="description">Applies Relationship Based Care principals to strengthen teamwork and collaboration with all colleagues to improve the patient experience.</div>
                <div class="rating">
                  <label>My Rating:</label> Expert</div>
              </div>
              ...
              <div class="action action-multi">
                <div class="btn-group">
                  <a href="/assessment-statement.php?assessment=competency-1&statement=statement-5&user=rater&state=5&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="/assessment-statement.php?assessment=competency-1&statement=statement-5&user=rater&state=5&progress=6">View Statement Details</a></li>
                    <li><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6">View All Ratings</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="actor actor--rater actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--rater">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust
                      in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=rater">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--employee actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--employee">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action
                      plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=employee">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=peer-1">Peer 1</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=peer-2">Peer 2</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-5&user=rater&progress=6&actor=peer-3">Peer 3</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div>
        ...
        <section class="section">
          <header class="section-header">
            <h2>Med-Surg Core Orientation</h2>
          </header>
          <div class="statement">
            <div class="summary">
              <div class="basics">
                <div class="title"><a href="/assessment-statement.php?assessment=competency-1&statement=statement-6&user=rater&state=5&progress=6">Blood Transfusion</a></div>
                <div class="description">Initiates and administers blood transfusions.</div>
                <div class="rating">
                  <label>My Rating:</label> Expert</div>
              </div>
              <div class="rating">
              ...
              <div class="action action-multi">
                <div class="btn-group">
                  <a href="/assessment-statement.php?assessment=competency-1&statement=statement-6&user=rater&state=5&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="/assessment-statement.php?assessment=competency-1&statement=statement-6&user=rater&state=5&progress=6">View Statement Details</a></li>
                    <li><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6">View All Ratings</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="actor actor--rater actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--rater">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust
                      in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=rater">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--employee actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--employee">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action
                      plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=employee">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=peer-1">Peer 1</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=peer-2">Peer 2</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-6&user=rater&progress=6&actor=peer-3">Peer 3</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div>
          ...
          <div class="statement">
            <div class="summary">
              <div class="basics">
                <div class="title"><a href="/assessment-statement.php?assessment=competency-1&statement=statement-7&user=rater&state=5&progress=6">Patient Controlled Analgesia - PCA</a></div>
              ...
              <div class="action action-multi">
                <div class="btn-group">
                  <a href="/assessment-statement.php?assessment=competency-1&statement=statement-7&user=rater&state=5&progress=6" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Options <i class="fa fa-caret-down"></i></a>
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="/assessment-statement.php?assessment=competency-1&statement=statement-7&user=rater&state=5&progress=6">View Statement Details</a></li>
                    <li><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6">View All Ratings</a></li>
                  </ul>
                </div>
              </div>
            </div>
              ...
              <div class="actor actor--rater actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=rater">Crane, Darcy L.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--rater">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> She is very dependable and a leader on the team. She contributes during meetings and always offers constructive criticism.She embodies our company’s vision and I put a lot of trust
                      in her to help me&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=rater">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--employee actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=employee">Juniper, Stephanie P.</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--employee">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
                    ...
                    <div class="actor__summary"><span class="actor__summary-date">Jul 21, 2016:</span> Overall, I am very satisfied in the direction of my role as it has changed dramatically over the last year.I appreciate my manager asking me for feedback and putting in action
                      plans geared towards tea&hellip; <a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=employee">More</a></div>
                  </div>
                </div>
              </div>
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=peer-1">Peer 1</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=peer-2">Peer 2</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na"></span></div>
              ...
              <div class="actor actor--peer actor--rated">
                <div class="actor__basics">
                  <div class="actor__row">
                    ...
                    <div class="actor__name"><a href="#" class="js-rating-details" data-params="assessment=competency-1&statement=statement-7&user=rater&progress=6&actor=peer-3">Peer 3</a></div>
                    <div class="actor__rating">
                      <div class="rating-control rating-control--peer">
                        <div class="rating-control-row">
                          <div class="rating-control-cell"><span class="rating-option rating-option-na rating-selected"></span></div>
        ...
        <section class="section">
          <a href="#jump-signoff" class="btn btn-default">Return to Top</a>
        </section>
      </section>
    </div>
  </div>
            ...
            <div class="slat slat-spaced slat-callout-w" data-filter-category="5">
              <div class="slat-default">
                ...
                <ul class="meta">
                  ...
                  <li><span class="meta-label">Status:</span><span class="meta-value">In Progress</span></li>
                  <li class="meta-callout"><span class="meta-label">Due: </span><span class="meta-value"><span class="meta-callout-label">Due:</span>Jul 28, 2016</span>
                  </li>
                </ul>
              </div>
            </div>
    ...
    $(function() {
      ...
      $('.js-submit').click(function(e) {
        var growl = {
          ...
          growlText: encodeURIComponent('<dl class="gritter-class"><dd>Initial Nursing Competency Appraisal</dd></dl>'),
          growlSticky: 'false'
        }
        e.preventDefault();
      ...
      $('.js-submit-to-review').click(function(e) {
        ...
        HealthStream.utilities.interrupt({
          ...
          text: '<p>You have selected to move to the Assessment to the review state.</p><ul><li>Once the Assessment is in review the ratings cannot be changed.</li><li>Any employee or peer(s) ratings that have not been either saved/shared will not be displayed.</li><li>Any employee or peer(s) ratings that have not been submitted will now be displayed.</li></ul>',
          actions: [{
            type: 'success',
            label: 'Yes, move to Review state',
            url: '/assessment.php?assessment=competency-1&user=rater&state=1',
          }, {
            label: 'Cancel'
          }]
        });
      ...
      $('.js-signoff-remote').click(function(e) {
        var growl = {
          ...
          growlText: encodeURIComponent('<p>Stephanie P. Juniper was notified to complete sign off.</p><br><dl class="gritter-class"><dd>Initial Nursing Competency Appraisal</dd></dl>'),
          growlSticky: 'false'
        }
        e.preventDefault();
        window.location.href = '/?' + $.param(growl);
