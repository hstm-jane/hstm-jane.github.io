...
<div class="layout layout-assessment">
    <div class="container">
        <section class="section section-main section-box">
            ...
            <div style="padding:20px;margin:0px;border: 2px solid #eaeaea;box-shadow:2px 5px 10px -5px rgba(0,0,0,.2);">
             <h2 style="font-weight:400;margin-top:0px;">Initial Nursing Competency Appraisal </h2>
   <div class="meta-box" style="background-color:#f9f9f9;">
        ...
        <div style="display:table-row">
         ...
         <div style="display:table-row">
            <div style="display:table-cell;padding: 5px 5px 5px 5px;">
              ...
              <section class="section assessment-action-section" id="jump-top" style="margin-left:0px;margin-right:10px;">
            ...
            <section class="section page-header" style="margin-top:10px;border:none;padding-bottom:0px;margin-bottom:0px;">
    
  
 <h4>Description</h4>
    <p>Orientation for MS RN</p>

<div class="assessment-instructions" style="padding:0;margin:0;">
...
<div style="border-left: 1px #eaeaea solid;
    margin: 0;
    padding: 20px 40px;
    border-right: 1px #eaeaea solid;
    box-shadow: inset 2px 5px 10px -5px rgba(0,0,0,.2);background-color: #f9f9f9;">
