        ...
        $(function(){
            ...
            $('.js-btn-save').click(function(e){
                ...
                if ( validate($el) ) {
                    ...
                    $.post('/server.php', $el.serialize(), function(data) {
                        // console.log(data);
                        location.href = "/building/" + data.building + "/room/" + data.id + '/';
                        // location.href = "/building/" + data.building + "/";
                    });
                }
            });
            $('.js-btn-save-add').click(function(e){
                ...
                if ( validate($el) ) {
                    ...
                    $.post('/server.php', $el.serialize(), function(data) {
                        // console.log(data);
                        location.href = "/building/" + data.building + "/room/";
                    });
                }
            });
            $('.js-btn-save-clone').click(function(e){
                ...
                if ( validate($el) ) {
                    ...
                    $.post('/server.php', $el.serialize(), function(data) {
                        // console.log(data);
                        location.href = "/building/" + data.building + "/room/" + data.id + "/clone/";
                    });
                }
            });
