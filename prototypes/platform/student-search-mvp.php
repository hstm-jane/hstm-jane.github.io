            ...
            <section class="section section-main section-box">
                <div class="row">
                    <div class="col-md-3 hidden-sm hidden-xs">
                        <section class="section section-filters equalized" data-equalize="layout-columns">
                            <header>
                            ...
                            <div class="search-panel-filters">
                                <section class="section section-refinement-group">
                                    <ul class="list-unstyled">
                                        <li class="radio">
                                            <label type="checkbox"><input type="radio" name="affiliations" value="Jupiter" checked> Jupiter Healthcare</label>
                                        </li>
                                        <li class="radio">
                                            <label type="checkbox"><input type="radio" id="all-affiliations" name="affiliations" value="All">All Affiliations</label> </li>
                                    </ul>
                                </section>
                                <section class="section section-refinement-group">
                                    <ul class="list-unstyled">
                                        <li class="checkbox">
                                            <label>
                                                <input type="checkbox" value="Department" checked> Department
                                            </label>
                                        </li>
                                        <li class="checkbox">
                                            <label>
                                                <input type="checkbox" value="Job Title" checked> Job Title
                                            </label>
                                        </li>
                                    </ul>
                                </section> 
                                    ...
                                    'sets' => array(
                                        array(
                                            ...
                                            'html' => '
                                                ...
                                                <a href="/event-single-roster.php" class="btn btn-default">Cancel</a>
                                            ',
                                        ),
                                        array(
                                            'position' => 'right',
...
<script type="text/javascript" src="/scripts/prototype.student-search.js"></script>
