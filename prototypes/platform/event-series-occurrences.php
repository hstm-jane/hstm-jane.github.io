                    ...
                    <section class="section">
                        ...
                        <h2 class="page-header">Occurrences <span class="badge">52</span>
                            <span class="page-header-options">
                                <button class="btn btn-sm btn-default" id="btnRecurrence" type="button">Add Occurrence</button>
                                <button class="btn btn-sm btn-default" id="btnRecurrence" type="button" data-toggle="modal" data-target="#modal-recurrence">
