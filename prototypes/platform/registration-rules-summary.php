...
$patterns['start']['title'] = 'Rules Summary';
$patterns['focus']['title'] = 'Rules Summary';
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <section class="section section-box" id="event-resources" style="background-color: rgba(0, 0, 0, 0.02)">
                                ...
                                <div class="row" style="padding-top:5px">
                                    ...
                                    <div class="col-xs-2" style="left: -45px;top: 0px;">
                                        <div class="left-inner-addon">
                                            <input type="text" class="form-control text-center input-sm" id="min" rows="0" placeholder="1">
                                        </div>
                                    </div>
                                    <div class="col-xs-3 text-center" style="left: -58px;">
          ...
          <td><div class="btn btn-sm btn-danger pull-right"><i class="fa fa-minus"></i></div></td>
                            ...
                            <section class="section section-box" style="background-color: rgba(0, 0, 0, 0.02)">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 text-center" style="left: -58px;">
                                    ...
                                    <div class="col-xs-2 hidden" id="how-many-days" style="left: -131px;">
                                        <div class="left-inner-addon">
                                            <input type="text" class="form-control input-sm text-center" id="min" rows="0" placeholder="1" style="width:100px;">
                                        </div>
                                    </div>
                                    <div class="col-xs-4" style="top: 5px;left: -135px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6" style="top: 5px;left: -20px;">
                                ...
                                <div class="hidden" id="cb-fields">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3" style="top: 20px; margin-left:-20px">
                                            <label class="min"></label>
                                            does not respond
                                        </div>
                                        <div class="col-xs-2" style="left: -40px;top: 15px;">
                                            <div class="left-inner-addon">
                                                <input type="text" class="form-control text-center input-sm" id="min" rows="0" placeholder="1">
                                            </div>
                                        </div>
                                    ...
                                    <div clas="row" style="margin-bottom: 84px;">
                                        <div class="col-xs-6" style="top: 40px;padding-left:30px">
                                            before event start time, then:
                                        </div>
                                        <div class="col-xs-4" style="margin-top: 35px; margin-left: -115px">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="hidden" id="wl-fields">
                                            ...
                                            <div class="row" style="margin-top: 58px;">
                                                ...
                                                <div class="col-xs-2" style="left: -70px;top: 0px;">
                                                    <div class="left-inner-addon">
                                                        <input type="text" class="form-control text-center input-sm" id="min" rows="0" placeholder="1">
                                                    </div>
                                                </div>
                                                <div class="col-xs-3 text-center" style="left: -88px;">
                                                    <select class="form-control option-center input-sm">
                                                        <option selected="" id="days"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Day(s)</option>
                                                        <option id="hours"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hour(s)</option>
                                                    </select>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="row" style="padding-top:5px">
                                            ...
                                            <div class="col-xs-3 text-center" style="left: -38px;">
                                                <select class="form-control option-center input-sm" id="elapses-days" disabled>
                                                    <option selected="" id="days"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Day(s)</option>
                                                    <option id="hours"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hour(s)</option>
                                                </select>
                                            </div>
                                            <div class="col-xs-3 text-center" style="margin-left:-42px">
                                            ...
                                            <div class="col-xs-2" style="top: 5px; margin-left:-22px">
                                                <span class="text-disabled" id="elapses-text">event</span>
                                            </div>
                                            <div class="col-xs-3 text-center" style="margin-left:-72px">
                                        ...
                                        <div class="row" style="padding-top:20px">
                                            ...
                                            <div class="col-xs-12">
                                                ...
                                                <div style="padding-left:5px">
                                                    ...
                                                    <div class="radio-inline" style="padding-left:45px">
                                                        <label></label>
                                                        <input type="radio" name="after-event"> Daily
                                                    </div>
                                                    <div class="radio-inline">
                                                        <label></label>
                                                        <input type="radio" name="after-event"> Weekly
                                                    </div>
                                                </div>
                                                <hr />
                                                <div class="row">
                                ...
                                $stickybar = array(
                                    'sets' => array(
                                        array(
                                            ...
                                            'html' => '
                                                <a href="/registration-rules" class="btn btn-default"><i class="fa fa-arrow-left"></i> Go Back</a>
                                                <a href="/demo-complete" class="btn btn-success">Save & Finish</a>
                                            ',
                                        ),
                                    ),
                                );
