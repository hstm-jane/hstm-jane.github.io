...
<style>
	...
	.modal-nrp .modal-content .modal-footer{
...
<div id="modal-nrp-change-highlights" class="modal modal-nrp modal-xl fade" tabindex="-1">
	<div class="modal-dialog border-box">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
				<h1 class="text-center">Explore What's <strong>New</strong> With Your View.</h1>
				<h4 class="text-center sub-header">You can now keep tabs on your NRP status right from your My Events page. </h4>
			</div>
			<div class="modal-body text-center">	
				<img class="nrp-new-img" src="./content/images/Test_Highlight.jpg">
			</div>
			<div class="modal-footer">
				<a href="/admin-add-group.php" target="_blank" class="btn btn-default close-link">Learn More <i class="fa fa-caret-right"></i></a>
				<div class="form-group">
...
<!-- <div id="modal-nrp-highlights-2" class="modal modal-nrp modal-xl fade" tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
			...
			<div class="modal-body text-center ">
				<div class="text-left nrp-details">
                    ...
                    <h4>Read the <a class="nrp-white-link" href="#">full release notes here.</a></h4>
				</div>
	...
	(function(window, $) {
		...
		healthStream.search = {},
			...
			healthStream.search.expandcollapse = function() {
				...
				$('#modal-nrp-change-highlights').modal('show');
					$('.nrp-new-img').css('max-height', $(parent).height() * .55);
					$('.modal-nrp .modal-content').css('max-height', $(window).height() * 0.9);
					$('.modal-nrp .modal-content').css('height', auto);
		...
		$('.close-link').click(function(){
			$('#modal-nrp-change-highlights').modal('hide');
		});
	}(window, jQuery));
</script>
