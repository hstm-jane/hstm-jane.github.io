    ...
    <div class="site-header<?= $site_header_class ?>">
        <div class="container">
            ...
            <nav class="nav-account">
                ...
                <?php if ($alerts) { ?>
                <a href="alerts.php" class="alerts"><span class="badge"><?= $alerts ?></span></a>
                <?php } ?>
                <div class="institution"><a href="#"><?= $institution ?></a></div>
                <div class="logout"><a href="/authentication/login.php">Logout</a></div>
                ...
                <ul class="nav">
                    <li><a href="/account-settings.php">Profile Settings</a></li>
                   ...
                   <!-- <li><a href="alerts.php">Alerts
                    ...
                    <li class="hide-header-open logout"><a href="/authentication/login.php">Logout</a></li>
                </ul>
            </nav><!-- /account -->
        </div><!-- /container -->
        <nav class="nav-main">
            <div class="container">
                <ul class="nav">
                    <li class="<?php if($nav_main_active === 'activity'){ echo ' active'; } ?>"><a href="./activity.php">Activity</a></li>
                    <li class="<?php if($nav_main_active === 'ideas'){ echo ' active'; } ?>"><a href="./my-ideas.php">My Ideas</a></li>
                    <li class="<?php if($nav_main_active === 'search'){ echo ' active'; } ?>"><a href="./search-bright-ideas.php">Search</a></li>
                    <li class="<?php if($nav_main_active === 'points'){ echo ' active'; } ?>"><a href="./my-points.php">My Points</a></li>
                    <li class="<?php if($nav_main_active === 'reports'){ echo ' active'; } ?>"><a href="./reports.php">Reports</a></li>
                    <li class="dropdown">
                    ...
                    <li class="<?php if($nav_main_active === 'help'){ echo ' active'; } ?>"><a href="./help/Default.php" target="_blank">Help</a></li>
