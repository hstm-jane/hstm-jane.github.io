 ...
 * Version: 1.7.4
 *
 * Modified Date: July 23, 2013
 * Modified By: Marc Sexton (marc.sexton@sturdy.io)
 * ========================================================== */
...
(function (window, $) {
	...
	*/
    $.gritter.options = {
        ...
        slide_in_speed: 500, // how fast notifications fade in
	...
	*/
    var Gritter = {
        ...
        _item_count: 0,
        _is_setup: 0,
        _tpl_close: '<a class="gritter-close" href="#" tabindex="1">' + icons.Times + '</a>',
		...
		*/
        add: function (params) {
            ...
            item.show().animate({ left: '+=300' }, this.slide_in_speed, function () {
